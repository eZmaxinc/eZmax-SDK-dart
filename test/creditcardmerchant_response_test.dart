...
// tests for CreditcardmerchantResponse
void main() {
  // final instance = CreditcardmerchantResponse();

  group('test CreditcardmerchantResponse', () {
    ...
    test('to test the property `sBankaccountBankname`', () async {
      // TODO
    });
