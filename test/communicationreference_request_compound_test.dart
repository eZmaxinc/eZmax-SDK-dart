...
// tests for CommunicationreferenceRequestCompound
void main() {
  // final instance = CommunicationreferenceRequestCompound();

  group('test CommunicationreferenceRequestCompound', () {
    // The unique ID of the Communicationreference
    // int pkiCommunicationreferenceID
    test('to test the property `pkiCommunicationreferenceID`', () async {
      // TODO
    });
