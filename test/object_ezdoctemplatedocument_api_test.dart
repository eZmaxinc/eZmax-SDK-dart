...
/// tests for ObjectEzdoctemplatedocumentApi
void main() {
  // final instance = ObjectEzdoctemplatedocumentApi();

  group('tests for ObjectEzdoctemplatedocumentApi', () {
    ...
    test('test ezdoctemplatedocumentCreateObjectV1', () async {
      // TODO
    });
    ...
    //
    //Future ezdoctemplatedocumentDownloadV1(int pkiEzdoctemplatedocumentID) async
    test('test ezdoctemplatedocumentDownloadV1', () async {
      // TODO
    });
    ...
    test('test ezdoctemplatedocumentGetAutocompleteV2', () async {
      // TODO
    });
    ...
    test('test ezdoctemplatedocumentGetListV1', () async {
      // TODO
    });
    ...
    test('test ezdoctemplatedocumentGetObjectV2', () async {
      // TODO
    });
