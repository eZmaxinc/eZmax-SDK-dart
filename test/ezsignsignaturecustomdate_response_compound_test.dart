...
// tests for EzsignsignaturecustomdateResponseCompound
void main() {
  // final instance = EzsignsignaturecustomdateResponseCompound();

  group('test EzsignsignaturecustomdateResponseCompound', () {
    ...
    test('to test the property `iEzsignsignaturecustomdateX`', () async {
      // TODO
    });
