...
// tests for EzsigndocumentGetEzsignsignaturesV1Response
void main() {
  // final instance = EzsigndocumentGetEzsignsignaturesV1Response();

  group('test EzsigndocumentGetEzsignsignaturesV1Response', () {
