...
/// tests for ObjectEzsignsigningreasonApi
void main() {
  // final instance = ObjectEzsignsigningreasonApi();

  group('tests for ObjectEzsignsigningreasonApi', () {
    ...
    test('test ezsignsigningreasonCreateObjectV1', () async {
      // TODO
    });
    ...
    test('test ezsignsigningreasonGetAutocompleteV2', () async {
      // TODO
    });
    ...
    test('test ezsignsigningreasonGetListV1', () async {
      // TODO
    });
    ...
    test('test ezsignsigningreasonGetObjectV2', () async {
      // TODO
    });
