...
// tests for CreditcardtypeGetAutocompleteV2Response
void main() {
  // final instance = CreditcardtypeGetAutocompleteV2Response();

  group('test CreditcardtypeGetAutocompleteV2Response', () {
