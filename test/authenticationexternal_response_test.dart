...
// tests for AuthenticationexternalResponse
void main() {
  // final instance = AuthenticationexternalResponse();

  group('test AuthenticationexternalResponse', () {
    // The unique ID of the Authenticationexternal
    // int pkiAuthenticationexternalID
    test('to test the property `pkiAuthenticationexternalID`', () async {
      // TODO
    });
    ...
    test('to test the property `eAuthenticationexternalType`', () async {
      // TODO
    });

    // Whether the Authenticationexternal has been connected or not
    // bool bAuthenticationexternalConnected
    test('to test the property `bAuthenticationexternalConnected`', () async {
      // TODO
    });

    // The url to authorize the Authenticationexternal
    // String sAuthenticationexternalAuthorizationurl
    test('to test the property `sAuthenticationexternalAuthorizationurl`', () async {
      // TODO
    });
