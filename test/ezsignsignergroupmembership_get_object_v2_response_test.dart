...
// tests for EzsignsignergroupmembershipGetObjectV2Response
void main() {
  // final instance = EzsignsignergroupmembershipGetObjectV2Response();

  group('test EzsignsignergroupmembershipGetObjectV2Response', () {
