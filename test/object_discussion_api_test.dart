...
/// tests for ObjectDiscussionApi
void main() {
  // final instance = ObjectDiscussionApi();

  group('tests for ObjectDiscussionApi', () {
    ...
    test('test discussionCreateObjectV1', () async {
      // TODO
    });
    ...
    test('test discussionGetObjectV2', () async {
      // TODO
    });
