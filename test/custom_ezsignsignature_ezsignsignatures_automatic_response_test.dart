...
// tests for CustomEzsignsignatureEzsignsignaturesAutomaticResponse
void main() {
  // final instance = CustomEzsignsignatureEzsignsignaturesAutomaticResponse();

  group('test CustomEzsignsignatureEzsignsignaturesAutomaticResponse', () {
