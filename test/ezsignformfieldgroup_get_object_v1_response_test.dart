...
// tests for EzsignformfieldgroupGetObjectV1Response
void main() {
  // final instance = EzsignformfieldgroupGetObjectV1Response();

  group('test EzsignformfieldgroupGetObjectV1Response', () {
