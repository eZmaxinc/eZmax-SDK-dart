...
// tests for CommunicationexternalrecipientResponseCompound
void main() {
  // final instance = CommunicationexternalrecipientResponseCompound();

  group('test CommunicationexternalrecipientResponseCompound', () {
    // The unique ID of the Communicationexternalrecipient
    // int pkiCommunicationexternalrecipientID
    test('to test the property `pkiCommunicationexternalrecipientID`', () async {
      // TODO
    });
