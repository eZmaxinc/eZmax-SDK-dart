...
// tests for EzsigntemplatesignaturecustomdateRequestCompoundV2
void main() {
  // final instance = EzsigntemplatesignaturecustomdateRequestCompoundV2();

  group('test EzsigntemplatesignaturecustomdateRequestCompoundV2', () {
