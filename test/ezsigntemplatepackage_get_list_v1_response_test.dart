...
// tests for EzsigntemplatepackageGetListV1Response
void main() {
  final instance = EzsigntemplatepackageGetListV1Response();

  group('test EzsigntemplatepackageGetListV1Response', () {
