...
// tests for EzsigntemplatedocumentpagerecognitionRequestCompound
void main() {
  // final instance = EzsigntemplatedocumentpagerecognitionRequestCompound();

  group('test EzsigntemplatedocumentpagerecognitionRequestCompound', () {
