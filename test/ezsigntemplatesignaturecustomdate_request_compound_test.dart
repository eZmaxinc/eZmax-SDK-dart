...
// tests for EzsigntemplatesignaturecustomdateRequestCompound
void main() {
  // final instance = EzsigntemplatesignaturecustomdateRequestCompound();

  group('test EzsigntemplatesignaturecustomdateRequestCompound', () {
