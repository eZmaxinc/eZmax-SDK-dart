...
// tests for ColleagueResponseV2
void main() {
  // final instance = ColleagueResponseV2();

  group('test ColleagueResponseV2', () {
    // The unique ID of the Colleague
    // int pkiColleagueID
    test('to test the property `pkiColleagueID`', () async {
      // TODO
    });
