...
// tests for UsergroupmembershipResponseCompound
void main() {
  // final instance = UsergroupmembershipResponseCompound();

  group('test UsergroupmembershipResponseCompound', () {
    // The unique ID of the Usergroupmembership
    // int pkiUsergroupmembershipID
    test('to test the property `pkiUsergroupmembershipID`', () async {
      // TODO
    });
