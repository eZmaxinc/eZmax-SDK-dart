...
// tests for EzsigntemplatepackagesignerResponse
void main() {
  // final instance = EzsigntemplatepackagesignerResponse();

  group('test EzsigntemplatepackagesignerResponse', () {
    // The unique ID of the Ezsigntemplatepackagesigner
    // int pkiEzsigntemplatepackagesignerID
    test('to test the property `pkiEzsigntemplatepackagesignerID`', () async {
      // TODO
    });
