...
// tests for EzsigndocumentGetEzsignannotationsV1Response
void main() {
  // final instance = EzsigndocumentGetEzsignannotationsV1Response();

  group('test EzsigndocumentGetEzsignannotationsV1Response', () {
