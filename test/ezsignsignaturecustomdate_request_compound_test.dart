...
// tests for EzsignsignaturecustomdateRequestCompound
void main() {
  // final instance = EzsignsignaturecustomdateRequestCompound();

  group('test EzsignsignaturecustomdateRequestCompound', () {
