...
// tests for CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest
void main() {
  // final instance = CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest();

  group('test CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest', () {
    ...
    // List<EzsignformfieldRequestCompound> aObjEzsignformfield (default value: const [])
