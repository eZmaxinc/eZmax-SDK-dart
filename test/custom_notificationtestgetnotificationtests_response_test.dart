...
// tests for CustomNotificationtestgetnotificationtestsResponse
void main() {
  // final instance = CustomNotificationtestgetnotificationtestsResponse();

  group('test CustomNotificationtestgetnotificationtestsResponse', () {
    ...
    test('to test the property `sNotificationtestNameX`', () async {
      // TODO
    });

    // FieldENotificationpreferenceStatus eNotificationpreferenceStatus
    test('to test the property `eNotificationpreferenceStatus`', () async {
      // TODO
    });

    // The number of elements returned by the Notificationtest
    // int iNotificationtest
    test('to test the property `iNotificationtest`', () async {
      // TODO
    });
