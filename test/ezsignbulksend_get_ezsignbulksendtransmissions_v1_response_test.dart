...
// tests for EzsignbulksendGetEzsignbulksendtransmissionsV1Response
void main() {
  // final instance = EzsignbulksendGetEzsignbulksendtransmissionsV1Response();

  group('test EzsignbulksendGetEzsignbulksendtransmissionsV1Response', () {
