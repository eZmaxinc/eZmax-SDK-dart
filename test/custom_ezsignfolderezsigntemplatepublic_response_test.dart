...
// tests for CustomEzsignfolderezsigntemplatepublicResponse
void main() {
  // final instance = CustomEzsignfolderezsigntemplatepublicResponse();

  group('test CustomEzsignfolderezsigntemplatepublicResponse', () {
    ...
    test('to test the property `iEzsignfolderSignaturetotal`', () async {
      // TODO
    });
    ...
    // List<CustomEzsignfolderezsigntemplatepublicSignerResponse> aObjEzsignfolderezsigntemplatepublicSigner (default value: const [])
    test('to test the property `aObjEzsignfolderezsigntemplatepublicSigner`', () async {
      // TODO
    });
