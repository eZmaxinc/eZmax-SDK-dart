...
// tests for CustomCommunicationrecipientsrecipientResponse
void main() {
  // final instance = CustomCommunicationrecipientsrecipientResponse();

  group('test CustomCommunicationrecipientsrecipientResponse', () {
    ...
    // int fkiEzcomagentID
    test('to test the property `fkiEzcomagentID`', () async {
      // TODO
    });
    ...
    test('to test the property `fkiRewardmemberID`', () async {
      // TODO
    });
    ...
    // String eCommunicationrecipientsrecipientObjecttype
    test('to test the property `eCommunicationrecipientsrecipientObjecttype`', () async {
      // TODO
    });
