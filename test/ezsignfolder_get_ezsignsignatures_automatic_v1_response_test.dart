...
// tests for EzsignfolderGetEzsignsignaturesAutomaticV1Response
void main() {
  // final instance = EzsignfolderGetEzsignsignaturesAutomaticV1Response();

  group('test EzsignfolderGetEzsignsignaturesAutomaticV1Response', () {
