...
// tests for EzsigntemplatepackagesignerRequestCompound
void main() {
  // final instance = EzsigntemplatepackagesignerRequestCompound();

  group('test EzsigntemplatepackagesignerRequestCompound', () {
