...
// tests for EzsignannotationResponseCompound
void main() {
  // final instance = EzsignannotationResponseCompound();

  group('test EzsignannotationResponseCompound', () {
    // The unique ID of the Ezsignannotation
    // int pkiEzsignannotationID
    test('to test the property `pkiEzsignannotationID`', () async {
      // TODO
    });
    ...
    test('to test the property `eEzsignannotationHorizontalalignment`', () async {
      // TODO
    });

    // EnumVerticalalignment eEzsignannotationVerticalalignment
    test('to test the property `eEzsignannotationVerticalalignment`', () async {
      // TODO
    });

    // FieldEEzsignannotationType eEzsignannotationType
    test('to test the property `eEzsignannotationType`', () async {
      // TODO
    });
    ...
    test('to test the property `iEzsignannotationX`', () async {
      // TODO
    });
    ...
    test('to test the property `iEzsignannotationY`', () async {
      // TODO
    });
    ...
    test('to test the property `iEzsignannotationWidth`', () async {
      // TODO
    });
    ...
    test('to test the property `iEzsignannotationHeight`', () async {
      // TODO
    });

    // The Text of the Ezsignannotation
    // String sEzsignannotationText
    test('to test the property `sEzsignannotationText`', () async {
      // TODO
    });
