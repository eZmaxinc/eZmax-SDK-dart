...
// tests for EzsignformfieldgroupCreateObjectV1Response
void main() {
  // final instance = EzsignformfieldgroupCreateObjectV1Response();

  group('test EzsignformfieldgroupCreateObjectV1Response', () {
