...
// tests for EzsigntemplatesignatureRequestCompoundV2
void main() {
  // final instance = EzsigntemplatesignatureRequestCompoundV2();

  group('test EzsigntemplatesignatureRequestCompoundV2', () {
    ...
    // List<EzsigntemplatesignaturecustomdateRequestCompoundV2> aObjEzsigntemplatesignaturecustomdate (default value: const [])
