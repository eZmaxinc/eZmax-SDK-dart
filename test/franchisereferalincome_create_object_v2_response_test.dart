...
// tests for FranchisereferalincomeCreateObjectV2Response
void main() {
  // final instance = FranchisereferalincomeCreateObjectV2Response();

  group('test FranchisereferalincomeCreateObjectV2Response', () {
