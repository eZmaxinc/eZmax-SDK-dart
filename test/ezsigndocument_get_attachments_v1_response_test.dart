...
// tests for EzsigndocumentGetAttachmentsV1Response
void main() {
  // final instance = EzsigndocumentGetAttachmentsV1Response();

  group('test EzsigndocumentGetAttachmentsV1Response', () {
