...
// tests for WebsiteResponseCompound
void main() {
  // final instance = WebsiteResponseCompound();

  group('test WebsiteResponseCompound', () {
    ...
    test('to test the property `sWebsiteAddress`', () async {
      // TODO
    });
