...
// tests for EzsigndocumentGetEzsignformfieldgroupsV1Response
void main() {
  // final instance = EzsigndocumentGetEzsignformfieldgroupsV1Response();

  group('test EzsigndocumentGetEzsignformfieldgroupsV1Response', () {
