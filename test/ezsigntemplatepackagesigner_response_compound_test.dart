...
// tests for EzsigntemplatepackagesignerResponseCompound
void main() {
  // final instance = EzsigntemplatepackagesignerResponseCompound();

  group('test EzsigntemplatepackagesignerResponseCompound', () {
