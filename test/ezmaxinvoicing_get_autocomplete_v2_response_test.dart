...
// tests for EzmaxinvoicingGetAutocompleteV2Response
void main() {
  // final instance = EzmaxinvoicingGetAutocompleteV2Response();

  group('test EzmaxinvoicingGetAutocompleteV2Response', () {
