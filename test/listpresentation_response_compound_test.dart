...
// tests for ListpresentationResponseCompound
void main() {
  // final instance = ListpresentationResponseCompound();

  group('test ListpresentationResponseCompound', () {
    // A descriptive for the list presentation
    // String sListpresentationDescription
    test('to test the property `sListpresentationDescription`', () async {
      // TODO
    });

    // The filter to apply to the request to limit results.
    // String sListpresentationFilter
    test('to test the property `sListpresentationFilter`', () async {
      // TODO
    });

    // The order by the user chose
    // String sListpresentationOrderby
    test('to test the property `sListpresentationOrderby`', () async {
      // TODO
    });

    // An array of column names that the user chose to bee visible
    // List<String> aSColumnName (default value: const [])
    test('to test the property `aSColumnName`', () async {
      // TODO
    });

    // The maximum numbers of results to be returned
    // int iListpresentationRowMax
    test('to test the property `iListpresentationRowMax`', () async {
      // TODO
    });
    ...
    test('to test the property `iListpresentationRowOffset`', () async {
      // TODO
    });
