...
// tests for RejectedoffertopurchaseGetCommunicationCountV1Response
void main() {
  // final instance = RejectedoffertopurchaseGetCommunicationCountV1Response();

  group('test RejectedoffertopurchaseGetCommunicationCountV1Response', () {
