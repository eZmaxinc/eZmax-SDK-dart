...
// tests for EzsignfoldertypeAutocompleteElementResponse
void main() {
  // final instance = EzsignfoldertypeAutocompleteElementResponse();

  group('test EzsignfoldertypeAutocompleteElementResponse', () {
