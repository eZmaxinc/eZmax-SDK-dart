...
/// tests for ObjectAuthenticationexternalApi
void main() {
  // final instance = ObjectAuthenticationexternalApi();

  group('tests for ObjectAuthenticationexternalApi', () {
    ...
    test('test authenticationexternalCreateObjectV1', () async {
      // TODO
    });
    ...
    test('test authenticationexternalGetAutocompleteV2', () async {
      // TODO
    });
    ...
    test('test authenticationexternalGetListV1', () async {
      // TODO
    });
    ...
    test('test authenticationexternalGetObjectV2', () async {
      // TODO
    });
