...
// tests for UsergroupexternalmembershipResponseCompound
void main() {
  // final instance = UsergroupexternalmembershipResponseCompound();

  group('test UsergroupexternalmembershipResponseCompound', () {
    // The unique ID of the Usergroupexternalmembership
    // int pkiUsergroupexternalmembershipID
    test('to test the property `pkiUsergroupexternalmembershipID`', () async {
      // TODO
    });
