...
// tests for CreditcardclientListElement
void main() {
  // final instance = CreditcardclientListElement();

  group('test CreditcardclientListElement', () {
    // The unique ID of the Creditcardclient
    // int pkiCreditcardclientID
    test('to test the property `pkiCreditcardclientID`', () async {
      // TODO
    });

    // The unique ID of the Creditcarddetail
    // int fkiCreditcarddetailID
    test('to test the property `fkiCreditcarddetailID`', () async {
      // TODO
    });
    ...
    test('to test the property `sCreditcardclientDescription`', () async {
      // TODO
    });
    ...
    test('to test the property `bCreditcardclientAllowedtranquillit`', () async {
      // TODO
    });

    // The expirationmonth of the Creditcarddetail
    // int iCreditcarddetailExpirationmonth
    test('to test the property `iCreditcarddetailExpirationmonth`', () async {
      // TODO
    });

    // The expirationyear of the Creditcarddetail
    // int iCreditcarddetailExpirationyear
    test('to test the property `iCreditcarddetailExpirationyear`', () async {
      // TODO
    });
