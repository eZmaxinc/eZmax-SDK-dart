...
// tests for UsergroupexternalCreateObjectV1Response
void main() {
  // final instance = UsergroupexternalCreateObjectV1Response();

  group('test UsergroupexternalCreateObjectV1Response', () {
