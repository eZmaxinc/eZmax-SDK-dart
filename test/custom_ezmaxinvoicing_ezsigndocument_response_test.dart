...
// tests for CustomEzmaxinvoicingEzsigndocumentResponse
void main() {
  // final instance = CustomEzmaxinvoicingEzsigndocumentResponse();

  group('test CustomEzmaxinvoicingEzsigndocumentResponse', () {
