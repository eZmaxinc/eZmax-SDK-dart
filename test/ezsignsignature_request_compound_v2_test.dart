...
// tests for EzsignsignatureRequestCompoundV2
void main() {
  // final instance = EzsignsignatureRequestCompoundV2();

  group('test EzsignsignatureRequestCompoundV2', () {
    ...
    // List<EzsignsignaturecustomdateRequestCompoundV2> aObjEzsignsignaturecustomdate (default value: const [])
