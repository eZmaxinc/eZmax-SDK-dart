...
// tests for EzsigntemplateformfieldgroupResponseCompoundAllOf
void main() {
  // final instance = EzsigntemplateformfieldgroupResponseCompoundAllOf();

  group('test EzsigntemplateformfieldgroupResponseCompoundAllOf', () {
