...
// tests for CustomEzsignformfieldgroupRequest
void main() {
  // final instance = CustomEzsignformfieldgroupRequest();

  group('test CustomEzsignformfieldgroupRequest', () {
    ...
    // List<CustomEzsignformfieldRequest> aObjEzsignformfield (default value: const [])
