...
// tests for EzsigntemplateformfieldRequestCompound
void main() {
  // final instance = EzsigntemplateformfieldRequestCompound();

  group('test EzsigntemplateformfieldRequestCompound', () {
