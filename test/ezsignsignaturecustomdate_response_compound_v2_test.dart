...
// tests for EzsignsignaturecustomdateResponseCompoundV2
void main() {
  // final instance = EzsignsignaturecustomdateResponseCompoundV2();

  group('test EzsignsignaturecustomdateResponseCompoundV2', () {
