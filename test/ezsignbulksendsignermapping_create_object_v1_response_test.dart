...
// tests for EzsignbulksendsignermappingCreateObjectV1Response
void main() {
  // final instance = EzsignbulksendsignermappingCreateObjectV1Response();

  group('test EzsignbulksendsignermappingCreateObjectV1Response', () {
