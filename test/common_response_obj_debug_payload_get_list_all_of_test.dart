...
// tests for CommonResponseObjDebugPayloadGetListAllOf
void main() {
  final instance = CommonResponseObjDebugPayloadGetListAllOf();

  group('test CommonResponseObjDebugPayloadGetListAllOf', () {
