...
// tests for WebhookEzsignEzsignsignerAcceptclauseAllOf
void main() {
  // final instance = WebhookEzsignEzsignsignerAcceptclauseAllOf();

  group('test WebhookEzsignEzsignsignerAcceptclauseAllOf', () {
