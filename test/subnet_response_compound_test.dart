...
// tests for SubnetResponseCompound
void main() {
  // final instance = SubnetResponseCompound();

  group('test SubnetResponseCompound', () {
    // The unique ID of the Subnet
    // int pkiSubnetID
    test('to test the property `pkiSubnetID`', () async {
      // TODO
    });
