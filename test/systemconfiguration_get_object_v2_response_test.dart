...
// tests for SystemconfigurationGetObjectV2Response
void main() {
  // final instance = SystemconfigurationGetObjectV2Response();

  group('test SystemconfigurationGetObjectV2Response', () {
