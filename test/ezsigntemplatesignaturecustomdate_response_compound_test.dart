...
// tests for EzsigntemplatesignaturecustomdateResponseCompound
void main() {
  // final instance = EzsigntemplatesignaturecustomdateResponseCompound();

  group('test EzsigntemplatesignaturecustomdateResponseCompound', () {
    // The unique ID of the Ezsigntemplatesignaturecustomdate
    // int pkiEzsigntemplatesignaturecustomdateID
    test('to test the property `pkiEzsigntemplatesignaturecustomdateID`', () async {
      // TODO
    });
    ...
    test('to test the property `iEzsigntemplatesignaturecustomdateX`', () async {
      // TODO
    });
    ...
    test('to test the property `iEzsigntemplatesignaturecustomdateY`', () async {
      // TODO
    });
    ...
    test('to test the property `iEzsigntemplatesignaturecustomdateOffsetx`', () async {
      // TODO
    });
    ...
    test('to test the property `iEzsigntemplatesignaturecustomdateOffsety`', () async {
      // TODO
    });
    ...
    test('to test the property `sEzsigntemplatesignaturecustomdateFormat`', () async {
      // TODO
    });
