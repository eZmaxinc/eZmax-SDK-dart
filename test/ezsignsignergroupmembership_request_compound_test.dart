...
// tests for EzsignsignergroupmembershipRequestCompound
void main() {
  // final instance = EzsignsignergroupmembershipRequestCompound();

  group('test EzsignsignergroupmembershipRequestCompound', () {
