...
// tests for EzsignbulksendGetEzsignsignaturesAutomaticV1Response
void main() {
  // final instance = EzsignbulksendGetEzsignsignaturesAutomaticV1Response();

  group('test EzsignbulksendGetEzsignsignaturesAutomaticV1Response', () {
