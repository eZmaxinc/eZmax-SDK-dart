...
// tests for EzsignsignatureResponseCompound
void main() {
  // final instance = EzsignsignatureResponseCompound();

  group('test EzsignsignatureResponseCompound', () {
    ...
    test('to test the property `dtEzsignsignatureDateInFolderTimezone`', () async {
      // TODO
    });
