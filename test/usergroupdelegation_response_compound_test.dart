...
// tests for UsergroupdelegationResponseCompound
void main() {
  // final instance = UsergroupdelegationResponseCompound();

  group('test UsergroupdelegationResponseCompound', () {
    // The unique ID of the Usergroupdelegation
    // int pkiUsergroupdelegationID
    test('to test the property `pkiUsergroupdelegationID`', () async {
      // TODO
    });
