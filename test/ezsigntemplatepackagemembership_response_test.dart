...
// tests for EzsigntemplatepackagemembershipResponse
void main() {
  // final instance = EzsigntemplatepackagemembershipResponse();

  group('test EzsigntemplatepackagemembershipResponse', () {
