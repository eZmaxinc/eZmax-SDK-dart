...
/// tests for ObjectEzsigntemplatesignerApi
void main() {
  // final instance = ObjectEzsigntemplatesignerApi();

  group('tests for ObjectEzsigntemplatesignerApi', () {
    ...
    test('test ezsigntemplatesignerCreateObjectV1', () async {
      // TODO
    });
    ...
    test('test ezsigntemplatesignerDeleteObjectV1', () async {
      // TODO
    });
    ...
    test('test ezsigntemplatesignerEditObjectV1', () async {
      // TODO
    });
    ...
    // 
    //
    //Future<EzsigntemplatesignerGetObjectV1Response> ezsigntemplatesignerGetObjectV1(int pkiEzsigntemplatesignerID) async
    test('test ezsigntemplatesignerGetObjectV1', () async {
      // TODO
    });
    ...
    test('test ezsigntemplatesignerGetObjectV2', () async {
      // TODO
    });
