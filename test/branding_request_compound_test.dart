...
// tests for BrandingRequestCompound
void main() {
  // final instance = BrandingRequestCompound();

  group('test BrandingRequestCompound', () {
    ...
    test('to test the property `sBrandingBase64`', () async {
      // TODO
    });
