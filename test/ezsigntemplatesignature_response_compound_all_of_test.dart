...
// tests for EzsigntemplatesignatureResponseCompoundAllOf
void main() {
  // final instance = EzsigntemplatesignatureResponseCompoundAllOf();

  group('test EzsigntemplatesignatureResponseCompoundAllOf', () {
