...
// tests for EzsigndocumentExtractTextV1Request
void main() {
  // final instance = EzsigndocumentExtractTextV1Request();

  group('test EzsigndocumentExtractTextV1Request', () {
