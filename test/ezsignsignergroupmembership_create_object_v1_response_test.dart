...
// tests for EzsignsignergroupmembershipCreateObjectV1Response
void main() {
  // final instance = EzsignsignergroupmembershipCreateObjectV1Response();

  group('test EzsignsignergroupmembershipCreateObjectV1Response', () {
