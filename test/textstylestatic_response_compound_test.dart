...
// tests for TextstylestaticResponseCompound
void main() {
  // final instance = TextstylestaticResponseCompound();

  group('test TextstylestaticResponseCompound', () {
    // The unique ID of the Textstylestatic
    // int pkiTextstylestaticID
    test('to test the property `pkiTextstylestaticID`', () async {
      // TODO
    });
