...
// tests for EzsigntemplatedocumentpagerecognitionResponse
void main() {
  // final instance = EzsigntemplatedocumentpagerecognitionResponse();

  group('test EzsigntemplatedocumentpagerecognitionResponse', () {
