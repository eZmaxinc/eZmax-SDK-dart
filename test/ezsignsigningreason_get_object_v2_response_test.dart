...
// tests for EzsignsigningreasonGetObjectV2Response
void main() {
  // final instance = EzsignsigningreasonGetObjectV2Response();

  group('test EzsignsigningreasonGetObjectV2Response', () {
