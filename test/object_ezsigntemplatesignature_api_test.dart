...
/// tests for ObjectEzsigntemplatesignatureApi
void main() {
  // final instance = ObjectEzsigntemplatesignatureApi();

  group('tests for ObjectEzsigntemplatesignatureApi', () {
    ...
    test('test ezsigntemplatesignatureDeleteObjectV1', () async {
      // TODO
    });
    ...
    test('test ezsigntemplatesignatureGetObjectV1', () async {
      // TODO
    });
