...
/// tests for ObjectFranchisereferalincomeApi
void main() {
  // final instance = ObjectFranchisereferalincomeApi();

  group('tests for ObjectFranchisereferalincomeApi', () {
    ...
    test('test franchisereferalincomeCreateObjectV1', () async {
      // TODO
    });
