...
/// tests for ObjectSubnetApi
void main() {
  // final instance = ObjectSubnetApi();

  group('tests for ObjectSubnetApi', () {
    // Create a new Subnet
    //
    ...
    test('test subnetCreateObjectV1', () async {
      // TODO
    });
    ...
    test('test subnetGetObjectV2', () async {
      // TODO
    });
