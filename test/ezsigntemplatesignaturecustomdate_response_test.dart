...
// tests for EzsigntemplatesignaturecustomdateResponse
void main() {
  // final instance = EzsigntemplatesignaturecustomdateResponse();

  group('test EzsigntemplatesignaturecustomdateResponse', () {
