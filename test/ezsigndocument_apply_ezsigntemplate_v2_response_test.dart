...
// tests for EzsigndocumentApplyEzsigntemplateV2Response
void main() {
  // final instance = EzsigndocumentApplyEzsigntemplateV2Response();

  group('test EzsigndocumentApplyEzsigntemplateV2Response', () {
