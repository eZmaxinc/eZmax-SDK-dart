...
// tests for EzsignfolderImportEzsigntemplatepackageV1Response
void main() {
  // final instance = EzsignfolderImportEzsigntemplatepackageV1Response();

  group('test EzsignfolderImportEzsigntemplatepackageV1Response', () {
