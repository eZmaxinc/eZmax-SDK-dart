...
// tests for EzsignfolderGetObjectV1ResponseMPayload
void main() {
  // final instance = EzsignfolderGetObjectV1ResponseMPayload();

  group('test EzsignfolderGetObjectV1ResponseMPayload', () {
