...
// tests for FranchisebrokerGetAutocompleteV2Response
void main() {
  // final instance = FranchisebrokerGetAutocompleteV2Response();

  group('test FranchisebrokerGetAutocompleteV2Response', () {
