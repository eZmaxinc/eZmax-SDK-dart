...
// tests for EzsigntemplatedocumentpagerecognitionResponseCompound
void main() {
  // final instance = EzsigntemplatedocumentpagerecognitionResponseCompound();

  group('test EzsigntemplatedocumentpagerecognitionResponseCompound', () {
    // The unique ID of the Ezsigntemplatedocumentpagerecognition
    // int pkiEzsigntemplatedocumentpagerecognitionID
    test('to test the property `pkiEzsigntemplatedocumentpagerecognitionID`', () async {
      // TODO
    });

    // The unique ID of the Ezsigntemplatedocumentpage
    // int fkiEzsigntemplatedocumentpageID
    test('to test the property `fkiEzsigntemplatedocumentpageID`', () async {
      // TODO
    });

    // FieldEEzsigntemplatedocumentpagerecognitionOperator eEzsigntemplatedocumentpagerecognitionOperator
    test('to test the property `eEzsigntemplatedocumentpagerecognitionOperator`', () async {
      // TODO
    });

    // FieldEEzsigntemplatedocumentpagerecognitionSection eEzsigntemplatedocumentpagerecognitionSection
    test('to test the property `eEzsigntemplatedocumentpagerecognitionSection`', () async {
      // TODO
    });
