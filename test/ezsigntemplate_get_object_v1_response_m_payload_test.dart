...
// tests for EzsigntemplateGetObjectV1ResponseMPayload
void main() {
  // final instance = EzsigntemplateGetObjectV1ResponseMPayload();

  group('test EzsigntemplateGetObjectV1ResponseMPayload', () {
