...
// tests for UserRequestCompoundV2
void main() {
  // final instance = UserRequestCompoundV2();

  group('test UserRequestCompoundV2', () {
    ...
    test('to test the property `sUserSecretresponse`', () async {
      // TODO
    });
