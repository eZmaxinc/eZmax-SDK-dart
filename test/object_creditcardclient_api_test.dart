...
/// tests for ObjectCreditcardclientApi
void main() {
  // final instance = ObjectCreditcardclientApi();

  group('tests for ObjectCreditcardclientApi', () {
    ...
    test('test creditcardclientCreateObjectV1', () async {
      // TODO
    });
    ...
    test('test creditcardclientGetAutocompleteV2', () async {
      // TODO
    });
    ...
    test('test creditcardclientGetListV1', () async {
      // TODO
    });
    ...
    test('test creditcardclientGetObjectV2', () async {
      // TODO
    });
