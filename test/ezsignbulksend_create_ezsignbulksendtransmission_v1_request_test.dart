...
// tests for EzsignbulksendCreateEzsignbulksendtransmissionV1Request
void main() {
  // final instance = EzsignbulksendCreateEzsignbulksendtransmissionV1Request();

  group('test EzsignbulksendCreateEzsignbulksendtransmissionV1Request', () {
