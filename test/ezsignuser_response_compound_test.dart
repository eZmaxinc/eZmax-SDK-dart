...
// tests for EzsignuserResponseCompound
void main() {
  // final instance = EzsignuserResponseCompound();

  group('test EzsignuserResponseCompound', () {
    // The unique ID of the Ezsignuser
    // int pkiEzsignuserID
    test('to test the property `pkiEzsignuserID`', () async {
      // TODO
    });
