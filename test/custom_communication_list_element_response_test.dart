...
// tests for CustomCommunicationListElementResponse
void main() {
  // final instance = CustomCommunicationListElementResponse();

  group('test CustomCommunicationListElementResponse', () {
