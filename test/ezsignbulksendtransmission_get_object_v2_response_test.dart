...
// tests for EzsignbulksendtransmissionGetObjectV2Response
void main() {
  // final instance = EzsignbulksendtransmissionGetObjectV2Response();

  group('test EzsignbulksendtransmissionGetObjectV2Response', () {
