...
// tests for EzsignsigningreasonGetAutocompleteV2Response
void main() {
  // final instance = EzsignsigningreasonGetAutocompleteV2Response();

  group('test EzsignsigningreasonGetAutocompleteV2Response', () {
