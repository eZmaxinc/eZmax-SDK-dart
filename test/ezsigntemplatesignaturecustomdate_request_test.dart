...
// tests for EzsigntemplatesignaturecustomdateRequest
void main() {
  // final instance = EzsigntemplatesignaturecustomdateRequest();

  group('test EzsigntemplatesignaturecustomdateRequest', () {
