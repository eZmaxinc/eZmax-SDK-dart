...
// tests for EzsignbulksenddocumentmappingCreateObjectV1Response
void main() {
  // final instance = EzsignbulksenddocumentmappingCreateObjectV1Response();

  group('test EzsignbulksenddocumentmappingCreateObjectV1Response', () {
