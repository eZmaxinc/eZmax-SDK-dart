...
// tests for CommunicationrecipientResponseCompound
void main() {
  // final instance = CommunicationrecipientResponseCompound();

  group('test CommunicationrecipientResponseCompound', () {
    // The unique ID of the Communicationrecipient.
    // int pkiCommunicationrecipientID
    test('to test the property `pkiCommunicationrecipientID`', () async {
      // TODO
    });
