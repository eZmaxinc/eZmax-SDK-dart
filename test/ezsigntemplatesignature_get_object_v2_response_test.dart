...
// tests for EzsigntemplatesignatureGetObjectV2Response
void main() {
  // final instance = EzsigntemplatesignatureGetObjectV2Response();

  group('test EzsigntemplatesignatureGetObjectV2Response', () {
