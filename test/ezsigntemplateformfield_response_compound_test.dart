...
// tests for EzsigntemplateformfieldResponseCompound
void main() {
  // final instance = EzsigntemplateformfieldResponseCompound();

  group('test EzsigntemplateformfieldResponseCompound', () {
    ...
    test('to test the property `bEzsigntemplateformfieldAutocomplete`', () async {
      // TODO
    });
