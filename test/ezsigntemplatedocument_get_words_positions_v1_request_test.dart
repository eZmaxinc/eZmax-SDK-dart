...
// tests for EzsigntemplatedocumentGetWordsPositionsV1Request
void main() {
  // final instance = EzsigntemplatedocumentGetWordsPositionsV1Request();

  group('test EzsigntemplatedocumentGetWordsPositionsV1Request', () {
    ...
    test('to test the property `bWordCaseSensitive`', () async {
      // TODO
    });
