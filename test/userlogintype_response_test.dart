...
// tests for UserlogintypeResponse
void main() {
  // final instance = UserlogintypeResponse();

  group('test UserlogintypeResponse', () {
    ...
    test('to test the property `objUserlogintypeDescription`', () async {
      // TODO
    });
