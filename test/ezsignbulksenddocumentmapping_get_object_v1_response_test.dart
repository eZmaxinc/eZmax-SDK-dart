...
// tests for EzsignbulksenddocumentmappingGetObjectV1Response
void main() {
  // final instance = EzsignbulksenddocumentmappingGetObjectV1Response();

  group('test EzsignbulksenddocumentmappingGetObjectV1Response', () {
