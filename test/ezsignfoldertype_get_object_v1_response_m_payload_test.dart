...
// tests for EzsignfoldertypeGetObjectV1ResponseMPayload
void main() {
  // final instance = EzsignfoldertypeGetObjectV1ResponseMPayload();

  group('test EzsignfoldertypeGetObjectV1ResponseMPayload', () {
    ...
    test('to test the property `sUsergroupNameXRestricted`', () async {
      // TODO
    });
