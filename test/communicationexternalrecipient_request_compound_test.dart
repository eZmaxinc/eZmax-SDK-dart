...
// tests for CommunicationexternalrecipientRequestCompound
void main() {
  // final instance = CommunicationexternalrecipientRequestCompound();

  group('test CommunicationexternalrecipientRequestCompound', () {
