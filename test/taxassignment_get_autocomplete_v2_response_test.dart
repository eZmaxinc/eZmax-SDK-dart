...
// tests for TaxassignmentGetAutocompleteV2Response
void main() {
  // final instance = TaxassignmentGetAutocompleteV2Response();

  group('test TaxassignmentGetAutocompleteV2Response', () {
