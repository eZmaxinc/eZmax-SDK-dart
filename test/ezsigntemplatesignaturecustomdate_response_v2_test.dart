...
// tests for EzsigntemplatesignaturecustomdateResponseV2
void main() {
  // final instance = EzsigntemplatesignaturecustomdateResponseV2();

  group('test EzsigntemplatesignaturecustomdateResponseV2', () {
