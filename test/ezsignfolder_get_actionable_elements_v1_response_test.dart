...
// tests for EzsignfolderGetActionableElementsV1Response
void main() {
  // final instance = EzsignfolderGetActionableElementsV1Response();

  group('test EzsignfolderGetActionableElementsV1Response', () {
