...
// tests for EzsigntemplateResponseCompoundV3
void main() {
  // final instance = EzsigntemplateResponseCompoundV3();

  group('test EzsigntemplateResponseCompoundV3', () {
    // The unique ID of the Ezsigntemplate
    // int pkiEzsigntemplateID
    test('to test the property `pkiEzsigntemplateID`', () async {
      // TODO
    });
    ...
    test('to test the property `eEzsigntemplateRecognition`', () async {
      // TODO
    });

    // The filename regexp of the Ezsigntemplate.
    // String sEzsigntemplateFilenameregexp
    test('to test the property `sEzsigntemplateFilenameregexp`', () async {
      // TODO
    });

    // Whether the Ezsigntemplate can be accessed by admin users only (eUserType=Normal)
    // bool bEzsigntemplateAdminonly
    test('to test the property `bEzsigntemplateAdminonly`', () async {
      // TODO
    });
    ...
    test('to test the property `bEzsigntemplateEditallowed`', () async {
      // TODO
    });

    // FieldEEzsigntemplateType eEzsigntemplateType
    test('to test the property `eEzsigntemplateType`', () async {
      // TODO
    });

    // EzsigntemplatedocumentResponse objEzsigntemplatedocument
    test('to test the property `objEzsigntemplatedocument`', () async {
      // TODO
    });

    // List<EzsigntemplatesignerResponseCompound> aObjEzsigntemplatesigner (default value: const [])
    test('to test the property `aObjEzsigntemplatesigner`', () async {
      // TODO
    });
