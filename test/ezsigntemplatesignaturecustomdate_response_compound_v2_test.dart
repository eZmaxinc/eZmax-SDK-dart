...
// tests for EzsigntemplatesignaturecustomdateResponseCompoundV2
void main() {
  // final instance = EzsigntemplatesignaturecustomdateResponseCompoundV2();

  group('test EzsigntemplatesignaturecustomdateResponseCompoundV2', () {
