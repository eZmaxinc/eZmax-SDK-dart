...
// tests for CommunicationexternalrecipientResponse
void main() {
  // final instance = CommunicationexternalrecipientResponse();

  group('test CommunicationexternalrecipientResponse', () {
