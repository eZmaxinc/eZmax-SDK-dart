...
// tests for EzsignfolderResponseCompoundV3
void main() {
  // final instance = EzsignfolderResponseCompoundV3();

  group('test EzsignfolderResponseCompoundV3', () {
    ...
    test('to test the property `eEzsignfolderAccess`', () async {
      // TODO
    });
