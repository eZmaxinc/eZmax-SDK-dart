...
// tests for EzsignsignatureGetEzsignsignaturesAutomaticV1Response
void main() {
  // final instance = EzsignsignatureGetEzsignsignaturesAutomaticV1Response();

  group('test EzsignsignatureGetEzsignsignaturesAutomaticV1Response', () {
