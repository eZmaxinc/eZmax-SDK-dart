...
// tests for EzsigntemplatesignatureResponseCompound
void main() {
  // final instance = EzsigntemplatesignatureResponseCompound();

  group('test EzsigntemplatesignatureResponseCompound', () {
