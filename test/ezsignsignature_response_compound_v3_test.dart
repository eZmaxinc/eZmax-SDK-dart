...
// tests for EzsignsignatureResponseCompoundV3
void main() {
  // final instance = EzsignsignatureResponseCompoundV3();

  group('test EzsignsignatureResponseCompoundV3', () {
    ...
    // List<EzsignsignaturecustomdateResponseCompoundV2> aObjEzsignsignaturecustomdate (default value: const [])
