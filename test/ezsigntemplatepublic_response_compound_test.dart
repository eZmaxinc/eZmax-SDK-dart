...
// tests for EzsigntemplatepublicResponseCompound
void main() {
  // final instance = EzsigntemplatepublicResponseCompound();

  group('test EzsigntemplatepublicResponseCompound', () {
    ...
    test('to test the property `sEzsigntemplatepublicReferenceid`', () async {
      // TODO
    });
    ...
    test('to test the property `sEzsigntemplatepublicUrl`', () async {
      // TODO
    });
    ...
    // List<CustomEzsignfolderezsigntemplatepublicResponse> aObjEzsignfolderezsigntemplatepublic (default value: const [])
    test('to test the property `aObjEzsignfolderezsigntemplatepublic`', () async {
      // TODO
    });
