...
// tests for EzsignbulksendtransmissionGetObjectV1Response
void main() {
  // final instance = EzsignbulksendtransmissionGetObjectV1Response();

  group('test EzsignbulksendtransmissionGetObjectV1Response', () {
