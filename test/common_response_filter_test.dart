...
// tests for CommonResponseFilter
void main() {
  // final instance = CommonResponseFilter();

  group('test CommonResponseFilter', () {
    // List of filters that can be used in *sFilter* (Automatic types)
    // Map<String, String> aAutoType (default value: const {})
    test('to test the property `aAutoType`', () async {
      // TODO
    });
