...
// tests for BrandingGetObjectV1ResponseMPayload
void main() {
  // final instance = BrandingGetObjectV1ResponseMPayload();

  group('test BrandingGetObjectV1ResponseMPayload', () {
    // The unique ID of the Branding
    // int pkiBrandingID
    test('to test the property `pkiBrandingID`', () async {
      // TODO
    });
    ...
    test('to test the property `eBrandingLogo`', () async {
      // TODO
    });
    ...
    test('to test the property `sBrandingLogourl`', () async {
      // TODO
    });
