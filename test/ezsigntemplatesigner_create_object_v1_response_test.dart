...
// tests for EzsigntemplatesignerCreateObjectV1Response
void main() {
  // final instance = EzsigntemplatesignerCreateObjectV1Response();

  group('test EzsigntemplatesignerCreateObjectV1Response', () {
