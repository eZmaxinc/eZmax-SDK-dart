...
// tests for BillingentityinternalResponseCompoundAllOf
void main() {
  // final instance = BillingentityinternalResponseCompoundAllOf();

  group('test BillingentityinternalResponseCompoundAllOf', () {
