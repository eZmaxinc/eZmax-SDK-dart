...
// tests for FranchisereferalincomeRequestCompoundAllOf
void main() {
  // final instance = FranchisereferalincomeRequestCompoundAllOf();

  group('test FranchisereferalincomeRequestCompoundAllOf', () {
