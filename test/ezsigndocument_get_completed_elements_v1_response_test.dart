...
// tests for EzsigndocumentGetCompletedElementsV1Response
void main() {
  // final instance = EzsigndocumentGetCompletedElementsV1Response();

  group('test EzsigndocumentGetCompletedElementsV1Response', () {
