...
// tests for EzsigntemplateformfieldgroupGetObjectV2Response
void main() {
  // final instance = EzsigntemplateformfieldgroupGetObjectV2Response();

  group('test EzsigntemplateformfieldgroupGetObjectV2Response', () {
