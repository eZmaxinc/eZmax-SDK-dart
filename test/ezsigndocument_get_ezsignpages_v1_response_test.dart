...
// tests for EzsigndocumentGetEzsignpagesV1Response
void main() {
  // final instance = EzsigndocumentGetEzsignpagesV1Response();

  group('test EzsigndocumentGetEzsignpagesV1Response', () {
