...
/// tests for ObjectPermissionApi
void main() {
  // final instance = ObjectPermissionApi();

  group('tests for ObjectPermissionApi', () {
    ...
    test('test permissionCreateObjectV1', () async {
      // TODO
    });
    ...
    test('test permissionGetObjectV2', () async {
      // TODO
    });
