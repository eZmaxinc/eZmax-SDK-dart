# openapi.model.EzsignfoldertypeResponseCompoundV4
...
**aFkiPdfalevelID** | **List<int>** |  | [optional] [default to const []]
**aObjUserlogintype** | [**List<UserlogintypeResponse>**](UserlogintypeResponse.md) |  | [default to const []]
**aObjUsergroupAll** | [**List<UsergroupResponse>**](UsergroupResponse.md) |  | [optional] [default to const []]
**aObjUsergroupRestricted** | [**List<UsergroupResponse>**](UsergroupResponse.md) |  | [optional] [default to const []]
**aObjUsergroupTemplate** | [**List<UsergroupResponse>**](UsergroupResponse.md) |  | [optional] [default to const []]
