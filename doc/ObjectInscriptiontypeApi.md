# openapi.api.ObjectInscriptiontypeApi
...
final api_instance = ObjectInscriptiontypeApi();
final sSelector = sSelector_example; // String | The type of Inscriptiontypes to return
final sQuery = sQuery_example; // String | Allow to filter the returned results
final acceptLanguage = ; // HeaderAcceptLanguage | 

try {
    final result = api_instance.inscriptiontypeGetAutocompleteV2(sSelector, sQuery, acceptLanguage);
    print(result);
} catch (e) {
    print('Exception when calling ObjectInscriptiontypeApi->inscriptiontypeGetAutocompleteV2: $e\n');
}
```
