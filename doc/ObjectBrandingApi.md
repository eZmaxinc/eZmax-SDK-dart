...
try {
    final result = api_instance.brandingGetAutocompleteV1(sSelector, eFilterActive, sQuery, acceptLanguage);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.brandingGetObjectV1(pkiBrandingID);
    print(result);
} catch (e) {
    print('Exception when calling ObjectBrandingApi->brandingGetObjectV1: $e\n');
}
```
