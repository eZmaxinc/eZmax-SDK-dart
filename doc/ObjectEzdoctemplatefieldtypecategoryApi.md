# openapi.api.ObjectEzdoctemplatefieldtypecategoryApi
...
final api_instance = ObjectEzdoctemplatefieldtypecategoryApi();
final sSelector = sSelector_example; // String | The type of Ezdoctemplatefieldtypecategorys to return
final eFilterActive = eFilterActive_example; // String | Specify which results we want to display.
final sQuery = sQuery_example; // String | Allow to filter the returned results
final acceptLanguage = ; // HeaderAcceptLanguage | 

try {
    final result = api_instance.ezdoctemplatefieldtypecategoryGetAutocompleteV2(sSelector, eFilterActive, sQuery, acceptLanguage);
    print(result);
} catch (e) {
    print('Exception when calling ObjectEzdoctemplatefieldtypecategoryApi->ezdoctemplatefieldtypecategoryGetAutocompleteV2: $e\n');
}
```
