...
try {
    final result = api_instance.ezsignbulksendGetObjectV1(pkiEzsignbulksendID);
    print(result);
} catch (e) {
    print('Exception when calling ObjectEzsignbulksendApi->ezsignbulksendGetObjectV1: $e\n');
}
```
