...
try {
    final result = api_instance.ezsigntemplateGetObjectV4(pkiEzsigntemplateID);
    print(result);
} catch (e) {
    print('Exception when calling ObjectEzsigntemplateApi->ezsigntemplateGetObjectV4: $e\n');
}
```
