...
final api_instance = ObjectTimezoneApi();
final sSelector = sSelector_example; // String | The type of Timezones to return
final eFilterActive = eFilterActive_example; // String | Specify which results we want to display.
final sQuery = sQuery_example; // String | Allow to filter the returned results
final acceptLanguage = ; // HeaderAcceptLanguage | 

try {
    final result = api_instance.timezoneGetAutocompleteV1(sSelector, eFilterActive, sQuery, acceptLanguage);
    print(result);
} catch (e) {
    print('Exception when calling ObjectTimezoneApi->timezoneGetAutocompleteV1: $e\n');
}
```
...
try {
    final result = api_instance.timezoneGetAutocompleteV2(sSelector, eFilterActive, sQuery, acceptLanguage);
    print(result);
} catch (e) {
    print('Exception when calling ObjectTimezoneApi->timezoneGetAutocompleteV2: $e\n');
}
```
