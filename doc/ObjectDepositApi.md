...
# **depositGetListV1**
> DepositGetListV1Response depositGetListV1(eOrderBy, iRowMax, iRowOffset, acceptLanguage, sFilter)
...
try {
    final result = api_instance.depositGetListV1(eOrderBy, iRowMax, iRowOffset, acceptLanguage, sFilter);
    print(result);
} catch (e) {
    print('Exception when calling ObjectDepositApi->depositGetListV1: $e\n');
}
```
