...
try {
    final result = api_instance.notificationtestGetElementsV2(pkiNotificationtestID);
    print(result);
} catch (e) {
    print('Exception when calling ObjectNotificationtestApi->notificationtestGetElementsV2: $e\n');
}
```
