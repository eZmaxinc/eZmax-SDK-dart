...
try {
    final result = api_instance.variableexpenseDeleteObjectV1(pkiVariableexpenseID);
    print(result);
} catch (e) {
    print('Exception when calling ObjectVariableexpenseApi->variableexpenseDeleteObjectV1: $e\n');
}
```
