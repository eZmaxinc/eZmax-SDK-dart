# openapi.model.EzsignfoldertypeRequestCompoundV3
...
**aFkiUserlogintypeID** | **List<int>** |  | [default to const []]
**aFkiUsergroupIDAll** | **List<int>** |  | [optional] [default to const []]
**aFkiUsergroupIDRestricted** | **List<int>** |  | [optional] [default to const []]
**aFkiUsergroupIDTemplate** | **List<int>** |  | [optional] [default to const []]
