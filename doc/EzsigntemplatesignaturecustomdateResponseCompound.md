# openapi.model.EzsigntemplatesignaturecustomdateResponseCompound
...
**iEzsigntemplatesignaturecustomdateY** | **int** | The Y coordinate (Vertical) where to put the Ezsigntemplatesignaturecustomdate on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsigntemplatesignaturecustomdate 3 inches from the top border of the page, you would use \"300\" for the Y coordinate. | [optional] 
