...
try {
    final result = api_instance.ezsigntemplatepackageGetObjectV1(pkiEzsigntemplatepackageID);
    print(result);
} catch (e) {
    print('Exception when calling ObjectEzsigntemplatepackageApi->ezsigntemplatepackageGetObjectV1: $e\n');
}
```
