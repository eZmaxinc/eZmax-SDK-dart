...
try {
    final result = api_instance.secretquestionGetAutocompleteV1(sSelector, eFilterActive, sQuery, acceptLanguage);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.secretquestionGetAutocompleteV2(sSelector, eFilterActive, sQuery, acceptLanguage);
    print(result);
} catch (e) {
    print('Exception when calling ObjectSecretquestionApi->secretquestionGetAutocompleteV2: $e\n');
}
```
