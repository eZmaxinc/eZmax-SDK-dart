# openapi.api.ObjectSessionhistoryApi
...
final api_instance = ObjectSessionhistoryApi();
...
try {
    final result = api_instance.sessionhistoryGetListV1(eOrderBy, iRowMax, iRowOffset, acceptLanguage, sFilter);
    print(result);
} catch (e) {
    print('Exception when calling ObjectSessionhistoryApi->sessionhistoryGetListV1: $e\n');
}
```
