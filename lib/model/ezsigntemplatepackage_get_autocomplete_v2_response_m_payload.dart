...
class EzsigntemplatepackageGetAutocompleteV2ResponseMPayload {
  ...
  static EzsigntemplatepackageGetAutocompleteV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsigntemplatepackage'), 'Required key "EzsigntemplatepackageGetAutocompleteV2ResponseMPayload[a_objEzsigntemplatepackage]" is missing from JSON.');
        assert(json[r'a_objEzsigntemplatepackage'] != null, 'Required key "EzsigntemplatepackageGetAutocompleteV2ResponseMPayload[a_objEzsigntemplatepackage]" has a null value in JSON.');
        return true;
      }());
