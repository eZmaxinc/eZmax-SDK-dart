...
class EzsigndocumentGetEzsignsignaturesV1ResponseMPayload {
  ...
  static EzsigndocumentGetEzsignsignaturesV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsignsignature'), 'Required key "EzsigndocumentGetEzsignsignaturesV1ResponseMPayload[a_objEzsignsignature]" is missing from JSON.');
        assert(json[r'a_objEzsignsignature'] != null, 'Required key "EzsigndocumentGetEzsignsignaturesV1ResponseMPayload[a_objEzsignsignature]" has a null value in JSON.');
        return true;
      }());
