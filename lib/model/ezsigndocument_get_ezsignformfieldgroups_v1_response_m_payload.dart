...
class EzsigndocumentGetEzsignformfieldgroupsV1ResponseMPayload {
  ...
  static EzsigndocumentGetEzsignformfieldgroupsV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsignformfieldgroup'), 'Required key "EzsigndocumentGetEzsignformfieldgroupsV1ResponseMPayload[a_objEzsignformfieldgroup]" is missing from JSON.');
        assert(json[r'a_objEzsignformfieldgroup'] != null, 'Required key "EzsigndocumentGetEzsignformfieldgroupsV1ResponseMPayload[a_objEzsignformfieldgroup]" has a null value in JSON.');
        return true;
      }());
  ...
  static Map<String, List<EzsigndocumentGetEzsignformfieldgroupsV1ResponseMPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsigndocumentGetEzsignformfieldgroupsV1ResponseMPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
