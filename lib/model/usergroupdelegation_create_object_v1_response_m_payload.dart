...
class UsergroupdelegationCreateObjectV1ResponseMPayload {
  ...
  static UsergroupdelegationCreateObjectV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiUsergroupdelegationID'), 'Required key "UsergroupdelegationCreateObjectV1ResponseMPayload[a_pkiUsergroupdelegationID]" is missing from JSON.');
        assert(json[r'a_pkiUsergroupdelegationID'] != null, 'Required key "UsergroupdelegationCreateObjectV1ResponseMPayload[a_pkiUsergroupdelegationID]" has a null value in JSON.');
        return true;
      }());
