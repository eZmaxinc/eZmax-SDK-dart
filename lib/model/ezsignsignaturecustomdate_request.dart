...
class EzsignsignaturecustomdateRequest {
  ...
  @override
  String toString() => 'EzsignsignaturecustomdateRequest[pkiEzsignsignaturecustomdateID=$pkiEzsignsignaturecustomdateID, iEzsignsignaturecustomdateX=$iEzsignsignaturecustomdateX, iEzsignsignaturecustomdateY=$iEzsignsignaturecustomdateY, iEzsignsignaturecustomdateOffsetx=$iEzsignsignaturecustomdateOffsetx, iEzsignsignaturecustomdateOffsety=$iEzsignsignaturecustomdateOffsety, sEzsignsignaturecustomdateFormat=$sEzsignsignaturecustomdateFormat]';
  ...
  static EzsignsignaturecustomdateRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'sEzsignsignaturecustomdateFormat'), 'Required key "EzsignsignaturecustomdateRequest[sEzsignsignaturecustomdateFormat]" is missing from JSON.');
        assert(json[r'sEzsignsignaturecustomdateFormat'] != null, 'Required key "EzsignsignaturecustomdateRequest[sEzsignsignaturecustomdateFormat]" has a null value in JSON.');
        return true;
      }());
  ...
  static Map<String, List<EzsignsignaturecustomdateRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsignsignaturecustomdateRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
