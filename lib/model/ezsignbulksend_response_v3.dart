...
class EzsignbulksendResponseV3 {
  /// Returns a new [EzsignbulksendResponseV3] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsignbulksendResponseV3 &&
  ...
  /// Returns a new [EzsignbulksendResponseV3] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsignbulksendResponseV3? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return EzsignbulksendResponseV3(
  ...
  static List<EzsignbulksendResponseV3> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsignbulksendResponseV3>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsignbulksendResponseV3.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsignbulksendResponseV3> mapFromJson(dynamic json) {
    final map = <String, EzsignbulksendResponseV3>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsignbulksendResponseV3.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsignbulksendResponseV3-objects as value to a dart map
  static Map<String, List<EzsignbulksendResponseV3>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsignbulksendResponseV3>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsignbulksendResponseV3.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
