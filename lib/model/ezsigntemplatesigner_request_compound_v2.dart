...
class EzsigntemplatesignerRequestCompoundV2 {
  /// Returns a new [EzsigntemplatesignerRequestCompoundV2] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsigntemplatesignerRequestCompoundV2 &&
  ...
  @override
  String toString() => 'EzsigntemplatesignerRequestCompoundV2[pkiEzsigntemplatesignerID=$pkiEzsigntemplatesignerID, fkiEzsigntemplateID=$fkiEzsigntemplateID, fkiUserID=$fkiUserID, fkiUsergroupID=$fkiUsergroupID, fkiEzdoctemplatedocumentID=$fkiEzdoctemplatedocumentID, eEzsigntemplatesignerRole=$eEzsigntemplatesignerRole, eEzsigntemplatesignerMapping=$eEzsigntemplatesignerMapping, sEzsigntemplatesignerDescription=$sEzsigntemplatesignerDescription]';
  ...
  /// Returns a new [EzsigntemplatesignerRequestCompoundV2] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsigntemplatesignerRequestCompoundV2? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiEzsigntemplateID'), 'Required key "EzsigntemplatesignerRequestCompoundV2[fkiEzsigntemplateID]" is missing from JSON.');
        assert(json[r'fkiEzsigntemplateID'] != null, 'Required key "EzsigntemplatesignerRequestCompoundV2[fkiEzsigntemplateID]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsigntemplatesignerDescription'), 'Required key "EzsigntemplatesignerRequestCompoundV2[sEzsigntemplatesignerDescription]" is missing from JSON.');
        assert(json[r'sEzsigntemplatesignerDescription'] != null, 'Required key "EzsigntemplatesignerRequestCompoundV2[sEzsigntemplatesignerDescription]" has a null value in JSON.');
        return true;
      }());

      return EzsigntemplatesignerRequestCompoundV2(
  ...
  static List<EzsigntemplatesignerRequestCompoundV2> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigntemplatesignerRequestCompoundV2>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigntemplatesignerRequestCompoundV2.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigntemplatesignerRequestCompoundV2> mapFromJson(dynamic json) {
    final map = <String, EzsigntemplatesignerRequestCompoundV2>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplatesignerRequestCompoundV2.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigntemplatesignerRequestCompoundV2-objects as value to a dart map
  static Map<String, List<EzsigntemplatesignerRequestCompoundV2>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigntemplatesignerRequestCompoundV2>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplatesignerRequestCompoundV2.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
