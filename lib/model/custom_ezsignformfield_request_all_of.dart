...
class CustomEzsignformfieldRequestAllOf {
  /// Returns a new [CustomEzsignformfieldRequestAllOf] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CustomEzsignformfieldRequestAllOf &&
  ...
  @override
  String toString() => 'CustomEzsignformfieldRequestAllOf[pkiEzsignformfieldID=$pkiEzsignformfieldID, sEzsignformfieldLabel=$sEzsignformfieldLabel, bEzsignformfieldSelected=$bEzsignformfieldSelected, sEzsignformfieldEnteredvalue=$sEzsignformfieldEnteredvalue]';
  ...
  /// Returns a new [CustomEzsignformfieldRequestAllOf] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CustomEzsignformfieldRequestAllOf? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CustomEzsignformfieldRequestAllOf[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CustomEzsignformfieldRequestAllOf[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return CustomEzsignformfieldRequestAllOf(
  ...
  static List<CustomEzsignformfieldRequestAllOf> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CustomEzsignformfieldRequestAllOf>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CustomEzsignformfieldRequestAllOf.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CustomEzsignformfieldRequestAllOf> mapFromJson(dynamic json) {
    final map = <String, CustomEzsignformfieldRequestAllOf>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CustomEzsignformfieldRequestAllOf.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CustomEzsignformfieldRequestAllOf-objects as value to a dart map
  static Map<String, List<CustomEzsignformfieldRequestAllOf>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CustomEzsignformfieldRequestAllOf>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CustomEzsignformfieldRequestAllOf.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
