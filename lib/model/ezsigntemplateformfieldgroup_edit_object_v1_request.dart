...
class EzsigntemplateformfieldgroupEditObjectV1Request {
  ...
  static EzsigntemplateformfieldgroupEditObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objEzsigntemplateformfieldgroup'), 'Required key "EzsigntemplateformfieldgroupEditObjectV1Request[objEzsigntemplateformfieldgroup]" is missing from JSON.');
        assert(json[r'objEzsigntemplateformfieldgroup'] != null, 'Required key "EzsigntemplateformfieldgroupEditObjectV1Request[objEzsigntemplateformfieldgroup]" has a null value in JSON.');
        return true;
      }());
  ...
  static Map<String, List<EzsigntemplateformfieldgroupEditObjectV1Request>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplateformfieldgroupEditObjectV1Request.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
