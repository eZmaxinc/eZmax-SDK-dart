...
enum FieldEEzsignsignatureSignaturepadrequired {
  no._(r'No'),
  ...
  const FieldEEzsignsignatureSignaturepadrequired._(this._value);
  ...
  /// Returns the instance of [FieldEEzsignsignatureSignaturepadrequired] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [FieldEEzsignsignatureSignaturepadrequired]
...
class FieldEEzsignsignatureSignaturepadrequiredTypeTransformer {
  ...
  /// Encodes this enum as a value suitable for JSON.
  String encode(FieldEEzsignsignatureSignaturepadrequired data) => data._value;
  ...
  FieldEEzsignsignatureSignaturepadrequired? decode(dynamic data, {bool allowNull = true}) {
    if (data is FieldEEzsignsignatureSignaturepadrequired) {
      return data;
    }
    if (data != null) {
      switch (data) {
