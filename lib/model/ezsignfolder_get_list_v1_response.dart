...
class EzsignfolderGetListV1Response {
  ...
  static List<EzsignfolderGetListV1Response> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(EzsignfolderGetListV1Response.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <EzsignfolderGetListV1Response>[];
  ...
  static Map<String, EzsignfolderGetListV1Response> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = EzsignfolderGetListV1Response.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of EzsignfolderGetListV1Response-objects as value to a dart map
  static Map<String, List<EzsignfolderGetListV1Response>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<EzsignfolderGetListV1Response>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = EzsignfolderGetListV1Response.listFromJson(
            value,
