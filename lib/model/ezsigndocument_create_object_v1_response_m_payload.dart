...
class EzsigndocumentCreateObjectV1ResponseMPayload {
  ...
  static EzsigndocumentCreateObjectV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiEzsigndocumentID'), 'Required key "EzsigndocumentCreateObjectV1ResponseMPayload[a_pkiEzsigndocumentID]" is missing from JSON.');
        assert(json[r'a_pkiEzsigndocumentID'] != null, 'Required key "EzsigndocumentCreateObjectV1ResponseMPayload[a_pkiEzsigndocumentID]" has a null value in JSON.');
        return true;
      }());
  ...
  static Map<String, List<EzsigndocumentCreateObjectV1ResponseMPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsigndocumentCreateObjectV1ResponseMPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
