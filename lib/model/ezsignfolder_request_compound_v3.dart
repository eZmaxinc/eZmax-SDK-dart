...
class EzsignfolderRequestCompoundV3 {
  ...
  static EzsignfolderRequestCompoundV3? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiEzsignfoldertypeID'), 'Required key "EzsignfolderRequestCompoundV3[fkiEzsignfoldertypeID]" is missing from JSON.');
        assert(json[r'fkiEzsignfoldertypeID'] != null, 'Required key "EzsignfolderRequestCompoundV3[fkiEzsignfoldertypeID]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsignfolderDescription'), 'Required key "EzsignfolderRequestCompoundV3[sEzsignfolderDescription]" is missing from JSON.');
        assert(json[r'sEzsignfolderDescription'] != null, 'Required key "EzsignfolderRequestCompoundV3[sEzsignfolderDescription]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsignfolderSendreminderfirstdays'), 'Required key "EzsignfolderRequestCompoundV3[iEzsignfolderSendreminderfirstdays]" is missing from JSON.');
        assert(json[r'iEzsignfolderSendreminderfirstdays'] != null, 'Required key "EzsignfolderRequestCompoundV3[iEzsignfolderSendreminderfirstdays]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsignfolderSendreminderotherdays'), 'Required key "EzsignfolderRequestCompoundV3[iEzsignfolderSendreminderotherdays]" is missing from JSON.');
        assert(json[r'iEzsignfolderSendreminderotherdays'] != null, 'Required key "EzsignfolderRequestCompoundV3[iEzsignfolderSendreminderotherdays]" has a null value in JSON.');
        return true;
      }());
