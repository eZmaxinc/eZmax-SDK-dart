...
class FontGetAutocompleteV2ResponseMPayload {
  ...
  static FontGetAutocompleteV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objFont'), 'Required key "FontGetAutocompleteV2ResponseMPayload[a_objFont]" is missing from JSON.');
        assert(json[r'a_objFont'] != null, 'Required key "FontGetAutocompleteV2ResponseMPayload[a_objFont]" has a null value in JSON.');
        return true;
      }());
