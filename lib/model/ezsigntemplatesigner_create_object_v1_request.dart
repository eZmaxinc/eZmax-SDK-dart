...
class EzsigntemplatesignerCreateObjectV1Request {
  ...
  static EzsigntemplatesignerCreateObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsigntemplatesigner'), 'Required key "EzsigntemplatesignerCreateObjectV1Request[a_objEzsigntemplatesigner]" is missing from JSON.');
        assert(json[r'a_objEzsigntemplatesigner'] != null, 'Required key "EzsigntemplatesignerCreateObjectV1Request[a_objEzsigntemplatesigner]" has a null value in JSON.');
        return true;
      }());
