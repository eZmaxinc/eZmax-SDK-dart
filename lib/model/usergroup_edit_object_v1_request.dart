...
class UsergroupEditObjectV1Request {
  ...
  static UsergroupEditObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objUsergroup'), 'Required key "UsergroupEditObjectV1Request[objUsergroup]" is missing from JSON.');
        assert(json[r'objUsergroup'] != null, 'Required key "UsergroupEditObjectV1Request[objUsergroup]" has a null value in JSON.');
        return true;
      }());
