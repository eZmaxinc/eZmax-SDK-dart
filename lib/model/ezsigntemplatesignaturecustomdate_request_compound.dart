...
class EzsigntemplatesignaturecustomdateRequestCompound {
  ...
  static EzsigntemplatesignaturecustomdateRequestCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'sEzsigntemplatesignaturecustomdateFormat'), 'Required key "EzsigntemplatesignaturecustomdateRequestCompound[sEzsigntemplatesignaturecustomdateFormat]" is missing from JSON.');
        assert(json[r'sEzsigntemplatesignaturecustomdateFormat'] != null, 'Required key "EzsigntemplatesignaturecustomdateRequestCompound[sEzsigntemplatesignaturecustomdateFormat]" has a null value in JSON.');
        return true;
      }());
