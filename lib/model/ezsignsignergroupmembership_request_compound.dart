...
class EzsignsignergroupmembershipRequestCompound {
  ...
  static EzsignsignergroupmembershipRequestCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiEzsignsignergroupID'), 'Required key "EzsignsignergroupmembershipRequestCompound[fkiEzsignsignergroupID]" is missing from JSON.');
        assert(json[r'fkiEzsignsignergroupID'] != null, 'Required key "EzsignsignergroupmembershipRequestCompound[fkiEzsignsignergroupID]" has a null value in JSON.');
        return true;
      }());
