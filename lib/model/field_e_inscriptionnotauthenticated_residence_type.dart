...
class FieldEInscriptionnotauthenticatedResidenceType {
  ...
  const FieldEInscriptionnotauthenticatedResidenceType._(this.value);
  ...
  static const principal = FieldEInscriptionnotauthenticatedResidenceType._(r'Principal');
  static const secondary = FieldEInscriptionnotauthenticatedResidenceType._(r'Secondary');

  /// List of all possible values in this [enum][FieldEInscriptionnotauthenticatedResidenceType].
  static const values = <FieldEInscriptionnotauthenticatedResidenceType>[
    principal,
    secondary,
  ];
...
class FieldEInscriptionnotauthenticatedResidenceTypeTypeTransformer {
  ...
  String encode(FieldEInscriptionnotauthenticatedResidenceType data) => data.value;

  /// Decodes a [dynamic value][data] to a FieldEInscriptionnotauthenticatedResidenceType.
  ///
  ...
  /// Singleton [FieldEInscriptionnotauthenticatedResidenceTypeTypeTransformer] instance.
