...
class WebhookRealestateInscriptionnotauthenticatedCreated {
  /// Returns a new [WebhookRealestateInscriptionnotauthenticatedCreated] instance.
  ...
  /// Returns a new [WebhookRealestateInscriptionnotauthenticatedCreated] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static WebhookRealestateInscriptionnotauthenticatedCreated? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objWebhook'), 'Required key "WebhookRealestateInscriptionnotauthenticatedCreated[objWebhook]" is missing from JSON.');
  ...
  static List<WebhookRealestateInscriptionnotauthenticatedCreated> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <WebhookRealestateInscriptionnotauthenticatedCreated>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = WebhookRealestateInscriptionnotauthenticatedCreated.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, WebhookRealestateInscriptionnotauthenticatedCreated> mapFromJson(dynamic json) {
    final map = <String, WebhookRealestateInscriptionnotauthenticatedCreated>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = WebhookRealestateInscriptionnotauthenticatedCreated.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of WebhookRealestateInscriptionnotauthenticatedCreated-objects as value to a dart map
  static Map<String, List<WebhookRealestateInscriptionnotauthenticatedCreated>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<WebhookRealestateInscriptionnotauthenticatedCreated>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = WebhookRealestateInscriptionnotauthenticatedCreated.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
