...
class UsergroupGetListV1Response {
  ...
  static UsergroupGetListV1Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "UsergroupGetListV1Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "UsergroupGetListV1Response[objDebugPayload]" has a null value in JSON.');
        assert(json.containsKey(r'mPayload'), 'Required key "UsergroupGetListV1Response[mPayload]" is missing from JSON.');
        assert(json[r'mPayload'] != null, 'Required key "UsergroupGetListV1Response[mPayload]" has a null value in JSON.');
        return true;
      }());
