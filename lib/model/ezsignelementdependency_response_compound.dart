...
class EzsignelementdependencyResponseCompound {
  /// Returns a new [EzsignelementdependencyResponseCompound] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsignelementdependencyResponseCompound &&
  ...
  @override
  String toString() => 'EzsignelementdependencyResponseCompound[pkiEzsignelementdependencyID=$pkiEzsignelementdependencyID, fkiEzsignformfieldID=$fkiEzsignformfieldID, fkiEzsignsignatureID=$fkiEzsignsignatureID, fkiEzsignformfieldIDValidation=$fkiEzsignformfieldIDValidation, fkiEzsignformfieldgroupIDValidation=$fkiEzsignformfieldgroupIDValidation, eEzsignelementdependencyValidation=$eEzsignelementdependencyValidation, bEzsignelementdependencySelected=$bEzsignelementdependencySelected, eEzsignelementdependencyOperator=$eEzsignelementdependencyOperator, sEzsignelementdependencyValue=$sEzsignelementdependencyValue]';
  ...
  /// Returns a new [EzsignelementdependencyResponseCompound] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsignelementdependencyResponseCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsignelementdependencyID'), 'Required key "EzsignelementdependencyResponseCompound[pkiEzsignelementdependencyID]" is missing from JSON.');
        assert(json[r'pkiEzsignelementdependencyID'] != null, 'Required key "EzsignelementdependencyResponseCompound[pkiEzsignelementdependencyID]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsignelementdependencyValidation'), 'Required key "EzsignelementdependencyResponseCompound[eEzsignelementdependencyValidation]" is missing from JSON.');
        assert(json[r'eEzsignelementdependencyValidation'] != null, 'Required key "EzsignelementdependencyResponseCompound[eEzsignelementdependencyValidation]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<EzsignelementdependencyResponseCompound> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsignelementdependencyResponseCompound>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsignelementdependencyResponseCompound.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsignelementdependencyResponseCompound> mapFromJson(dynamic json) {
    final map = <String, EzsignelementdependencyResponseCompound>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsignelementdependencyResponseCompound.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsignelementdependencyResponseCompound-objects as value to a dart map
  static Map<String, List<EzsignelementdependencyResponseCompound>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsignelementdependencyResponseCompound>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsignelementdependencyResponseCompound.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
