...
class FranchiseofficeGetAutocompleteV2ResponseMPayload {
  ...
  static FranchiseofficeGetAutocompleteV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objFranchiseoffice'), 'Required key "FranchiseofficeGetAutocompleteV2ResponseMPayload[a_objFranchiseoffice]" is missing from JSON.');
        assert(json[r'a_objFranchiseoffice'] != null, 'Required key "FranchiseofficeGetAutocompleteV2ResponseMPayload[a_objFranchiseoffice]" has a null value in JSON.');
        return true;
      }());
