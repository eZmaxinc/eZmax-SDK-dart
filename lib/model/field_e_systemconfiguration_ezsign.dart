  ...
  static List<FieldESystemconfigurationEzsign> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FieldESystemconfigurationEzsign.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [FieldESystemconfigurationEzsign] to String,
/// and [decode] dynamic data back to [FieldESystemconfigurationEzsign].
class FieldESystemconfigurationEzsignTypeTransformer {
  factory FieldESystemconfigurationEzsignTypeTransformer() => _instance ??= const FieldESystemconfigurationEzsignTypeTransformer._();
  ...
  FieldESystemconfigurationEzsign? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'Yes': return FieldESystemconfigurationEzsign.yes;
        default:
          if (!allowNull) {
