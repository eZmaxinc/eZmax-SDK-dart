...
enum FieldECommunicationImportance {
  high._(r'High'),
  normal._(r'Normal'),
  low._(r'Low'),
  ;
  ...
  const FieldECommunicationImportance._(this._value);
  ...
  /// Returns the instance of [FieldECommunicationImportance] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [FieldECommunicationImportance]
...
class FieldECommunicationImportanceTypeTransformer {
  ...
  /// Encodes this enum as a value suitable for JSON.
  String encode(FieldECommunicationImportance data) => data._value;
  ...
  FieldECommunicationImportance? decode(dynamic data, {bool allowNull = true}) {
    if (data is FieldECommunicationImportance) {
      return data;
    }
    if (data != null) {
      switch (data) {
