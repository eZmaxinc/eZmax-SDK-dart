...
class EzsignsignatureCreateObjectV1ResponseMPayload {
  ...
  static EzsignsignatureCreateObjectV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiEzsignsignatureID'), 'Required key "EzsignsignatureCreateObjectV1ResponseMPayload[a_pkiEzsignsignatureID]" is missing from JSON.');
        assert(json[r'a_pkiEzsignsignatureID'] != null, 'Required key "EzsignsignatureCreateObjectV1ResponseMPayload[a_pkiEzsignsignatureID]" has a null value in JSON.');
        return true;
      }());
  ...
  static Map<String, List<EzsignsignatureCreateObjectV1ResponseMPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsignsignatureCreateObjectV1ResponseMPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
