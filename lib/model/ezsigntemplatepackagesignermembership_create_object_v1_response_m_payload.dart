...
class EzsigntemplatepackagesignermembershipCreateObjectV1ResponseMPayload {
  ...
  bool operator ==(Object other) => identical(this, other) || other is EzsigntemplatepackagesignermembershipCreateObjectV1ResponseMPayload &&
    _deepEquality.equals(other.aPkiEzsigntemplatepackagesignermembershipID, aPkiEzsigntemplatepackagesignermembershipID);
  ...
  static EzsigntemplatepackagesignermembershipCreateObjectV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiEzsigntemplatepackagesignermembershipID'), 'Required key "EzsigntemplatepackagesignermembershipCreateObjectV1ResponseMPayload[a_pkiEzsigntemplatepackagesignermembershipID]" is missing from JSON.');
        assert(json[r'a_pkiEzsigntemplatepackagesignermembershipID'] != null, 'Required key "EzsigntemplatepackagesignermembershipCreateObjectV1ResponseMPayload[a_pkiEzsigntemplatepackagesignermembershipID]" has a null value in JSON.');
        return true;
      }());

      return EzsigntemplatepackagesignermembershipCreateObjectV1ResponseMPayload(
        aPkiEzsigntemplatepackagesignermembershipID: json[r'a_pkiEzsigntemplatepackagesignermembershipID'] is Iterable
            ? (json[r'a_pkiEzsigntemplatepackagesignermembershipID'] as Iterable).cast<int>().toList(growable: false)
            : const [],
      );
    }
    return null;
  ...
  static Map<String, List<EzsigntemplatepackagesignermembershipCreateObjectV1ResponseMPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplatepackagesignermembershipCreateObjectV1ResponseMPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
