...
class EzsigndocumentEditEzsignformfieldgroupsV1ResponseMPayload {
  ...
  static EzsigndocumentEditEzsignformfieldgroupsV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiEzsignformfieldgroupID'), 'Required key "EzsigndocumentEditEzsignformfieldgroupsV1ResponseMPayload[a_pkiEzsignformfieldgroupID]" is missing from JSON.');
        assert(json[r'a_pkiEzsignformfieldgroupID'] != null, 'Required key "EzsigndocumentEditEzsignformfieldgroupsV1ResponseMPayload[a_pkiEzsignformfieldgroupID]" has a null value in JSON.');
        return true;
      }());
