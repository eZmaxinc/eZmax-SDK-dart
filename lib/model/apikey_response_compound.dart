...
class ApikeyResponseCompound {
  ...
  @override
  String toString() => 'ApikeyResponseCompound[pkiApikeyID=$pkiApikeyID, fkiUserID=$fkiUserID, fkiEzmaxpartnerproductstageID=$fkiEzmaxpartnerproductstageID, objApikeyDescription=$objApikeyDescription, objContactName=$objContactName, sApikeyApikey=$sApikeyApikey, sApikeySecret=$sApikeySecret, bApikeyIsactive=$bApikeyIsactive, bApikeyIssigned=$bApikeyIssigned, objAudit=$objAudit]';
