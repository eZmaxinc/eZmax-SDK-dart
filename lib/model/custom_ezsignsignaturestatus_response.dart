...
class CustomEzsignsignaturestatusResponse {
  ...
  static Map<String, List<CustomEzsignsignaturestatusResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = CustomEzsignsignaturestatusResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Type of step
enum CustomEzsignsignaturestatusResponseEEzsignsignaturestatusSteptypeEnum {
  form._(r'Form'),
  signature._(r'Signature'),
  ;

  /// Instantiate a new enum with the provided value.
  const CustomEzsignsignaturestatusResponseEEzsignsignaturestatusSteptypeEnum._(this._value);
  ...
  /// Returns the instance of [CustomEzsignsignaturestatusResponseEEzsignsignaturestatusSteptypeEnum] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [CustomEzsignsignaturestatusResponseEEzsignsignaturestatusSteptypeEnum]
...
class CustomEzsignsignaturestatusResponseEEzsignsignaturestatusSteptypeEnumTypeTransformer {
  ...
  String encode(CustomEzsignsignaturestatusResponseEEzsignsignaturestatusSteptypeEnum data) => data._value;
  ...
  CustomEzsignsignaturestatusResponseEEzsignsignaturestatusSteptypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data is CustomEzsignsignaturestatusResponseEEzsignsignaturestatusSteptypeEnum) {
      return data;
    }
    if (data != null) {
      switch (data) {
