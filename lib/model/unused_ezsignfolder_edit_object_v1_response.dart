...
class UNUSEDEzsignfolderEditObjectV1Response {
  ...
  static List<UNUSEDEzsignfolderEditObjectV1Response> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(UNUSEDEzsignfolderEditObjectV1Response.fromJson).toList(growable: true == growable)
  ...
  static Map<String, UNUSEDEzsignfolderEditObjectV1Response> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = UNUSEDEzsignfolderEditObjectV1Response.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of UNUSEDEzsignfolderEditObjectV1Response-objects as value to a dart map
  static Map<String, List<UNUSEDEzsignfolderEditObjectV1Response>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<UNUSEDEzsignfolderEditObjectV1Response>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = UNUSEDEzsignfolderEditObjectV1Response.listFromJson(
            value,
