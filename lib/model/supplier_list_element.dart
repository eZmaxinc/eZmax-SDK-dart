...
class SupplierListElement {
  ...
  static SupplierListElement? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiSupplierID'), 'Required key "SupplierListElement[pkiSupplierID]" is missing from JSON.');
        assert(json[r'pkiSupplierID'] != null, 'Required key "SupplierListElement[pkiSupplierID]" has a null value in JSON.');
        assert(json.containsKey(r'sSupplierName'), 'Required key "SupplierListElement[sSupplierName]" is missing from JSON.');
        assert(json[r'sSupplierName'] != null, 'Required key "SupplierListElement[sSupplierName]" has a null value in JSON.');
        assert(json.containsKey(r'sSupplierCode'), 'Required key "SupplierListElement[sSupplierCode]" is missing from JSON.');
        assert(json[r'sSupplierCode'] != null, 'Required key "SupplierListElement[sSupplierCode]" has a null value in JSON.');
        assert(json.containsKey(r'sSupplierAccount'), 'Required key "SupplierListElement[sSupplierAccount]" is missing from JSON.');
        assert(json[r'sSupplierAccount'] != null, 'Required key "SupplierListElement[sSupplierAccount]" has a null value in JSON.');
        assert(json.containsKey(r'bSupplierIsactive'), 'Required key "SupplierListElement[bSupplierIsactive]" is missing from JSON.');
        assert(json[r'bSupplierIsactive'] != null, 'Required key "SupplierListElement[bSupplierIsactive]" has a null value in JSON.');
        assert(json.containsKey(r'sGlaccountcontainerLongcode'), 'Required key "SupplierListElement[sGlaccountcontainerLongcode]" is missing from JSON.');
        assert(json[r'sGlaccountcontainerLongcode'] != null, 'Required key "SupplierListElement[sGlaccountcontainerLongcode]" has a null value in JSON.');
        assert(json.containsKey(r'sGlaccountcontainerLongdescriptionX'), 'Required key "SupplierListElement[sGlaccountcontainerLongdescriptionX]" is missing from JSON.');
        assert(json[r'sGlaccountcontainerLongdescriptionX'] != null, 'Required key "SupplierListElement[sGlaccountcontainerLongdescriptionX]" has a null value in JSON.');
        return true;
      }());
