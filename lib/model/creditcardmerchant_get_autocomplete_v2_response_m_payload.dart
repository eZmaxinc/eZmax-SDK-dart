...
class CreditcardmerchantGetAutocompleteV2ResponseMPayload {
  ...
  static CreditcardmerchantGetAutocompleteV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objCreditcardmerchant'), 'Required key "CreditcardmerchantGetAutocompleteV2ResponseMPayload[a_objCreditcardmerchant]" is missing from JSON.');
        assert(json[r'a_objCreditcardmerchant'] != null, 'Required key "CreditcardmerchantGetAutocompleteV2ResponseMPayload[a_objCreditcardmerchant]" has a null value in JSON.');
        return true;
      }());
