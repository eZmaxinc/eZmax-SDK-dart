...
class UserRequest {
  ...
  static UserRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiCompanyIDDefault'), 'Required key "UserRequest[fkiCompanyIDDefault]" is missing from JSON.');
        assert(json[r'fkiCompanyIDDefault'] != null, 'Required key "UserRequest[fkiCompanyIDDefault]" has a null value in JSON.');
        assert(json.containsKey(r'fkiDepartmentIDDefault'), 'Required key "UserRequest[fkiDepartmentIDDefault]" is missing from JSON.');
        assert(json[r'fkiDepartmentIDDefault'] != null, 'Required key "UserRequest[fkiDepartmentIDDefault]" has a null value in JSON.');
        assert(json.containsKey(r'fkiTimezoneID'), 'Required key "UserRequest[fkiTimezoneID]" is missing from JSON.');
        assert(json[r'fkiTimezoneID'] != null, 'Required key "UserRequest[fkiTimezoneID]" has a null value in JSON.');
        assert(json.containsKey(r'fkiLanguageID'), 'Required key "UserRequest[fkiLanguageID]" is missing from JSON.');
        assert(json[r'fkiLanguageID'] != null, 'Required key "UserRequest[fkiLanguageID]" has a null value in JSON.');
        assert(json.containsKey(r'objEmail'), 'Required key "UserRequest[objEmail]" is missing from JSON.');
        assert(json[r'objEmail'] != null, 'Required key "UserRequest[objEmail]" has a null value in JSON.');
        assert(json.containsKey(r'fkiBillingentityinternalID'), 'Required key "UserRequest[fkiBillingentityinternalID]" is missing from JSON.');
        assert(json[r'fkiBillingentityinternalID'] != null, 'Required key "UserRequest[fkiBillingentityinternalID]" has a null value in JSON.');
        assert(json.containsKey(r'eUserType'), 'Required key "UserRequest[eUserType]" is missing from JSON.');
        assert(json[r'eUserType'] != null, 'Required key "UserRequest[eUserType]" has a null value in JSON.');
        assert(json.containsKey(r'eUserLogintype'), 'Required key "UserRequest[eUserLogintype]" is missing from JSON.');
        assert(json[r'eUserLogintype'] != null, 'Required key "UserRequest[eUserLogintype]" has a null value in JSON.');
        assert(json.containsKey(r'sUserFirstname'), 'Required key "UserRequest[sUserFirstname]" is missing from JSON.');
        assert(json[r'sUserFirstname'] != null, 'Required key "UserRequest[sUserFirstname]" has a null value in JSON.');
        assert(json.containsKey(r'sUserLastname'), 'Required key "UserRequest[sUserLastname]" is missing from JSON.');
        assert(json[r'sUserLastname'] != null, 'Required key "UserRequest[sUserLastname]" has a null value in JSON.');
        assert(json.containsKey(r'sUserLoginname'), 'Required key "UserRequest[sUserLoginname]" is missing from JSON.');
        assert(json[r'sUserLoginname'] != null, 'Required key "UserRequest[sUserLoginname]" has a null value in JSON.');
        assert(json.containsKey(r'eUserEzsignaccess'), 'Required key "UserRequest[eUserEzsignaccess]" is missing from JSON.');
        assert(json[r'eUserEzsignaccess'] != null, 'Required key "UserRequest[eUserEzsignaccess]" has a null value in JSON.');
        assert(json.containsKey(r'bUserIsactive'), 'Required key "UserRequest[bUserIsactive]" is missing from JSON.');
        assert(json[r'bUserIsactive'] != null, 'Required key "UserRequest[bUserIsactive]" has a null value in JSON.');
        return true;
      }());
