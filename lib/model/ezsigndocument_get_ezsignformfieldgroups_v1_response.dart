...
class EzsigndocumentGetEzsignformfieldgroupsV1Response {
  ...
  @override
  String toString() => 'EzsigndocumentGetEzsignformfieldgroupsV1Response[objDebugPayload=$objDebugPayload, objDebug=$objDebug, mPayload=$mPayload]';
  ...
  static EzsigndocumentGetEzsignformfieldgroupsV1Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "EzsigndocumentGetEzsignformfieldgroupsV1Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "EzsigndocumentGetEzsignformfieldgroupsV1Response[objDebugPayload]" has a null value in JSON.');
        assert(json.containsKey(r'mPayload'), 'Required key "EzsigndocumentGetEzsignformfieldgroupsV1Response[mPayload]" is missing from JSON.');
        assert(json[r'mPayload'] != null, 'Required key "EzsigndocumentGetEzsignformfieldgroupsV1Response[mPayload]" has a null value in JSON.');
        return true;
      }());
