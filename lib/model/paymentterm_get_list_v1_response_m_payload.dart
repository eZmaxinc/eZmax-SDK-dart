...
class PaymenttermGetListV1ResponseMPayload {
  ...
  static PaymenttermGetListV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'iRowReturned'), 'Required key "PaymenttermGetListV1ResponseMPayload[iRowReturned]" is missing from JSON.');
        assert(json[r'iRowReturned'] != null, 'Required key "PaymenttermGetListV1ResponseMPayload[iRowReturned]" has a null value in JSON.');
        assert(json.containsKey(r'iRowFiltered'), 'Required key "PaymenttermGetListV1ResponseMPayload[iRowFiltered]" is missing from JSON.');
        assert(json[r'iRowFiltered'] != null, 'Required key "PaymenttermGetListV1ResponseMPayload[iRowFiltered]" has a null value in JSON.');
        assert(json.containsKey(r'a_objPaymentterm'), 'Required key "PaymenttermGetListV1ResponseMPayload[a_objPaymentterm]" is missing from JSON.');
        assert(json[r'a_objPaymentterm'] != null, 'Required key "PaymenttermGetListV1ResponseMPayload[a_objPaymentterm]" has a null value in JSON.');
        return true;
      }());
