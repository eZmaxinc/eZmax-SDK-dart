...
class UsergroupEditUsergroupdelegationsV1Request {
  ...
  static UsergroupEditUsergroupdelegationsV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objUsergroupdelegation'), 'Required key "UsergroupEditUsergroupdelegationsV1Request[a_objUsergroupdelegation]" is missing from JSON.');
        assert(json[r'a_objUsergroupdelegation'] != null, 'Required key "UsergroupEditUsergroupdelegationsV1Request[a_objUsergroupdelegation]" has a null value in JSON.');
        return true;
      }());
