...
class EzsigndocumentExtractTextV1Request {
  ...
  static EzsigndocumentExtractTextV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'iPage'), 'Required key "EzsigndocumentExtractTextV1Request[iPage]" is missing from JSON.');
        assert(json[r'iPage'] != null, 'Required key "EzsigndocumentExtractTextV1Request[iPage]" has a null value in JSON.');
        return true;
      }());
