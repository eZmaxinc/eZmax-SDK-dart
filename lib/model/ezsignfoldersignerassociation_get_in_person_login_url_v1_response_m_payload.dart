...
class EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseMPayload {
  ...
  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'sLoginUrl'] = this.sLoginUrl;
    return json;
  }
  ...
  static EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'sLoginUrl'), 'Required key "EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseMPayload[sLoginUrl]" is missing from JSON.');
        assert(json[r'sLoginUrl'] != null, 'Required key "EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseMPayload[sLoginUrl]" has a null value in JSON.');
        return true;
      }());
  ...
  static Map<String, List<EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseMPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseMPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
