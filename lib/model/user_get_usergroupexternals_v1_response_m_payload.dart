...
class UserGetUsergroupexternalsV1ResponseMPayload {
  ...
  static UserGetUsergroupexternalsV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objUsergroupexternal'), 'Required key "UserGetUsergroupexternalsV1ResponseMPayload[a_objUsergroupexternal]" is missing from JSON.');
        assert(json[r'a_objUsergroupexternal'] != null, 'Required key "UserGetUsergroupexternalsV1ResponseMPayload[a_objUsergroupexternal]" has a null value in JSON.');
        return true;
      }());
