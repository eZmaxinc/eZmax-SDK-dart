...
class EzsignsignaturecustomdateResponseV2 {
  /// Returns a new [EzsignsignaturecustomdateResponseV2] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsignsignaturecustomdateResponseV2 &&
  ...
  @override
  String toString() => 'EzsignsignaturecustomdateResponseV2[pkiEzsignsignaturecustomdateID=$pkiEzsignsignaturecustomdateID, iEzsignsignaturecustomdateOffsetx=$iEzsignsignaturecustomdateOffsetx, iEzsignsignaturecustomdateOffsety=$iEzsignsignaturecustomdateOffsety, sEzsignsignaturecustomdateFormat=$sEzsignsignaturecustomdateFormat]';
  ...
  /// Returns a new [EzsignsignaturecustomdateResponseV2] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsignsignaturecustomdateResponseV2? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsignsignaturecustomdateID'), 'Required key "EzsignsignaturecustomdateResponseV2[pkiEzsignsignaturecustomdateID]" is missing from JSON.');
        assert(json[r'pkiEzsignsignaturecustomdateID'] != null, 'Required key "EzsignsignaturecustomdateResponseV2[pkiEzsignsignaturecustomdateID]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsignsignaturecustomdateOffsetx'), 'Required key "EzsignsignaturecustomdateResponseV2[iEzsignsignaturecustomdateOffsetx]" is missing from JSON.');
        assert(json[r'iEzsignsignaturecustomdateOffsetx'] != null, 'Required key "EzsignsignaturecustomdateResponseV2[iEzsignsignaturecustomdateOffsetx]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsignsignaturecustomdateOffsety'), 'Required key "EzsignsignaturecustomdateResponseV2[iEzsignsignaturecustomdateOffsety]" is missing from JSON.');
        assert(json[r'iEzsignsignaturecustomdateOffsety'] != null, 'Required key "EzsignsignaturecustomdateResponseV2[iEzsignsignaturecustomdateOffsety]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsignsignaturecustomdateFormat'), 'Required key "EzsignsignaturecustomdateResponseV2[sEzsignsignaturecustomdateFormat]" is missing from JSON.');
        assert(json[r'sEzsignsignaturecustomdateFormat'] != null, 'Required key "EzsignsignaturecustomdateResponseV2[sEzsignsignaturecustomdateFormat]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<EzsignsignaturecustomdateResponseV2> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsignsignaturecustomdateResponseV2>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsignsignaturecustomdateResponseV2.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsignsignaturecustomdateResponseV2> mapFromJson(dynamic json) {
    final map = <String, EzsignsignaturecustomdateResponseV2>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsignsignaturecustomdateResponseV2.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsignsignaturecustomdateResponseV2-objects as value to a dart map
  static Map<String, List<EzsignsignaturecustomdateResponseV2>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsignsignaturecustomdateResponseV2>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsignsignaturecustomdateResponseV2.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
