...
class UsergroupRequest {
  ...
  static UsergroupRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objUsergroupName'), 'Required key "UsergroupRequest[objUsergroupName]" is missing from JSON.');
        assert(json[r'objUsergroupName'] != null, 'Required key "UsergroupRequest[objUsergroupName]" has a null value in JSON.');
        return true;
      }());
