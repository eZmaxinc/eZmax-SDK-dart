...
class DiscussionCreateObjectV1ResponseMPayload {
  ...
  static DiscussionCreateObjectV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiDiscussionID'), 'Required key "DiscussionCreateObjectV1ResponseMPayload[a_pkiDiscussionID]" is missing from JSON.');
        assert(json[r'a_pkiDiscussionID'] != null, 'Required key "DiscussionCreateObjectV1ResponseMPayload[a_pkiDiscussionID]" has a null value in JSON.');
        return true;
      }());
