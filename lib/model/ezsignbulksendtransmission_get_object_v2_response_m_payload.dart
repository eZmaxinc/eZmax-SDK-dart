...
class EzsignbulksendtransmissionGetObjectV2ResponseMPayload {
  ...
  static EzsignbulksendtransmissionGetObjectV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objEzsignbulksendtransmission'), 'Required key "EzsignbulksendtransmissionGetObjectV2ResponseMPayload[objEzsignbulksendtransmission]" is missing from JSON.');
        assert(json[r'objEzsignbulksendtransmission'] != null, 'Required key "EzsignbulksendtransmissionGetObjectV2ResponseMPayload[objEzsignbulksendtransmission]" has a null value in JSON.');
        return true;
      }());
