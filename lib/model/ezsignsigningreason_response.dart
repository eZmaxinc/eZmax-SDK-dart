...
class EzsignsigningreasonResponse {
  ...
  static EzsignsigningreasonResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsignsigningreasonID'), 'Required key "EzsignsigningreasonResponse[pkiEzsignsigningreasonID]" is missing from JSON.');
        assert(json[r'pkiEzsignsigningreasonID'] != null, 'Required key "EzsignsigningreasonResponse[pkiEzsignsigningreasonID]" has a null value in JSON.');
        assert(json.containsKey(r'objEzsignsigningreasonDescription'), 'Required key "EzsignsigningreasonResponse[objEzsignsigningreasonDescription]" is missing from JSON.');
        assert(json[r'objEzsignsigningreasonDescription'] != null, 'Required key "EzsignsigningreasonResponse[objEzsignsigningreasonDescription]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsignsigningreasonIsactive'), 'Required key "EzsignsigningreasonResponse[bEzsignsigningreasonIsactive]" is missing from JSON.');
        assert(json[r'bEzsignsigningreasonIsactive'] != null, 'Required key "EzsignsigningreasonResponse[bEzsignsigningreasonIsactive]" has a null value in JSON.');
        return true;
      }());
