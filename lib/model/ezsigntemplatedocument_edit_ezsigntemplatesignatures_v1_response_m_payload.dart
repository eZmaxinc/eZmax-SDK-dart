...
class EzsigntemplatedocumentEditEzsigntemplatesignaturesV1ResponseMPayload {
  ...
  static EzsigntemplatedocumentEditEzsigntemplatesignaturesV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiEzsigntemplatesignatureID'), 'Required key "EzsigntemplatedocumentEditEzsigntemplatesignaturesV1ResponseMPayload[a_pkiEzsigntemplatesignatureID]" is missing from JSON.');
        assert(json[r'a_pkiEzsigntemplatesignatureID'] != null, 'Required key "EzsigntemplatedocumentEditEzsigntemplatesignaturesV1ResponseMPayload[a_pkiEzsigntemplatesignatureID]" has a null value in JSON.');
        return true;
      }());
