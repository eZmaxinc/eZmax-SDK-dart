...
class DepartmentGetAutocompleteV2ResponseMPayload {
  /// Returns a new [DepartmentGetAutocompleteV2ResponseMPayload] instance.
  DepartmentGetAutocompleteV2ResponseMPayload({
    this.aObjDepartment = const [],
  });

  /// An array of Department autocomplete element response.
  List<DepartmentAutocompleteElementResponse> aObjDepartment;

  @override
  bool operator ==(Object other) => identical(this, other) || other is DepartmentGetAutocompleteV2ResponseMPayload &&
    _deepEquality.equals(other.aObjDepartment, aObjDepartment);

  @override
  int get hashCode =>
    // ignore: unnecessary_parenthesis
    (aObjDepartment.hashCode);
  ...
  static DepartmentGetAutocompleteV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<DepartmentGetAutocompleteV2ResponseMPayload> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DepartmentGetAutocompleteV2ResponseMPayload.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DepartmentGetAutocompleteV2ResponseMPayload> mapFromJson(dynamic json) {
    final map = <String, DepartmentGetAutocompleteV2ResponseMPayload>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DepartmentGetAutocompleteV2ResponseMPayload.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of DepartmentGetAutocompleteV2ResponseMPayload-objects as value to a dart map
