...
class EzsigntemplateResponseCompoundV4 {
  /// Returns a new [EzsigntemplateResponseCompoundV4] instance.
  ...
  List<EzsigntemplatesignerResponseCompoundV3> aObjEzsigntemplatesigner;

  List<EzsigntemplateannotationResponseCompound> aObjEzsigntemplateannotation;

  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsigntemplateResponseCompoundV4 &&
  ...
  /// Returns a new [EzsigntemplateResponseCompoundV4] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsigntemplateResponseCompoundV4? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsigntemplateID'), 'Required key "EzsigntemplateResponseCompoundV4[pkiEzsigntemplateID]" is missing from JSON.');
        assert(json[r'pkiEzsigntemplateID'] != null, 'Required key "EzsigntemplateResponseCompoundV4[pkiEzsigntemplateID]" has a null value in JSON.');
        assert(json.containsKey(r'fkiLanguageID'), 'Required key "EzsigntemplateResponseCompoundV4[fkiLanguageID]" is missing from JSON.');
        assert(json[r'fkiLanguageID'] != null, 'Required key "EzsigntemplateResponseCompoundV4[fkiLanguageID]" has a null value in JSON.');
        assert(json.containsKey(r'sLanguageNameX'), 'Required key "EzsigntemplateResponseCompoundV4[sLanguageNameX]" is missing from JSON.');
        assert(json[r'sLanguageNameX'] != null, 'Required key "EzsigntemplateResponseCompoundV4[sLanguageNameX]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsigntemplateDescription'), 'Required key "EzsigntemplateResponseCompoundV4[sEzsigntemplateDescription]" is missing from JSON.');
        assert(json[r'sEzsigntemplateDescription'] != null, 'Required key "EzsigntemplateResponseCompoundV4[sEzsigntemplateDescription]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsigntemplateAdminonly'), 'Required key "EzsigntemplateResponseCompoundV4[bEzsigntemplateAdminonly]" is missing from JSON.');
        assert(json[r'bEzsigntemplateAdminonly'] != null, 'Required key "EzsigntemplateResponseCompoundV4[bEzsigntemplateAdminonly]" has a null value in JSON.');
        assert(json.containsKey(r'objAudit'), 'Required key "EzsigntemplateResponseCompoundV4[objAudit]" is missing from JSON.');
        assert(json[r'objAudit'] != null, 'Required key "EzsigntemplateResponseCompoundV4[objAudit]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsigntemplateEditallowed'), 'Required key "EzsigntemplateResponseCompoundV4[bEzsigntemplateEditallowed]" is missing from JSON.');
        assert(json[r'bEzsigntemplateEditallowed'] != null, 'Required key "EzsigntemplateResponseCompoundV4[bEzsigntemplateEditallowed]" has a null value in JSON.');
        assert(json.containsKey(r'a_objEzsigntemplatesigner'), 'Required key "EzsigntemplateResponseCompoundV4[a_objEzsigntemplatesigner]" is missing from JSON.');
        assert(json[r'a_objEzsigntemplatesigner'] != null, 'Required key "EzsigntemplateResponseCompoundV4[a_objEzsigntemplatesigner]" has a null value in JSON.');
        return true;
      }());

      return EzsigntemplateResponseCompoundV4(
        ...
        aObjEzsigntemplatesigner: EzsigntemplatesignerResponseCompoundV3.listFromJson(json[r'a_objEzsigntemplatesigner']),
  ...
  static List<EzsigntemplateResponseCompoundV4> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigntemplateResponseCompoundV4>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigntemplateResponseCompoundV4.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigntemplateResponseCompoundV4> mapFromJson(dynamic json) {
    final map = <String, EzsigntemplateResponseCompoundV4>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplateResponseCompoundV4.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigntemplateResponseCompoundV4-objects as value to a dart map
  static Map<String, List<EzsigntemplateResponseCompoundV4>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigntemplateResponseCompoundV4>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplateResponseCompoundV4.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
