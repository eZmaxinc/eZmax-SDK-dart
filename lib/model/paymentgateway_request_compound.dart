...
class PaymentgatewayRequestCompound {
  ...
  static PaymentgatewayRequestCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'ePaymentgatewayProcessor'), 'Required key "PaymentgatewayRequestCompound[ePaymentgatewayProcessor]" is missing from JSON.');
        assert(json[r'ePaymentgatewayProcessor'] != null, 'Required key "PaymentgatewayRequestCompound[ePaymentgatewayProcessor]" has a null value in JSON.');
        assert(json.containsKey(r'objPaymentgatewayDescription'), 'Required key "PaymentgatewayRequestCompound[objPaymentgatewayDescription]" is missing from JSON.');
        assert(json[r'objPaymentgatewayDescription'] != null, 'Required key "PaymentgatewayRequestCompound[objPaymentgatewayDescription]" has a null value in JSON.');
        return true;
      }());
