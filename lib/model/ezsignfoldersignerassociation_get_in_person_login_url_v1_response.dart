...
class EzsignfoldersignerassociationGetInPersonLoginUrlV1Response {
  ...
  @override
  String toString() => 'EzsignfoldersignerassociationGetInPersonLoginUrlV1Response[objDebugPayload=$objDebugPayload, objDebug=$objDebug, mPayload=$mPayload]';
  ...
  static EzsignfoldersignerassociationGetInPersonLoginUrlV1Response? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<EzsignfoldersignerassociationGetInPersonLoginUrlV1Response> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsignfoldersignerassociationGetInPersonLoginUrlV1Response>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsignfoldersignerassociationGetInPersonLoginUrlV1Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsignfoldersignerassociationGetInPersonLoginUrlV1Response> mapFromJson(dynamic json) {
    final map = <String, EzsignfoldersignerassociationGetInPersonLoginUrlV1Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsignfoldersignerassociationGetInPersonLoginUrlV1Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<EzsignfoldersignerassociationGetInPersonLoginUrlV1Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsignfoldersignerassociationGetInPersonLoginUrlV1Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsignfoldersignerassociationGetInPersonLoginUrlV1Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
