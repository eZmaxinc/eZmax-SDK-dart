...
class EzsignfoldersignerassociationGetInPersonLoginUrlV1Response {
  ...
  static List<EzsignfoldersignerassociationGetInPersonLoginUrlV1Response> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(EzsignfoldersignerassociationGetInPersonLoginUrlV1Response.fromJson).toList(growable: true == growable)
  ...
  static Map<String, EzsignfoldersignerassociationGetInPersonLoginUrlV1Response> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = EzsignfoldersignerassociationGetInPersonLoginUrlV1Response.fromJson(value));
    }
    return map;
  }
  ...
  static Map<String, List<EzsignfoldersignerassociationGetInPersonLoginUrlV1Response>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<EzsignfoldersignerassociationGetInPersonLoginUrlV1Response>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = EzsignfoldersignerassociationGetInPersonLoginUrlV1Response.listFromJson(
            value,
