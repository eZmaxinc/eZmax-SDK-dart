...
class InvoiceGetCommunicationListV1ResponseMPayload {
  ...
  static InvoiceGetCommunicationListV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objCommunication'), 'Required key "InvoiceGetCommunicationListV1ResponseMPayload[a_objCommunication]" is missing from JSON.');
        assert(json[r'a_objCommunication'] != null, 'Required key "InvoiceGetCommunicationListV1ResponseMPayload[a_objCommunication]" has a null value in JSON.');
        return true;
      }());
