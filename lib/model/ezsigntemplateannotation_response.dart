...
class EzsigntemplateannotationResponse {
  ...
  static EzsigntemplateannotationResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsigntemplateannotationID'), 'Required key "EzsigntemplateannotationResponse[pkiEzsigntemplateannotationID]" is missing from JSON.');
        assert(json[r'pkiEzsigntemplateannotationID'] != null, 'Required key "EzsigntemplateannotationResponse[pkiEzsigntemplateannotationID]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsigntemplateannotationHorizontalalignment'), 'Required key "EzsigntemplateannotationResponse[eEzsigntemplateannotationHorizontalalignment]" is missing from JSON.');
        assert(json[r'eEzsigntemplateannotationHorizontalalignment'] != null, 'Required key "EzsigntemplateannotationResponse[eEzsigntemplateannotationHorizontalalignment]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsigntemplateannotationVerticalalignment'), 'Required key "EzsigntemplateannotationResponse[eEzsigntemplateannotationVerticalalignment]" is missing from JSON.');
        assert(json[r'eEzsigntemplateannotationVerticalalignment'] != null, 'Required key "EzsigntemplateannotationResponse[eEzsigntemplateannotationVerticalalignment]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsigntemplateannotationType'), 'Required key "EzsigntemplateannotationResponse[eEzsigntemplateannotationType]" is missing from JSON.');
        assert(json[r'eEzsigntemplateannotationType'] != null, 'Required key "EzsigntemplateannotationResponse[eEzsigntemplateannotationType]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsigntemplateannotationX'), 'Required key "EzsigntemplateannotationResponse[iEzsigntemplateannotationX]" is missing from JSON.');
        assert(json[r'iEzsigntemplateannotationX'] != null, 'Required key "EzsigntemplateannotationResponse[iEzsigntemplateannotationX]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsigntemplateannotationY'), 'Required key "EzsigntemplateannotationResponse[iEzsigntemplateannotationY]" is missing from JSON.');
        assert(json[r'iEzsigntemplateannotationY'] != null, 'Required key "EzsigntemplateannotationResponse[iEzsigntemplateannotationY]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsigntemplateannotationWidth'), 'Required key "EzsigntemplateannotationResponse[iEzsigntemplateannotationWidth]" is missing from JSON.');
        assert(json[r'iEzsigntemplateannotationWidth'] != null, 'Required key "EzsigntemplateannotationResponse[iEzsigntemplateannotationWidth]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsigntemplateannotationHeight'), 'Required key "EzsigntemplateannotationResponse[iEzsigntemplateannotationHeight]" is missing from JSON.');
        assert(json[r'iEzsigntemplateannotationHeight'] != null, 'Required key "EzsigntemplateannotationResponse[iEzsigntemplateannotationHeight]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsigntemplatedocumentpagePagenumber'), 'Required key "EzsigntemplateannotationResponse[iEzsigntemplatedocumentpagePagenumber]" is missing from JSON.');
        assert(json[r'iEzsigntemplatedocumentpagePagenumber'] != null, 'Required key "EzsigntemplateannotationResponse[iEzsigntemplatedocumentpagePagenumber]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsigntemplateannotationDescription'), 'Required key "EzsigntemplateannotationResponse[sEzsigntemplateannotationDescription]" is missing from JSON.');
        assert(json[r'sEzsigntemplateannotationDescription'] != null, 'Required key "EzsigntemplateannotationResponse[sEzsigntemplateannotationDescription]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsigntemplateannotationDefaulttext'), 'Required key "EzsigntemplateannotationResponse[sEzsigntemplateannotationDefaulttext]" is missing from JSON.');
        assert(json[r'sEzsigntemplateannotationDefaulttext'] != null, 'Required key "EzsigntemplateannotationResponse[sEzsigntemplateannotationDefaulttext]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsigntemplateannotationDropdownvalues'), 'Required key "EzsigntemplateannotationResponse[sEzsigntemplateannotationDropdownvalues]" is missing from JSON.');
        assert(json[r'sEzsigntemplateannotationDropdownvalues'] != null, 'Required key "EzsigntemplateannotationResponse[sEzsigntemplateannotationDropdownvalues]" has a null value in JSON.');
        return true;
      }());
