...
class CommunicationreferenceRequestCompound {
  /// Returns a new [CommunicationreferenceRequestCompound] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CommunicationreferenceRequestCompound &&
  ...
  @override
  String toString() => 'CommunicationreferenceRequestCompound[pkiCommunicationreferenceID=$pkiCommunicationreferenceID, fkiBuyercontractID=$fkiBuyercontractID, fkiEzsignfolderID=$fkiEzsignfolderID, fkiInscriptionID=$fkiInscriptionID, fkiInscriptiontempID=$fkiInscriptiontempID, fkiInvoiceID=$fkiInvoiceID, fkiOtherincomeID=$fkiOtherincomeID, fkiElectronicfundstransferID=$fkiElectronicfundstransferID, fkiRejectedoffertopurchaseID=$fkiRejectedoffertopurchaseID]';
  ...
  /// Returns a new [CommunicationreferenceRequestCompound] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CommunicationreferenceRequestCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CommunicationreferenceRequestCompound[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CommunicationreferenceRequestCompound[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CommunicationreferenceRequestCompound> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CommunicationreferenceRequestCompound>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CommunicationreferenceRequestCompound.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CommunicationreferenceRequestCompound> mapFromJson(dynamic json) {
    final map = <String, CommunicationreferenceRequestCompound>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CommunicationreferenceRequestCompound.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CommunicationreferenceRequestCompound-objects as value to a dart map
  static Map<String, List<CommunicationreferenceRequestCompound>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CommunicationreferenceRequestCompound>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CommunicationreferenceRequestCompound.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
