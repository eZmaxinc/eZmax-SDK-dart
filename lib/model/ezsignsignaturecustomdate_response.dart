...
class EzsignsignaturecustomdateResponse {
  /// Returns a new [EzsignsignaturecustomdateResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsignsignaturecustomdateResponse &&
  ...
  @override
  String toString() => 'EzsignsignaturecustomdateResponse[pkiEzsignsignaturecustomdateID=$pkiEzsignsignaturecustomdateID, iEzsignsignaturecustomdateX=$iEzsignsignaturecustomdateX, iEzsignsignaturecustomdateY=$iEzsignsignaturecustomdateY, sEzsignsignaturecustomdateFormat=$sEzsignsignaturecustomdateFormat]';
  ...
  /// Returns a new [EzsignsignaturecustomdateResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsignsignaturecustomdateResponse? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<EzsignsignaturecustomdateResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsignsignaturecustomdateResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsignsignaturecustomdateResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsignsignaturecustomdateResponse> mapFromJson(dynamic json) {
    final map = <String, EzsignsignaturecustomdateResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsignsignaturecustomdateResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsignsignaturecustomdateResponse-objects as value to a dart map
  static Map<String, List<EzsignsignaturecustomdateResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsignsignaturecustomdateResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsignsignaturecustomdateResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
