...
class EzsigntemplatepackagesignerCreateObjectV1Request {
  ...
  static EzsigntemplatepackagesignerCreateObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsigntemplatepackagesigner'), 'Required key "EzsigntemplatepackagesignerCreateObjectV1Request[a_objEzsigntemplatepackagesigner]" is missing from JSON.');
        assert(json[r'a_objEzsigntemplatepackagesigner'] != null, 'Required key "EzsigntemplatepackagesignerCreateObjectV1Request[a_objEzsigntemplatepackagesigner]" has a null value in JSON.');
        return true;
      }());
  ...
  static Map<String, List<EzsigntemplatepackagesignerCreateObjectV1Request>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplatepackagesignerCreateObjectV1Request.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
