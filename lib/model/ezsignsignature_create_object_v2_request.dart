...
class EzsignsignatureCreateObjectV2Request {
  ...
  static EzsignsignatureCreateObjectV2Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsignsignature'), 'Required key "EzsignsignatureCreateObjectV2Request[a_objEzsignsignature]" is missing from JSON.');
        assert(json[r'a_objEzsignsignature'] != null, 'Required key "EzsignsignatureCreateObjectV2Request[a_objEzsignsignature]" has a null value in JSON.');
        return true;
      }());
