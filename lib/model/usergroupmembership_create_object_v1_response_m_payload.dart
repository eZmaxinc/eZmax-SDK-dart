...
class UsergroupmembershipCreateObjectV1ResponseMPayload {
  ...
  static UsergroupmembershipCreateObjectV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiUsergroupmembershipID'), 'Required key "UsergroupmembershipCreateObjectV1ResponseMPayload[a_pkiUsergroupmembershipID]" is missing from JSON.');
        assert(json[r'a_pkiUsergroupmembershipID'] != null, 'Required key "UsergroupmembershipCreateObjectV1ResponseMPayload[a_pkiUsergroupmembershipID]" has a null value in JSON.');
        return true;
      }());
