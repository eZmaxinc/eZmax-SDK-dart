...
class EzsignsignergroupCreateObjectV1Request {
  ...
  static EzsignsignergroupCreateObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsignsignergroup'), 'Required key "EzsignsignergroupCreateObjectV1Request[a_objEzsignsignergroup]" is missing from JSON.');
        assert(json[r'a_objEzsignsignergroup'] != null, 'Required key "EzsignsignergroupCreateObjectV1Request[a_objEzsignsignergroup]" has a null value in JSON.');
        return true;
      }());
