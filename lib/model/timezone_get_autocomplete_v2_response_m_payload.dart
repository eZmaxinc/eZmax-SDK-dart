...
class TimezoneGetAutocompleteV2ResponseMPayload {
  ...
  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'a_objTimezone'] = this.aObjTimezone;
    return json;
  }
  ...
  static TimezoneGetAutocompleteV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objTimezone'), 'Required key "TimezoneGetAutocompleteV2ResponseMPayload[a_objTimezone]" is missing from JSON.');
        assert(json[r'a_objTimezone'] != null, 'Required key "TimezoneGetAutocompleteV2ResponseMPayload[a_objTimezone]" has a null value in JSON.');
        return true;
      }());
  ...
  static Map<String, List<TimezoneGetAutocompleteV2ResponseMPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = TimezoneGetAutocompleteV2ResponseMPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
