...
class CommonGetAutocompleteV1Response {
  ...
  static CommonGetAutocompleteV1Response fromJson(Map<String, dynamic> json) => json == null
    ? null
    : CommonGetAutocompleteV1Response(
  ...
  static List<CommonGetAutocompleteV1Response> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <CommonGetAutocompleteV1Response>[]
      : json.map((v) => CommonGetAutocompleteV1Response.fromJson(v)).toList(growable: true == growable);

  static Map<String, CommonGetAutocompleteV1Response> mapFromJson(Map<String, dynamic> json) {
    final map = <String, CommonGetAutocompleteV1Response>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = CommonGetAutocompleteV1Response.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of CommonGetAutocompleteV1Response-objects as value to a dart map
  static Map<String, List<CommonGetAutocompleteV1Response>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<CommonGetAutocompleteV1Response>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = CommonGetAutocompleteV1Response.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
