...
class EzsigntemplatesignaturecustomdateResponse {
  /// Returns a new [EzsigntemplatesignaturecustomdateResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsigntemplatesignaturecustomdateResponse &&
  ...
  /// Returns a new [EzsigntemplatesignaturecustomdateResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsigntemplatesignaturecustomdateResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsigntemplatesignaturecustomdateID'), 'Required key "EzsigntemplatesignaturecustomdateResponse[pkiEzsigntemplatesignaturecustomdateID]" is missing from JSON.');
        assert(json[r'pkiEzsigntemplatesignaturecustomdateID'] != null, 'Required key "EzsigntemplatesignaturecustomdateResponse[pkiEzsigntemplatesignaturecustomdateID]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsigntemplatesignaturecustomdateFormat'), 'Required key "EzsigntemplatesignaturecustomdateResponse[sEzsigntemplatesignaturecustomdateFormat]" is missing from JSON.');
        assert(json[r'sEzsigntemplatesignaturecustomdateFormat'] != null, 'Required key "EzsigntemplatesignaturecustomdateResponse[sEzsigntemplatesignaturecustomdateFormat]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<EzsigntemplatesignaturecustomdateResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigntemplatesignaturecustomdateResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigntemplatesignaturecustomdateResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigntemplatesignaturecustomdateResponse> mapFromJson(dynamic json) {
    final map = <String, EzsigntemplatesignaturecustomdateResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplatesignaturecustomdateResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigntemplatesignaturecustomdateResponse-objects as value to a dart map
  static Map<String, List<EzsigntemplatesignaturecustomdateResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigntemplatesignaturecustomdateResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplatesignaturecustomdateResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
