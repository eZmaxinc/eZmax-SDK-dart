...
class EzsigntemplatepackageGetObjectV2ResponseMPayload {
  ...
  static EzsigntemplatepackageGetObjectV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objEzsigntemplatepackage'), 'Required key "EzsigntemplatepackageGetObjectV2ResponseMPayload[objEzsigntemplatepackage]" is missing from JSON.');
        assert(json[r'objEzsigntemplatepackage'] != null, 'Required key "EzsigntemplatepackageGetObjectV2ResponseMPayload[objEzsigntemplatepackage]" has a null value in JSON.');
        return true;
      }());
