...
class EzdoctemplatedocumentCreateObjectV1Request {
  ...
  static EzdoctemplatedocumentCreateObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzdoctemplatedocument'), 'Required key "EzdoctemplatedocumentCreateObjectV1Request[a_objEzdoctemplatedocument]" is missing from JSON.');
        assert(json[r'a_objEzdoctemplatedocument'] != null, 'Required key "EzdoctemplatedocumentCreateObjectV1Request[a_objEzdoctemplatedocument]" has a null value in JSON.');
        return true;
      }());
