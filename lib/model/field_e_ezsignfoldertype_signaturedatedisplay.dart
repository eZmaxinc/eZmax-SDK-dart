...
enum FieldEEzsignfoldertypeSignaturedatedisplay {
  ...
  const FieldEEzsignfoldertypeSignaturedatedisplay._(this._value);
  ...
  /// Returns the instance of [FieldEEzsignfoldertypeSignaturedatedisplay] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [FieldEEzsignfoldertypeSignaturedatedisplay]
...
class FieldEEzsignfoldertypeSignaturedatedisplayTypeTransformer {
  ...
  /// Encodes this enum as a value suitable for JSON.
  String encode(FieldEEzsignfoldertypeSignaturedatedisplay data) => data._value;
  ...
  FieldEEzsignfoldertypeSignaturedatedisplay? decode(dynamic data, {bool allowNull = true}) {
    if (data is FieldEEzsignfoldertypeSignaturedatedisplay) {
      return data;
    }
    if (data != null) {
      switch (data) {
