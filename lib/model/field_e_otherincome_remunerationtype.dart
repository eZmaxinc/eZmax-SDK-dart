...
enum FieldEOtherincomeRemunerationtype {
  dollars._(r'Dollars'),
  dollarsTaxesIncluded._(r'DollarsTaxesIncluded'),
  ;

  /// Instantiate a new enum with the provided value.
  const FieldEOtherincomeRemunerationtype._(this._value);
  ...
  /// Returns the instance of [FieldEOtherincomeRemunerationtype] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [FieldEOtherincomeRemunerationtype]
...
class FieldEOtherincomeRemunerationtypeTypeTransformer {
  ...
  /// Encodes this enum as a value suitable for JSON.
  String encode(FieldEOtherincomeRemunerationtype data) => data._value;
  ...
  FieldEOtherincomeRemunerationtype? decode(dynamic data, {bool allowNull = true}) {
    if (data is FieldEOtherincomeRemunerationtype) {
      return data;
    }
    if (data != null) {
      switch (data) {
