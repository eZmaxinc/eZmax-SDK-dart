...
class EzsignsignerRequestCompoundAllOf {
  ...
  static List<EzsignsignerRequestCompoundAllOf> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(EzsignsignerRequestCompoundAllOf.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <EzsignsignerRequestCompoundAllOf>[];
  ...
  static Map<String, EzsignsignerRequestCompoundAllOf> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = EzsignsignerRequestCompoundAllOf.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of EzsignsignerRequestCompoundAllOf-objects as value to a dart map
  static Map<String, List<EzsignsignerRequestCompoundAllOf>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<EzsignsignerRequestCompoundAllOf>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = EzsignsignerRequestCompoundAllOf.listFromJson(
            value,
