...
class EzsigntemplateResponseV4 {
  /// Returns a new [EzsigntemplateResponseV4] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsigntemplateResponseV4 &&
  ...
  /// Returns a new [EzsigntemplateResponseV4] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsigntemplateResponseV4? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsigntemplateID'), 'Required key "EzsigntemplateResponseV4[pkiEzsigntemplateID]" is missing from JSON.');
        assert(json[r'pkiEzsigntemplateID'] != null, 'Required key "EzsigntemplateResponseV4[pkiEzsigntemplateID]" has a null value in JSON.');
        assert(json.containsKey(r'fkiLanguageID'), 'Required key "EzsigntemplateResponseV4[fkiLanguageID]" is missing from JSON.');
        assert(json[r'fkiLanguageID'] != null, 'Required key "EzsigntemplateResponseV4[fkiLanguageID]" has a null value in JSON.');
        assert(json.containsKey(r'sLanguageNameX'), 'Required key "EzsigntemplateResponseV4[sLanguageNameX]" is missing from JSON.');
        assert(json[r'sLanguageNameX'] != null, 'Required key "EzsigntemplateResponseV4[sLanguageNameX]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsigntemplateDescription'), 'Required key "EzsigntemplateResponseV4[sEzsigntemplateDescription]" is missing from JSON.');
        assert(json[r'sEzsigntemplateDescription'] != null, 'Required key "EzsigntemplateResponseV4[sEzsigntemplateDescription]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsigntemplateAdminonly'), 'Required key "EzsigntemplateResponseV4[bEzsigntemplateAdminonly]" is missing from JSON.');
        assert(json[r'bEzsigntemplateAdminonly'] != null, 'Required key "EzsigntemplateResponseV4[bEzsigntemplateAdminonly]" has a null value in JSON.');
        assert(json.containsKey(r'objAudit'), 'Required key "EzsigntemplateResponseV4[objAudit]" is missing from JSON.');
        assert(json[r'objAudit'] != null, 'Required key "EzsigntemplateResponseV4[objAudit]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsigntemplateEditallowed'), 'Required key "EzsigntemplateResponseV4[bEzsigntemplateEditallowed]" is missing from JSON.');
        assert(json[r'bEzsigntemplateEditallowed'] != null, 'Required key "EzsigntemplateResponseV4[bEzsigntemplateEditallowed]" has a null value in JSON.');
        return true;
      }());

      return EzsigntemplateResponseV4(
  ...
  static List<EzsigntemplateResponseV4> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigntemplateResponseV4>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigntemplateResponseV4.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigntemplateResponseV4> mapFromJson(dynamic json) {
    final map = <String, EzsigntemplateResponseV4>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplateResponseV4.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigntemplateResponseV4-objects as value to a dart map
  static Map<String, List<EzsigntemplateResponseV4>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigntemplateResponseV4>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplateResponseV4.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
