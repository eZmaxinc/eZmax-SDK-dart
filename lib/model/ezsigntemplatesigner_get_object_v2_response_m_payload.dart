...
class EzsigntemplatesignerGetObjectV2ResponseMPayload {
  ...
  static EzsigntemplatesignerGetObjectV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objEzsigntemplatesigner'), 'Required key "EzsigntemplatesignerGetObjectV2ResponseMPayload[objEzsigntemplatesigner]" is missing from JSON.');
        assert(json[r'objEzsigntemplatesigner'] != null, 'Required key "EzsigntemplatesignerGetObjectV2ResponseMPayload[objEzsigntemplatesigner]" has a null value in JSON.');
        return true;
      }());
  ...
  static Map<String, List<EzsigntemplatesignerGetObjectV2ResponseMPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplatesignerGetObjectV2ResponseMPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
