...
class EzsigntemplatesignatureGetObjectV2Response {
  ...
  @override
  String toString() => 'EzsigntemplatesignatureGetObjectV2Response[mPayload=$mPayload, objDebugPayload=$objDebugPayload, objDebug=$objDebug]';
  ...
  static Map<String, List<EzsigntemplatesignatureGetObjectV2Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplatesignatureGetObjectV2Response.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
