...
class EzsigntemplatesignaturecustomdateResponseCompound {
  ...
  static EzsigntemplatesignaturecustomdateResponseCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsigntemplatesignaturecustomdateID'), 'Required key "EzsigntemplatesignaturecustomdateResponseCompound[pkiEzsigntemplatesignaturecustomdateID]" is missing from JSON.');
        assert(json[r'pkiEzsigntemplatesignaturecustomdateID'] != null, 'Required key "EzsigntemplatesignaturecustomdateResponseCompound[pkiEzsigntemplatesignaturecustomdateID]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsigntemplatesignaturecustomdateFormat'), 'Required key "EzsigntemplatesignaturecustomdateResponseCompound[sEzsigntemplatesignaturecustomdateFormat]" is missing from JSON.');
        assert(json[r'sEzsigntemplatesignaturecustomdateFormat'] != null, 'Required key "EzsigntemplatesignaturecustomdateResponseCompound[sEzsigntemplatesignaturecustomdateFormat]" has a null value in JSON.');
        return true;
      }());
