...
class EzsigndocumentCreateElementV3Response {
  ...
  static EzsigndocumentCreateElementV3Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsigndocumentID'), 'Required key "EzsigndocumentCreateElementV3Response[pkiEzsigndocumentID]" is missing from JSON.');
        assert(json[r'pkiEzsigndocumentID'] != null, 'Required key "EzsigndocumentCreateElementV3Response[pkiEzsigndocumentID]" has a null value in JSON.');
        assert(json.containsKey(r'a_objMatchingtemplate'), 'Required key "EzsigndocumentCreateElementV3Response[a_objMatchingtemplate]" is missing from JSON.');
        assert(json[r'a_objMatchingtemplate'] != null, 'Required key "EzsigndocumentCreateElementV3Response[a_objMatchingtemplate]" has a null value in JSON.');
        return true;
      }());
