...
class UsergroupGetListV1ResponseMPayload {
  ...
  @override
  String toString() => 'UsergroupGetListV1ResponseMPayload[aObjUsergroup=$aObjUsergroup, iRowReturned=$iRowReturned, iRowFiltered=$iRowFiltered]';
  ...
  static Map<String, List<UsergroupGetListV1ResponseMPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UsergroupGetListV1ResponseMPayload.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
