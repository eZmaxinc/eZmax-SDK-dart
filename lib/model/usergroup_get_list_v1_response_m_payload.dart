...
class UsergroupGetListV1ResponseMPayload {
  ...
  static UsergroupGetListV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'iRowReturned'), 'Required key "UsergroupGetListV1ResponseMPayload[iRowReturned]" is missing from JSON.');
        assert(json[r'iRowReturned'] != null, 'Required key "UsergroupGetListV1ResponseMPayload[iRowReturned]" has a null value in JSON.');
        assert(json.containsKey(r'iRowFiltered'), 'Required key "UsergroupGetListV1ResponseMPayload[iRowFiltered]" is missing from JSON.');
        assert(json[r'iRowFiltered'] != null, 'Required key "UsergroupGetListV1ResponseMPayload[iRowFiltered]" has a null value in JSON.');
        assert(json.containsKey(r'a_objUsergroup'), 'Required key "UsergroupGetListV1ResponseMPayload[a_objUsergroup]" is missing from JSON.');
        assert(json[r'a_objUsergroup'] != null, 'Required key "UsergroupGetListV1ResponseMPayload[a_objUsergroup]" has a null value in JSON.');
        return true;
      }());
