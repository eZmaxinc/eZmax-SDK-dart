...
class PhoneResponseCompound {
  ...
  static PhoneResponseCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiPhoneID'), 'Required key "PhoneResponseCompound[pkiPhoneID]" is missing from JSON.');
        assert(json[r'pkiPhoneID'] != null, 'Required key "PhoneResponseCompound[pkiPhoneID]" has a null value in JSON.');
        assert(json.containsKey(r'fkiPhonetypeID'), 'Required key "PhoneResponseCompound[fkiPhonetypeID]" is missing from JSON.');
        assert(json[r'fkiPhonetypeID'] != null, 'Required key "PhoneResponseCompound[fkiPhonetypeID]" has a null value in JSON.');
        return true;
      }());
