...
class EzsigndocumentCreateObjectV2ResponseMPayload {
  ...
  static EzsigndocumentCreateObjectV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiEzsigndocumentID'), 'Required key "EzsigndocumentCreateObjectV2ResponseMPayload[a_pkiEzsigndocumentID]" is missing from JSON.');
        assert(json[r'a_pkiEzsigndocumentID'] != null, 'Required key "EzsigndocumentCreateObjectV2ResponseMPayload[a_pkiEzsigndocumentID]" has a null value in JSON.');
        return true;
      }());
