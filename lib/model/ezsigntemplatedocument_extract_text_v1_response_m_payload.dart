...
class EzsigntemplatedocumentExtractTextV1ResponseMPayload {
  ...
  static EzsigntemplatedocumentExtractTextV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'sText'), 'Required key "EzsigntemplatedocumentExtractTextV1ResponseMPayload[sText]" is missing from JSON.');
        assert(json[r'sText'] != null, 'Required key "EzsigntemplatedocumentExtractTextV1ResponseMPayload[sText]" has a null value in JSON.');
        return true;
      }());
