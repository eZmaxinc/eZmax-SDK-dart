...
class AuthenticationexternalGetObjectV2ResponseMPayload {
  ...
  static AuthenticationexternalGetObjectV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objAuthenticationexternal'), 'Required key "AuthenticationexternalGetObjectV2ResponseMPayload[objAuthenticationexternal]" is missing from JSON.');
        assert(json[r'objAuthenticationexternal'] != null, 'Required key "AuthenticationexternalGetObjectV2ResponseMPayload[objAuthenticationexternal]" has a null value in JSON.');
        return true;
      }());
