...
class GlobalCustomerGetEndpointV1Response {
  ...
  static GlobalCustomerGetEndpointV1Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'sEndpointURL'), 'Required key "GlobalCustomerGetEndpointV1Response[sEndpointURL]" is missing from JSON.');
        assert(json[r'sEndpointURL'] != null, 'Required key "GlobalCustomerGetEndpointV1Response[sEndpointURL]" has a null value in JSON.');
        return true;
      }());
