...
class GlobalCustomerGetEndpointV1Response {
  ...
  static List<GlobalCustomerGetEndpointV1Response> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(GlobalCustomerGetEndpointV1Response.fromJson).toList(growable: true == growable)
  ...
  static Map<String, GlobalCustomerGetEndpointV1Response> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = GlobalCustomerGetEndpointV1Response.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of GlobalCustomerGetEndpointV1Response-objects as value to a dart map
  static Map<String, List<GlobalCustomerGetEndpointV1Response>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<GlobalCustomerGetEndpointV1Response>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = GlobalCustomerGetEndpointV1Response.listFromJson(
            value,
