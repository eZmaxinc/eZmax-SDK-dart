...
class EzsigndocumentApplyEzsigntemplateglobalV1Response {
  ...
  static EzsigndocumentApplyEzsigntemplateglobalV1Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "EzsigndocumentApplyEzsigntemplateglobalV1Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "EzsigndocumentApplyEzsigntemplateglobalV1Response[objDebugPayload]" has a null value in JSON.');
        return true;
      }());
