...
class ApikeyCreateObjectV1ResponseMPayload {
  ...
  static List<ApikeyCreateObjectV1ResponseMPayload> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(ApikeyCreateObjectV1ResponseMPayload.fromJson).toList(growable: true == growable)
  ...
  static Map<String, ApikeyCreateObjectV1ResponseMPayload> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = ApikeyCreateObjectV1ResponseMPayload.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of ApikeyCreateObjectV1ResponseMPayload-objects as value to a dart map
  static Map<String, List<ApikeyCreateObjectV1ResponseMPayload>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<ApikeyCreateObjectV1ResponseMPayload>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = ApikeyCreateObjectV1ResponseMPayload.listFromJson(
            value,
