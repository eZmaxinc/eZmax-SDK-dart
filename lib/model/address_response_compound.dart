...
class AddressResponseCompound {
  /// Returns a new [AddressResponseCompound] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AddressResponseCompound &&
  ...
  /// Returns a new [AddressResponseCompound] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AddressResponseCompound? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<AddressResponseCompound> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AddressResponseCompound>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AddressResponseCompound.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AddressResponseCompound> mapFromJson(dynamic json) {
    final map = <String, AddressResponseCompound>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AddressResponseCompound.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AddressResponseCompound-objects as value to a dart map
  static Map<String, List<AddressResponseCompound>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AddressResponseCompound>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AddressResponseCompound.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
