...
class EzsignbulksendtransmissionGetFormsDataV1ResponseMPayload {
  ...
  static EzsignbulksendtransmissionGetFormsDataV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objFormsDataFolder'), 'Required key "EzsignbulksendtransmissionGetFormsDataV1ResponseMPayload[a_objFormsDataFolder]" is missing from JSON.');
        assert(json[r'a_objFormsDataFolder'] != null, 'Required key "EzsignbulksendtransmissionGetFormsDataV1ResponseMPayload[a_objFormsDataFolder]" has a null value in JSON.');
        return true;
      }());
