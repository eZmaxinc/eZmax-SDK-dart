...
/// The source of the Attachment
enum CustomAttachmentImportIntoEDMRequestEAttachmentSourceEnum {
  ...
  const CustomAttachmentImportIntoEDMRequestEAttachmentSourceEnum._(this._value);
  ...
  /// Returns the instance of [CustomAttachmentImportIntoEDMRequestEAttachmentSourceEnum] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [CustomAttachmentImportIntoEDMRequestEAttachmentSourceEnum]
...
class CustomAttachmentImportIntoEDMRequestEAttachmentSourceEnumTypeTransformer {
  ...
  String encode(CustomAttachmentImportIntoEDMRequestEAttachmentSourceEnum data) => data._value;
  ...
  CustomAttachmentImportIntoEDMRequestEAttachmentSourceEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data is CustomAttachmentImportIntoEDMRequestEAttachmentSourceEnum) {
      return data;
    }
    if (data != null) {
      switch (data) {
