...
class EzsigntemplatepackagesignerResponseCompoundV3 {
  /// Returns a new [EzsigntemplatepackagesignerResponseCompoundV3] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsigntemplatepackagesignerResponseCompoundV3 &&
  ...
  /// Returns a new [EzsigntemplatepackagesignerResponseCompoundV3] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsigntemplatepackagesignerResponseCompoundV3? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsigntemplatepackagesignerID'), 'Required key "EzsigntemplatepackagesignerResponseCompoundV3[pkiEzsigntemplatepackagesignerID]" is missing from JSON.');
        assert(json[r'pkiEzsigntemplatepackagesignerID'] != null, 'Required key "EzsigntemplatepackagesignerResponseCompoundV3[pkiEzsigntemplatepackagesignerID]" has a null value in JSON.');
        assert(json.containsKey(r'fkiEzsigntemplatepackageID'), 'Required key "EzsigntemplatepackagesignerResponseCompoundV3[fkiEzsigntemplatepackageID]" is missing from JSON.');
        assert(json[r'fkiEzsigntemplatepackageID'] != null, 'Required key "EzsigntemplatepackagesignerResponseCompoundV3[fkiEzsigntemplatepackageID]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsigntemplatepackagesignerDescription'), 'Required key "EzsigntemplatepackagesignerResponseCompoundV3[sEzsigntemplatepackagesignerDescription]" is missing from JSON.');
        assert(json[r'sEzsigntemplatepackagesignerDescription'] != null, 'Required key "EzsigntemplatepackagesignerResponseCompoundV3[sEzsigntemplatepackagesignerDescription]" has a null value in JSON.');
        return true;
      }());

      return EzsigntemplatepackagesignerResponseCompoundV3(
  ...
  static List<EzsigntemplatepackagesignerResponseCompoundV3> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigntemplatepackagesignerResponseCompoundV3>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigntemplatepackagesignerResponseCompoundV3.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigntemplatepackagesignerResponseCompoundV3> mapFromJson(dynamic json) {
    final map = <String, EzsigntemplatepackagesignerResponseCompoundV3>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplatepackagesignerResponseCompoundV3.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigntemplatepackagesignerResponseCompoundV3-objects as value to a dart map
  static Map<String, List<EzsigntemplatepackagesignerResponseCompoundV3>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigntemplatepackagesignerResponseCompoundV3>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplatepackagesignerResponseCompoundV3.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
