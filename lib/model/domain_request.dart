...
class DomainRequest {
  ...
  static DomainRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'sDomainName'), 'Required key "DomainRequest[sDomainName]" is missing from JSON.');
        assert(json[r'sDomainName'] != null, 'Required key "DomainRequest[sDomainName]" has a null value in JSON.');
        return true;
      }());
