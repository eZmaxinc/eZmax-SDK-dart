...
class CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest {
  /// Returns a new [CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest] instance.
  ...
  /// Returns a new [CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest> mapFromJson(dynamic json) {
    final map = <String, CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest-objects as value to a dart map
  static Map<String, List<CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
