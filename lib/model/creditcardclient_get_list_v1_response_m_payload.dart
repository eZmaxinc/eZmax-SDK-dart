...
class CreditcardclientGetListV1ResponseMPayload {
  ...
  static CreditcardclientGetListV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'iRowReturned'), 'Required key "CreditcardclientGetListV1ResponseMPayload[iRowReturned]" is missing from JSON.');
        assert(json[r'iRowReturned'] != null, 'Required key "CreditcardclientGetListV1ResponseMPayload[iRowReturned]" has a null value in JSON.');
        assert(json.containsKey(r'iRowFiltered'), 'Required key "CreditcardclientGetListV1ResponseMPayload[iRowFiltered]" is missing from JSON.');
        assert(json[r'iRowFiltered'] != null, 'Required key "CreditcardclientGetListV1ResponseMPayload[iRowFiltered]" has a null value in JSON.');
        assert(json.containsKey(r'a_objCreditcardclient'), 'Required key "CreditcardclientGetListV1ResponseMPayload[a_objCreditcardclient]" is missing from JSON.');
        assert(json[r'a_objCreditcardclient'] != null, 'Required key "CreditcardclientGetListV1ResponseMPayload[a_objCreditcardclient]" has a null value in JSON.');
        return true;
      }());
