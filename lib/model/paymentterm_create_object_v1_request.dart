...
class PaymenttermCreateObjectV1Request {
  ...
  static PaymenttermCreateObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objPaymentterm'), 'Required key "PaymenttermCreateObjectV1Request[a_objPaymentterm]" is missing from JSON.');
        assert(json[r'a_objPaymentterm'] != null, 'Required key "PaymenttermCreateObjectV1Request[a_objPaymentterm]" has a null value in JSON.');
        return true;
      }());
