...
class EzsignfolderResponseCompoundV3 {
  /// Returns a new [EzsignfolderResponseCompoundV3] instance.
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  ComputedEEzsignfolderAccess? eEzsignfolderAccess;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsignfolderResponseCompoundV3 &&
    ...
    other.iEzsignfolderStepcurrent == iEzsignfolderStepcurrent &&
  ...
  int get hashCode =>
    ...
    (iEzsignfolderStepcurrent == null ? 0 : iEzsignfolderStepcurrent!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.iEzsignfolderStepcurrent != null) {
      json[r'iEzsignfolderStepcurrent'] = this.iEzsignfolderStepcurrent;
    } else {
      json[r'iEzsignfolderStepcurrent'] = null;
    }
    ...
    if (this.eEzsignfolderAccess != null) {
      json[r'eEzsignfolderAccess'] = this.eEzsignfolderAccess;
    } else {
      json[r'eEzsignfolderAccess'] = null;
    }
  ...
  /// Returns a new [EzsignfolderResponseCompoundV3] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsignfolderResponseCompoundV3? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsignfolderID'), 'Required key "EzsignfolderResponseCompoundV3[pkiEzsignfolderID]" is missing from JSON.');
        assert(json[r'pkiEzsignfolderID'] != null, 'Required key "EzsignfolderResponseCompoundV3[pkiEzsignfolderID]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsignfolderCompletion'), 'Required key "EzsignfolderResponseCompoundV3[eEzsignfolderCompletion]" is missing from JSON.');
        assert(json[r'eEzsignfolderCompletion'] != null, 'Required key "EzsignfolderResponseCompoundV3[eEzsignfolderCompletion]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsignfolderDescription'), 'Required key "EzsignfolderResponseCompoundV3[sEzsignfolderDescription]" is missing from JSON.');
        assert(json[r'sEzsignfolderDescription'] != null, 'Required key "EzsignfolderResponseCompoundV3[sEzsignfolderDescription]" has a null value in JSON.');
        return true;
      }());
      ...
      return EzsignfolderResponseCompoundV3(
        ...
        iEzsignfolderStepcurrent: mapValueOfType<int>(json, r'iEzsignfolderStepcurrent'),
  ...
  static List<EzsignfolderResponseCompoundV3> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsignfolderResponseCompoundV3>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsignfolderResponseCompoundV3.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsignfolderResponseCompoundV3> mapFromJson(dynamic json) {
    final map = <String, EzsignfolderResponseCompoundV3>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsignfolderResponseCompoundV3.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsignfolderResponseCompoundV3-objects as value to a dart map
  static Map<String, List<EzsignfolderResponseCompoundV3>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsignfolderResponseCompoundV3>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsignfolderResponseCompoundV3.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
