    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EzsignfolderResponseCompoundV3[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EzsignfolderResponseCompoundV3[$key]" has a null value in JSON.');
        });
        return true;
      }());
