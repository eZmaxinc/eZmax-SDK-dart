...
class DomainCreateObjectV1ResponseMPayload {
  ...
  static DomainCreateObjectV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiDomainID'), 'Required key "DomainCreateObjectV1ResponseMPayload[a_pkiDomainID]" is missing from JSON.');
        assert(json[r'a_pkiDomainID'] != null, 'Required key "DomainCreateObjectV1ResponseMPayload[a_pkiDomainID]" has a null value in JSON.');
        return true;
      }());
