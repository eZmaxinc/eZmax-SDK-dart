...
class OtherincomeGetCommunicationCountV1ResponseMPayload {
  ...
  static OtherincomeGetCommunicationCountV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'iCommunicationCount'), 'Required key "OtherincomeGetCommunicationCountV1ResponseMPayload[iCommunicationCount]" is missing from JSON.');
        assert(json[r'iCommunicationCount'] != null, 'Required key "OtherincomeGetCommunicationCountV1ResponseMPayload[iCommunicationCount]" has a null value in JSON.');
        return true;
      }());
