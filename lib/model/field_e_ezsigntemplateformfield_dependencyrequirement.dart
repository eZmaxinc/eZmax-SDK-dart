  ...
  static List<FieldEEzsigntemplateformfieldDependencyrequirement> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FieldEEzsigntemplateformfieldDependencyrequirement.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [FieldEEzsigntemplateformfieldDependencyrequirement] to String,
/// and [decode] dynamic data back to [FieldEEzsigntemplateformfieldDependencyrequirement].
class FieldEEzsigntemplateformfieldDependencyrequirementTypeTransformer {
  factory FieldEEzsigntemplateformfieldDependencyrequirementTypeTransformer() => _instance ??= const FieldEEzsigntemplateformfieldDependencyrequirementTypeTransformer._();
  ...
  FieldEEzsigntemplateformfieldDependencyrequirement? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'AnyOf': return FieldEEzsigntemplateformfieldDependencyrequirement.anyOf;
        default:
          if (!allowNull) {
