...
class EzsigntemplatedocumentCreateObjectV1Request {
  ...
  bool operator ==(Object other) => identical(this, other) || other is EzsigntemplatedocumentCreateObjectV1Request &&
    _deepEquality.equals(other.aObjEzsigntemplatedocument, aObjEzsigntemplatedocument);
  ...
  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'a_objEzsigntemplatedocument'] = this.aObjEzsigntemplatedocument;
    return json;
  }
  ...
  static EzsigntemplatedocumentCreateObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsigntemplatedocument'), 'Required key "EzsigntemplatedocumentCreateObjectV1Request[a_objEzsigntemplatedocument]" is missing from JSON.');
        assert(json[r'a_objEzsigntemplatedocument'] != null, 'Required key "EzsigntemplatedocumentCreateObjectV1Request[a_objEzsigntemplatedocument]" has a null value in JSON.');
        return true;
      }());
  ...
  static Map<String, List<EzsigntemplatedocumentCreateObjectV1Request>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplatedocumentCreateObjectV1Request.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
