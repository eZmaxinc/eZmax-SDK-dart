...
class EzsigntemplateGetAutocompleteV2ResponseMPayload {
  ...
  static EzsigntemplateGetAutocompleteV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsigntemplate'), 'Required key "EzsigntemplateGetAutocompleteV2ResponseMPayload[a_objEzsigntemplate]" is missing from JSON.');
        assert(json[r'a_objEzsigntemplate'] != null, 'Required key "EzsigntemplateGetAutocompleteV2ResponseMPayload[a_objEzsigntemplate]" has a null value in JSON.');
        return true;
      }());
