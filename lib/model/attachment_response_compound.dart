...
class AttachmentResponseCompound {
  /// Returns a new [AttachmentResponseCompound] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AttachmentResponseCompound &&
  ...
  /// Returns a new [AttachmentResponseCompound] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AttachmentResponseCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        ...
        assert(json.containsKey(r'sAttachmentCategory'), 'Required key "AttachmentResponseCompound[sAttachmentCategory]" is missing from JSON.');
        assert(json[r'sAttachmentCategory'] != null, 'Required key "AttachmentResponseCompound[sAttachmentCategory]" has a null value in JSON.');
  ...
  static List<AttachmentResponseCompound> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AttachmentResponseCompound>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AttachmentResponseCompound.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AttachmentResponseCompound> mapFromJson(dynamic json) {
    final map = <String, AttachmentResponseCompound>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AttachmentResponseCompound.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AttachmentResponseCompound-objects as value to a dart map
  static Map<String, List<AttachmentResponseCompound>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AttachmentResponseCompound>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AttachmentResponseCompound.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
