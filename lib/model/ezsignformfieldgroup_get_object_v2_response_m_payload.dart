...
class EzsignformfieldgroupGetObjectV2ResponseMPayload {
  ...
  static EzsignformfieldgroupGetObjectV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objEzsignformfieldgroup'), 'Required key "EzsignformfieldgroupGetObjectV2ResponseMPayload[objEzsignformfieldgroup]" is missing from JSON.');
        assert(json[r'objEzsignformfieldgroup'] != null, 'Required key "EzsignformfieldgroupGetObjectV2ResponseMPayload[objEzsignformfieldgroup]" has a null value in JSON.');
        return true;
      }());
