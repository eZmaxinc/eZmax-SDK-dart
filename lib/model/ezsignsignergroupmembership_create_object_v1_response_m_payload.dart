...
class EzsignsignergroupmembershipCreateObjectV1ResponseMPayload {
  ...
  static EzsignsignergroupmembershipCreateObjectV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiEzsignsignergroupmembershipID'), 'Required key "EzsignsignergroupmembershipCreateObjectV1ResponseMPayload[a_pkiEzsignsignergroupmembershipID]" is missing from JSON.');
        assert(json[r'a_pkiEzsignsignergroupmembershipID'] != null, 'Required key "EzsignsignergroupmembershipCreateObjectV1ResponseMPayload[a_pkiEzsignsignergroupmembershipID]" has a null value in JSON.');
        return true;
      }());
