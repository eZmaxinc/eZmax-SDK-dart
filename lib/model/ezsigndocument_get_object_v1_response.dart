    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EzsigndocumentGetObjectV1Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EzsigndocumentGetObjectV1Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return EzsigndocumentGetObjectV1Response(
        ...
        mPayload: EzsigndocumentResponseCompound.fromJson(json[r'mPayload'])!,
      );
    }
    return null;
  }
