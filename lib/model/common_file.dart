...
/// The source of the File
enum CommonFileEFileSourceEnum {
  base64._(r'Base64'),
  url._(r'Url'),
  ;

  /// Instantiate a new enum with the provided value.
  const CommonFileEFileSourceEnum._(this._value);
  ...
  /// Returns the instance of [CommonFileEFileSourceEnum] that was successfully decoded
  /// from the passed [value] on success, null otherwise.
  static CommonFileEFileSourceEnum? fromJson(dynamic value) => CommonFileEFileSourceEnumTypeTransformer().decode(value);

  /// Returns a [List] containing instances of [CommonFileEFileSourceEnum]
...
class CommonFileEFileSourceEnumTypeTransformer {
  ...
  String encode(CommonFileEFileSourceEnum data) => data._value;
  ...
  CommonFileEFileSourceEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data is CommonFileEFileSourceEnum) {
      return data;
    }
    if (data != null) {
      switch (data) {
