...
class UserCreateEzsignuserV1Response {
  ...
  static List<UserCreateEzsignuserV1Response> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(UserCreateEzsignuserV1Response.fromJson).toList(growable: true == growable)
  ...
  static Map<String, UserCreateEzsignuserV1Response> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = UserCreateEzsignuserV1Response.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of UserCreateEzsignuserV1Response-objects as value to a dart map
  static Map<String, List<UserCreateEzsignuserV1Response>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<UserCreateEzsignuserV1Response>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = UserCreateEzsignuserV1Response.listFromJson(
            value,
