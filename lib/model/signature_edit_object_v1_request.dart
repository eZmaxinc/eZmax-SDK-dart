...
class SignatureEditObjectV1Request {
  ...
  static SignatureEditObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objSignature'), 'Required key "SignatureEditObjectV1Request[objSignature]" is missing from JSON.');
        assert(json[r'objSignature'] != null, 'Required key "SignatureEditObjectV1Request[objSignature]" has a null value in JSON.');
        return true;
      }());
