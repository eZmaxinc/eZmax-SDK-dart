...
class EzsignbulksendsignermappingRequestCompoundV2 {
  /// Returns a new [EzsignbulksendsignermappingRequestCompoundV2] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsignbulksendsignermappingRequestCompoundV2 &&
  ...
  /// Returns a new [EzsignbulksendsignermappingRequestCompoundV2] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsignbulksendsignermappingRequestCompoundV2? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiEzsignbulksendID'), 'Required key "EzsignbulksendsignermappingRequestCompoundV2[fkiEzsignbulksendID]" is missing from JSON.');
        assert(json[r'fkiEzsignbulksendID'] != null, 'Required key "EzsignbulksendsignermappingRequestCompoundV2[fkiEzsignbulksendID]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsignbulksendsignermappingDescription'), 'Required key "EzsignbulksendsignermappingRequestCompoundV2[sEzsignbulksendsignermappingDescription]" is missing from JSON.');
        assert(json[r'sEzsignbulksendsignermappingDescription'] != null, 'Required key "EzsignbulksendsignermappingRequestCompoundV2[sEzsignbulksendsignermappingDescription]" has a null value in JSON.');
        return true;
      }());

      return EzsignbulksendsignermappingRequestCompoundV2(
  ...
  static List<EzsignbulksendsignermappingRequestCompoundV2> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsignbulksendsignermappingRequestCompoundV2>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsignbulksendsignermappingRequestCompoundV2.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsignbulksendsignermappingRequestCompoundV2> mapFromJson(dynamic json) {
    final map = <String, EzsignbulksendsignermappingRequestCompoundV2>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsignbulksendsignermappingRequestCompoundV2.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsignbulksendsignermappingRequestCompoundV2-objects as value to a dart map
  static Map<String, List<EzsignbulksendsignermappingRequestCompoundV2>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsignbulksendsignermappingRequestCompoundV2>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsignbulksendsignermappingRequestCompoundV2.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
