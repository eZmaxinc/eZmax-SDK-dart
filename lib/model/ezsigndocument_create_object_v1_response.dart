...
class EzsigndocumentCreateObjectV1Response {
  ...
  static List<EzsigndocumentCreateObjectV1Response> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(EzsigndocumentCreateObjectV1Response.fromJson).toList(growable: true == growable)
  ...
  static Map<String, EzsigndocumentCreateObjectV1Response> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = EzsigndocumentCreateObjectV1Response.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of EzsigndocumentCreateObjectV1Response-objects as value to a dart map
  static Map<String, List<EzsigndocumentCreateObjectV1Response>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<EzsigndocumentCreateObjectV1Response>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = EzsigndocumentCreateObjectV1Response.listFromJson(
            value,
