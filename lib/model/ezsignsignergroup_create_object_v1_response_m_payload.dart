...
class EzsignsignergroupCreateObjectV1ResponseMPayload {
  ...
  static EzsignsignergroupCreateObjectV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiEzsignsignergroupID'), 'Required key "EzsignsignergroupCreateObjectV1ResponseMPayload[a_pkiEzsignsignergroupID]" is missing from JSON.');
        assert(json[r'a_pkiEzsignsignergroupID'] != null, 'Required key "EzsignsignergroupCreateObjectV1ResponseMPayload[a_pkiEzsignsignergroupID]" has a null value in JSON.');
        return true;
      }());
