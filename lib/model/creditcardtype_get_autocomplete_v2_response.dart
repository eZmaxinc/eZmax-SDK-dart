...
class CreditcardtypeGetAutocompleteV2Response {
  ...
  static CreditcardtypeGetAutocompleteV2Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "CreditcardtypeGetAutocompleteV2Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "CreditcardtypeGetAutocompleteV2Response[objDebugPayload]" has a null value in JSON.');
        assert(json.containsKey(r'mPayload'), 'Required key "CreditcardtypeGetAutocompleteV2Response[mPayload]" is missing from JSON.');
        assert(json[r'mPayload'] != null, 'Required key "CreditcardtypeGetAutocompleteV2Response[mPayload]" has a null value in JSON.');
        return true;
      }());
