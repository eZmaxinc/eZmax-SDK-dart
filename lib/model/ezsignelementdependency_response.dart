...
class EzsignelementdependencyResponse {
  ...
  static EzsignelementdependencyResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsignelementdependencyID'), 'Required key "EzsignelementdependencyResponse[pkiEzsignelementdependencyID]" is missing from JSON.');
        assert(json[r'pkiEzsignelementdependencyID'] != null, 'Required key "EzsignelementdependencyResponse[pkiEzsignelementdependencyID]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsignelementdependencyValidation'), 'Required key "EzsignelementdependencyResponse[eEzsignelementdependencyValidation]" is missing from JSON.');
        assert(json[r'eEzsignelementdependencyValidation'] != null, 'Required key "EzsignelementdependencyResponse[eEzsignelementdependencyValidation]" has a null value in JSON.');
        return true;
      }());
