...
class EzsigndocumentGetAttachmentsV1Response {
  ...
  static EzsigndocumentGetAttachmentsV1Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "EzsigndocumentGetAttachmentsV1Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "EzsigndocumentGetAttachmentsV1Response[objDebugPayload]" has a null value in JSON.');
        assert(json.containsKey(r'mPayload'), 'Required key "EzsigndocumentGetAttachmentsV1Response[mPayload]" is missing from JSON.');
        assert(json[r'mPayload'] != null, 'Required key "EzsigndocumentGetAttachmentsV1Response[mPayload]" has a null value in JSON.');
        return true;
      }());
