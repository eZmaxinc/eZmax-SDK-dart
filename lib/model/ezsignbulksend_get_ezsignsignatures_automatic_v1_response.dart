...
class EzsignbulksendGetEzsignsignaturesAutomaticV1Response {
  ...
  static EzsignbulksendGetEzsignsignaturesAutomaticV1Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "EzsignbulksendGetEzsignsignaturesAutomaticV1Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "EzsignbulksendGetEzsignsignaturesAutomaticV1Response[objDebugPayload]" has a null value in JSON.');
        assert(json.containsKey(r'mPayload'), 'Required key "EzsignbulksendGetEzsignsignaturesAutomaticV1Response[mPayload]" is missing from JSON.');
        assert(json[r'mPayload'] != null, 'Required key "EzsignbulksendGetEzsignsignaturesAutomaticV1Response[mPayload]" has a null value in JSON.');
        return true;
      }());
