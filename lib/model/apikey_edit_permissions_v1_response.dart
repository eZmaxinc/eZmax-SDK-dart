...
class ApikeyEditPermissionsV1Response {
  ...
  @override
  String toString() => 'ApikeyEditPermissionsV1Response[objDebugPayload=$objDebugPayload, objDebug=$objDebug, mPayload=$mPayload]';
  ...
  static ApikeyEditPermissionsV1Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "ApikeyEditPermissionsV1Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "ApikeyEditPermissionsV1Response[objDebugPayload]" has a null value in JSON.');
        assert(json.containsKey(r'mPayload'), 'Required key "ApikeyEditPermissionsV1Response[mPayload]" is missing from JSON.');
        assert(json[r'mPayload'] != null, 'Required key "ApikeyEditPermissionsV1Response[mPayload]" has a null value in JSON.');
        return true;
      }());
