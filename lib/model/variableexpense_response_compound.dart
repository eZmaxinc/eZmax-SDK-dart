...
class VariableexpenseResponseCompound {
  /// Returns a new [VariableexpenseResponseCompound] instance.
  ...
  @override
  String toString() => 'VariableexpenseResponseCompound[pkiVariableexpenseID=$pkiVariableexpenseID, sVariableexpenseCode=$sVariableexpenseCode, objVariableexpenseDescription=$objVariableexpenseDescription, eVariableexpenseTaxable=$eVariableexpenseTaxable, bVariableexpenseIsactive=$bVariableexpenseIsactive]';
  ...
  /// Returns a new [VariableexpenseResponseCompound] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static VariableexpenseResponseCompound? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<VariableexpenseResponseCompound>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = VariableexpenseResponseCompound.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, VariableexpenseResponseCompound> mapFromJson(dynamic json) {
    final map = <String, VariableexpenseResponseCompound>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = VariableexpenseResponseCompound.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of VariableexpenseResponseCompound-objects as value to a dart map
