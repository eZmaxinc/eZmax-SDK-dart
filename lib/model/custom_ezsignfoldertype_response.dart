...
class CustomEzsignfoldertypeResponse {
  ...
  static CustomEzsignfoldertypeResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsignfoldertypeID'), 'Required key "CustomEzsignfoldertypeResponse[pkiEzsignfoldertypeID]" is missing from JSON.');
        assert(json[r'pkiEzsignfoldertypeID'] != null, 'Required key "CustomEzsignfoldertypeResponse[pkiEzsignfoldertypeID]" has a null value in JSON.');
        return true;
      }());
