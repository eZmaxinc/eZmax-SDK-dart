...
class EzsignfoldersignerassociationRequestCompoundV2 {
  /// Returns a new [EzsignfoldersignerassociationRequestCompoundV2] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsignfoldersignerassociationRequestCompoundV2 &&
  ...
  @override
  String toString() => 'EzsignfoldersignerassociationRequestCompoundV2[pkiEzsignfoldersignerassociationID=$pkiEzsignfoldersignerassociationID, fkiUserID=$fkiUserID, fkiEzsignsignergroupID=$fkiEzsignsignergroupID, fkiEzsignfolderID=$fkiEzsignfolderID, eEzsignfoldersignerassociationRole=$eEzsignfoldersignerassociationRole, tEzsignfoldersignerassociationMessage=$tEzsignfoldersignerassociationMessage, objEzsignsigner=$objEzsignsigner]';
  ...
  /// Returns a new [EzsignfoldersignerassociationRequestCompoundV2] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsignfoldersignerassociationRequestCompoundV2? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiEzsignfolderID'), 'Required key "EzsignfoldersignerassociationRequestCompoundV2[fkiEzsignfolderID]" is missing from JSON.');
        assert(json[r'fkiEzsignfolderID'] != null, 'Required key "EzsignfoldersignerassociationRequestCompoundV2[fkiEzsignfolderID]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsignfoldersignerassociationRole'), 'Required key "EzsignfoldersignerassociationRequestCompoundV2[eEzsignfoldersignerassociationRole]" is missing from JSON.');
        assert(json[r'eEzsignfoldersignerassociationRole'] != null, 'Required key "EzsignfoldersignerassociationRequestCompoundV2[eEzsignfoldersignerassociationRole]" has a null value in JSON.');
        return true;
      }());

      return EzsignfoldersignerassociationRequestCompoundV2(
  ...
  static List<EzsignfoldersignerassociationRequestCompoundV2> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsignfoldersignerassociationRequestCompoundV2>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsignfoldersignerassociationRequestCompoundV2.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsignfoldersignerassociationRequestCompoundV2> mapFromJson(dynamic json) {
    final map = <String, EzsignfoldersignerassociationRequestCompoundV2>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsignfoldersignerassociationRequestCompoundV2.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsignfoldersignerassociationRequestCompoundV2-objects as value to a dart map
  static Map<String, List<EzsignfoldersignerassociationRequestCompoundV2>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsignfoldersignerassociationRequestCompoundV2>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsignfoldersignerassociationRequestCompoundV2.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
