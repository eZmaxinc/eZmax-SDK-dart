...
class ApikeyRegenerateV1Response {
  ...
  @override
  String toString() => 'ApikeyRegenerateV1Response[objDebugPayload=$objDebugPayload, objDebug=$objDebug, mPayload=$mPayload]';
  ...
  static ApikeyRegenerateV1Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "ApikeyRegenerateV1Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "ApikeyRegenerateV1Response[objDebugPayload]" has a null value in JSON.');
        assert(json.containsKey(r'mPayload'), 'Required key "ApikeyRegenerateV1Response[mPayload]" is missing from JSON.');
        assert(json[r'mPayload'] != null, 'Required key "ApikeyRegenerateV1Response[mPayload]" has a null value in JSON.');
        return true;
      }());
