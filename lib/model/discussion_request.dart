...
class DiscussionRequest {
  ...
  static DiscussionRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'sDiscussionDescription'), 'Required key "DiscussionRequest[sDiscussionDescription]" is missing from JSON.');
        assert(json[r'sDiscussionDescription'] != null, 'Required key "DiscussionRequest[sDiscussionDescription]" has a null value in JSON.');
        return true;
      }());
