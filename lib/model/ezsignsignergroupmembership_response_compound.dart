...
class EzsignsignergroupmembershipResponseCompound {
  ...
  static EzsignsignergroupmembershipResponseCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsignsignergroupmembershipID'), 'Required key "EzsignsignergroupmembershipResponseCompound[pkiEzsignsignergroupmembershipID]" is missing from JSON.');
        assert(json[r'pkiEzsignsignergroupmembershipID'] != null, 'Required key "EzsignsignergroupmembershipResponseCompound[pkiEzsignsignergroupmembershipID]" has a null value in JSON.');
        assert(json.containsKey(r'fkiEzsignsignergroupID'), 'Required key "EzsignsignergroupmembershipResponseCompound[fkiEzsignsignergroupID]" is missing from JSON.');
        assert(json[r'fkiEzsignsignergroupID'] != null, 'Required key "EzsignsignergroupmembershipResponseCompound[fkiEzsignsignergroupID]" has a null value in JSON.');
        return true;
      }());
