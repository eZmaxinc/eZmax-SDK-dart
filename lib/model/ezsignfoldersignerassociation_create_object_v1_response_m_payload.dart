...
class EzsignfoldersignerassociationCreateObjectV1ResponseMPayload {
  ...
  static EzsignfoldersignerassociationCreateObjectV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiEzsignfoldersignerassociationID'), 'Required key "EzsignfoldersignerassociationCreateObjectV1ResponseMPayload[a_pkiEzsignfoldersignerassociationID]" is missing from JSON.');
        assert(json[r'a_pkiEzsignfoldersignerassociationID'] != null, 'Required key "EzsignfoldersignerassociationCreateObjectV1ResponseMPayload[a_pkiEzsignfoldersignerassociationID]" has a null value in JSON.');
        return true;
      }());
