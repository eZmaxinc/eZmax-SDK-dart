...
class EzsigntemplateelementdependencyResponse {
  /// Returns a new [EzsigntemplateelementdependencyResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsigntemplateelementdependencyResponse &&
  ...
  /// Returns a new [EzsigntemplateelementdependencyResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsigntemplateelementdependencyResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsigntemplateelementdependencyID'), 'Required key "EzsigntemplateelementdependencyResponse[pkiEzsigntemplateelementdependencyID]" is missing from JSON.');
        assert(json[r'pkiEzsigntemplateelementdependencyID'] != null, 'Required key "EzsigntemplateelementdependencyResponse[pkiEzsigntemplateelementdependencyID]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsigntemplateelementdependencyValidation'), 'Required key "EzsigntemplateelementdependencyResponse[eEzsigntemplateelementdependencyValidation]" is missing from JSON.');
        assert(json[r'eEzsigntemplateelementdependencyValidation'] != null, 'Required key "EzsigntemplateelementdependencyResponse[eEzsigntemplateelementdependencyValidation]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<EzsigntemplateelementdependencyResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigntemplateelementdependencyResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigntemplateelementdependencyResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigntemplateelementdependencyResponse> mapFromJson(dynamic json) {
    final map = <String, EzsigntemplateelementdependencyResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplateelementdependencyResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigntemplateelementdependencyResponse-objects as value to a dart map
  static Map<String, List<EzsigntemplateelementdependencyResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigntemplateelementdependencyResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplateelementdependencyResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
