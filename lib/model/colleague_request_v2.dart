...
class ColleagueRequestV2 {
  /// Returns a new [ColleagueRequestV2] instance.
  ColleagueRequestV2({
    this.pkiColleagueID,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ColleagueRequestV2 &&
  ...
  /// Returns a new [ColleagueRequestV2] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ColleagueRequestV2? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<ColleagueRequestV2> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ColleagueRequestV2>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ColleagueRequestV2.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ColleagueRequestV2> mapFromJson(dynamic json) {
    final map = <String, ColleagueRequestV2>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ColleagueRequestV2.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ColleagueRequestV2-objects as value to a dart map
  static Map<String, List<ColleagueRequestV2>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ColleagueRequestV2>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ColleagueRequestV2.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
