...
class CommunicationattachmentRequest {
  /// Returns a new [CommunicationattachmentRequest] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CommunicationattachmentRequest &&
  ...
  @override
  String toString() => 'CommunicationattachmentRequest[pkiCommunicationattachmentID=$pkiCommunicationattachmentID, fkiAttachmentID=$fkiAttachmentID, fkiInvoiceID=$fkiInvoiceID, fkiSalarypreparationID=$fkiSalarypreparationID]';
  ...
  /// Returns a new [CommunicationattachmentRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CommunicationattachmentRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CommunicationattachmentRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CommunicationattachmentRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CommunicationattachmentRequest> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CommunicationattachmentRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CommunicationattachmentRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CommunicationattachmentRequest> mapFromJson(dynamic json) {
    final map = <String, CommunicationattachmentRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CommunicationattachmentRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CommunicationattachmentRequest-objects as value to a dart map
  static Map<String, List<CommunicationattachmentRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CommunicationattachmentRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CommunicationattachmentRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
