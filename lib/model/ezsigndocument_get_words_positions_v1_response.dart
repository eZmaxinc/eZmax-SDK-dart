...
class EzsigndocumentGetWordsPositionsV1Response {
  ...
  static EzsigndocumentGetWordsPositionsV1Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "EzsigndocumentGetWordsPositionsV1Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "EzsigndocumentGetWordsPositionsV1Response[objDebugPayload]" has a null value in JSON.');
        assert(json.containsKey(r'mPayload'), 'Required key "EzsigndocumentGetWordsPositionsV1Response[mPayload]" is missing from JSON.');
        assert(json[r'mPayload'] != null, 'Required key "EzsigndocumentGetWordsPositionsV1Response[mPayload]" has a null value in JSON.');
        return true;
      }());
