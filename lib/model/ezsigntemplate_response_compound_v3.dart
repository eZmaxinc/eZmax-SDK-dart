...
class EzsigntemplateResponseCompoundV3 {
  /// Returns a new [EzsigntemplateResponseCompoundV3] instance.
  ...
  /// Returns a new [EzsigntemplateResponseCompoundV3] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsigntemplateResponseCompoundV3? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<EzsigntemplateResponseCompoundV3> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigntemplateResponseCompoundV3>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigntemplateResponseCompoundV3.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigntemplateResponseCompoundV3> mapFromJson(dynamic json) {
    final map = <String, EzsigntemplateResponseCompoundV3>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplateResponseCompoundV3.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigntemplateResponseCompoundV3-objects as value to a dart map
  static Map<String, List<EzsigntemplateResponseCompoundV3>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigntemplateResponseCompoundV3>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplateResponseCompoundV3.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
