...
class EzsignfoldersignerassociationEditObjectV1Request {
  ...
  static EzsignfoldersignerassociationEditObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objEzsignfoldersignerassociation'), 'Required key "EzsignfoldersignerassociationEditObjectV1Request[objEzsignfoldersignerassociation]" is missing from JSON.');
        assert(json[r'objEzsignfoldersignerassociation'] != null, 'Required key "EzsignfoldersignerassociationEditObjectV1Request[objEzsignfoldersignerassociation]" has a null value in JSON.');
        return true;
      }());
