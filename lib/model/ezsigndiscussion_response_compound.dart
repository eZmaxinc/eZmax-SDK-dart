...
class EzsigndiscussionResponseCompound {
  /// Returns a new [EzsigndiscussionResponseCompound] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsigndiscussionResponseCompound &&
  ...
  /// Returns a new [EzsigndiscussionResponseCompound] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsigndiscussionResponseCompound? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<EzsigndiscussionResponseCompound> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigndiscussionResponseCompound>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigndiscussionResponseCompound.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigndiscussionResponseCompound> mapFromJson(dynamic json) {
    final map = <String, EzsigndiscussionResponseCompound>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigndiscussionResponseCompound.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigndiscussionResponseCompound-objects as value to a dart map
  static Map<String, List<EzsigndiscussionResponseCompound>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigndiscussionResponseCompound>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigndiscussionResponseCompound.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
