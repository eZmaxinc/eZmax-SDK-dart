...
class WebhookCreateObjectV2ResponseMPayload {
  ...
  static WebhookCreateObjectV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objWebhook'), 'Required key "WebhookCreateObjectV2ResponseMPayload[a_objWebhook]" is missing from JSON.');
        assert(json[r'a_objWebhook'] != null, 'Required key "WebhookCreateObjectV2ResponseMPayload[a_objWebhook]" has a null value in JSON.');
        return true;
      }());
