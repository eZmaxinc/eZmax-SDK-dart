...
class CorsEditObjectV1Response {
  ...
  static CorsEditObjectV1Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "CorsEditObjectV1Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "CorsEditObjectV1Response[objDebugPayload]" has a null value in JSON.');
        return true;
      }());
