...
class ActivesessionGetCurrentV2Response {
  ...
  static ActivesessionGetCurrentV2Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "ActivesessionGetCurrentV2Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "ActivesessionGetCurrentV2Response[objDebugPayload]" has a null value in JSON.');
        assert(json.containsKey(r'mPayload'), 'Required key "ActivesessionGetCurrentV2Response[mPayload]" is missing from JSON.');
        assert(json[r'mPayload'] != null, 'Required key "ActivesessionGetCurrentV2Response[mPayload]" has a null value in JSON.');
        return true;
      }());
