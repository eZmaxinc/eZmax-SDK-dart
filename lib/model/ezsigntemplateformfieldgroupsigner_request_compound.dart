...
class EzsigntemplateformfieldgroupsignerRequestCompound {
  ...
  static EzsigntemplateformfieldgroupsignerRequestCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiEzsigntemplatesignerID'), 'Required key "EzsigntemplateformfieldgroupsignerRequestCompound[fkiEzsigntemplatesignerID]" is missing from JSON.');
        assert(json[r'fkiEzsigntemplatesignerID'] != null, 'Required key "EzsigntemplateformfieldgroupsignerRequestCompound[fkiEzsigntemplatesignerID]" has a null value in JSON.');
        return true;
      }());
