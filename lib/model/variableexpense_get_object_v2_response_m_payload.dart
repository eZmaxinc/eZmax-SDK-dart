...
class VariableexpenseGetObjectV2ResponseMPayload {
  ...
  static VariableexpenseGetObjectV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objVariableexpense'), 'Required key "VariableexpenseGetObjectV2ResponseMPayload[objVariableexpense]" is missing from JSON.');
        assert(json[r'objVariableexpense'] != null, 'Required key "VariableexpenseGetObjectV2ResponseMPayload[objVariableexpense]" has a null value in JSON.');
        return true;
      }());
