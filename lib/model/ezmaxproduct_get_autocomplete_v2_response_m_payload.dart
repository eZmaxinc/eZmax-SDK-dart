...
class EzmaxproductGetAutocompleteV2ResponseMPayload {
  ...
  bool operator ==(Object other) => identical(this, other) || other is EzmaxproductGetAutocompleteV2ResponseMPayload &&
    _deepEquality.equals(other.aObjEzmaxproduct, aObjEzmaxproduct);
  ...
  static EzmaxproductGetAutocompleteV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzmaxproduct'), 'Required key "EzmaxproductGetAutocompleteV2ResponseMPayload[a_objEzmaxproduct]" is missing from JSON.');
        assert(json[r'a_objEzmaxproduct'] != null, 'Required key "EzmaxproductGetAutocompleteV2ResponseMPayload[a_objEzmaxproduct]" has a null value in JSON.');
        return true;
      }());
