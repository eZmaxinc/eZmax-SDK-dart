...
class DiscussionmessageCreateObjectV1Request {
  ...
  static DiscussionmessageCreateObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objDiscussionmessage'), 'Required key "DiscussionmessageCreateObjectV1Request[a_objDiscussionmessage]" is missing from JSON.');
        assert(json[r'a_objDiscussionmessage'] != null, 'Required key "DiscussionmessageCreateObjectV1Request[a_objDiscussionmessage]" has a null value in JSON.');
        return true;
      }());
