...
class FranchisebrokerGetAutocompleteV2Response {
  ...
  @override
  String toString() => 'FranchisebrokerGetAutocompleteV2Response[objDebugPayload=$objDebugPayload, objDebug=$objDebug, mPayload=$mPayload]';
  ...
  static FranchisebrokerGetAutocompleteV2Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "FranchisebrokerGetAutocompleteV2Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "FranchisebrokerGetAutocompleteV2Response[objDebugPayload]" has a null value in JSON.');
        assert(json.containsKey(r'mPayload'), 'Required key "FranchisebrokerGetAutocompleteV2Response[mPayload]" is missing from JSON.');
        assert(json[r'mPayload'] != null, 'Required key "FranchisebrokerGetAutocompleteV2Response[mPayload]" has a null value in JSON.');
        return true;
      }());
  ...
  static Map<String, List<FranchisebrokerGetAutocompleteV2Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = FranchisebrokerGetAutocompleteV2Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
