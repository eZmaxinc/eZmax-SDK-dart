...
class EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload {
  ...
  static EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_eEzsignsignatureType'), 'Required key "EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload[a_eEzsignsignatureType]" is missing from JSON.');
        assert(json[r'a_eEzsignsignatureType'] != null, 'Required key "EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload[a_eEzsignsignatureType]" has a null value in JSON.');
        assert(json.containsKey(r'a_objEzsignfolder'), 'Required key "EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload[a_objEzsignfolder]" is missing from JSON.');
        assert(json[r'a_objEzsignfolder'] != null, 'Required key "EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload[a_objEzsignfolder]" has a null value in JSON.');
        return true;
      }());
