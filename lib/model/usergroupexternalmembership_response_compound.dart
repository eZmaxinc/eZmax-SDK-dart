...
class UsergroupexternalmembershipResponseCompound {
  /// Returns a new [UsergroupexternalmembershipResponseCompound] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UsergroupexternalmembershipResponseCompound &&
  ...
  /// Returns a new [UsergroupexternalmembershipResponseCompound] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UsergroupexternalmembershipResponseCompound? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<UsergroupexternalmembershipResponseCompound> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <UsergroupexternalmembershipResponseCompound>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UsergroupexternalmembershipResponseCompound.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UsergroupexternalmembershipResponseCompound> mapFromJson(dynamic json) {
    final map = <String, UsergroupexternalmembershipResponseCompound>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UsergroupexternalmembershipResponseCompound.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of UsergroupexternalmembershipResponseCompound-objects as value to a dart map
  static Map<String, List<UsergroupexternalmembershipResponseCompound>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UsergroupexternalmembershipResponseCompound>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UsergroupexternalmembershipResponseCompound.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
