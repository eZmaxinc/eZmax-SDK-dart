...
class EzdoctemplatetypeGetAutocompleteV2ResponseMPayload {
  ...
  static EzdoctemplatetypeGetAutocompleteV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzdoctemplatetype'), 'Required key "EzdoctemplatetypeGetAutocompleteV2ResponseMPayload[a_objEzdoctemplatetype]" is missing from JSON.');
        assert(json[r'a_objEzdoctemplatetype'] != null, 'Required key "EzdoctemplatetypeGetAutocompleteV2ResponseMPayload[a_objEzdoctemplatetype]" has a null value in JSON.');
        return true;
      }());
