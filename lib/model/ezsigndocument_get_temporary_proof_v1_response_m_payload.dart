...
class EzsigndocumentGetTemporaryProofV1ResponseMPayload {
  ...
  static EzsigndocumentGetTemporaryProofV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsigndocumentlog'), 'Required key "EzsigndocumentGetTemporaryProofV1ResponseMPayload[a_objEzsigndocumentlog]" is missing from JSON.');
        assert(json[r'a_objEzsigndocumentlog'] != null, 'Required key "EzsigndocumentGetTemporaryProofV1ResponseMPayload[a_objEzsigndocumentlog]" has a null value in JSON.');
        return true;
      }());
  ...
  static Map<String, List<EzsigndocumentGetTemporaryProofV1ResponseMPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsigndocumentGetTemporaryProofV1ResponseMPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
