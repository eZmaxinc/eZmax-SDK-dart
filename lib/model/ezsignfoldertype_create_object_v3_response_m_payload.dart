...
class EzsignfoldertypeCreateObjectV3ResponseMPayload {
  ...
  static EzsignfoldertypeCreateObjectV3ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiEzsignfoldertypeID'), 'Required key "EzsignfoldertypeCreateObjectV3ResponseMPayload[a_pkiEzsignfoldertypeID]" is missing from JSON.');
        assert(json[r'a_pkiEzsignfoldertypeID'] != null, 'Required key "EzsignfoldertypeCreateObjectV3ResponseMPayload[a_pkiEzsignfoldertypeID]" has a null value in JSON.');
        return true;
      }());
