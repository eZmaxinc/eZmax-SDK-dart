...
class VariableexpenseResponse {
  ...
  static VariableexpenseResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiVariableexpenseID'), 'Required key "VariableexpenseResponse[pkiVariableexpenseID]" is missing from JSON.');
        assert(json[r'pkiVariableexpenseID'] != null, 'Required key "VariableexpenseResponse[pkiVariableexpenseID]" has a null value in JSON.');
        assert(json.containsKey(r'objVariableexpenseDescription'), 'Required key "VariableexpenseResponse[objVariableexpenseDescription]" is missing from JSON.');
        assert(json[r'objVariableexpenseDescription'] != null, 'Required key "VariableexpenseResponse[objVariableexpenseDescription]" has a null value in JSON.');
        return true;
      }());
