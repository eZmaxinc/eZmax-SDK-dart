...
class EzsignfolderCreateObjectV2Request {
  ...
  static EzsignfolderCreateObjectV2Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsignfolder'), 'Required key "EzsignfolderCreateObjectV2Request[a_objEzsignfolder]" is missing from JSON.');
        assert(json[r'a_objEzsignfolder'] != null, 'Required key "EzsignfolderCreateObjectV2Request[a_objEzsignfolder]" has a null value in JSON.');
        return true;
      }());
