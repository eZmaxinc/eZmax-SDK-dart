...
class ApikeyGetCorsV1ResponseMPayload {
  ...
  static ApikeyGetCorsV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objCors'), 'Required key "ApikeyGetCorsV1ResponseMPayload[a_objCors]" is missing from JSON.');
        assert(json[r'a_objCors'] != null, 'Required key "ApikeyGetCorsV1ResponseMPayload[a_objCors]" has a null value in JSON.');
        return true;
      }());
