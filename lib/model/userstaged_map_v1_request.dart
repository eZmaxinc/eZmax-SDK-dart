...
class UserstagedMapV1Request {
  ...
  static UserstagedMapV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiUserID'), 'Required key "UserstagedMapV1Request[fkiUserID]" is missing from JSON.');
        assert(json[r'fkiUserID'] != null, 'Required key "UserstagedMapV1Request[fkiUserID]" has a null value in JSON.');
        return true;
      }());
