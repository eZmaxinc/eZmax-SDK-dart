...
class EzsigndocumentdependencyRequestCompound {
  ...
  static EzsigndocumentdependencyRequestCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiEzsigndocumentIDdependency'), 'Required key "EzsigndocumentdependencyRequestCompound[fkiEzsigndocumentIDdependency]" is missing from JSON.');
        assert(json[r'fkiEzsigndocumentIDdependency'] != null, 'Required key "EzsigndocumentdependencyRequestCompound[fkiEzsigndocumentIDdependency]" has a null value in JSON.');
        return true;
      }());
