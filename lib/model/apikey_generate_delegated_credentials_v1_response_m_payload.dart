...
class ApikeyGenerateDelegatedCredentialsV1ResponseMPayload {
  ...
  static ApikeyGenerateDelegatedCredentialsV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objApikey'), 'Required key "ApikeyGenerateDelegatedCredentialsV1ResponseMPayload[objApikey]" is missing from JSON.');
        assert(json[r'objApikey'] != null, 'Required key "ApikeyGenerateDelegatedCredentialsV1ResponseMPayload[objApikey]" has a null value in JSON.');
        return true;
      }());
