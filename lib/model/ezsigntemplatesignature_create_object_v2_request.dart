...
class EzsigntemplatesignatureCreateObjectV2Request {
  ...
  static EzsigntemplatesignatureCreateObjectV2Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsigntemplatesignature'), 'Required key "EzsigntemplatesignatureCreateObjectV2Request[a_objEzsigntemplatesignature]" is missing from JSON.');
        assert(json[r'a_objEzsigntemplatesignature'] != null, 'Required key "EzsigntemplatesignatureCreateObjectV2Request[a_objEzsigntemplatesignature]" has a null value in JSON.');
        return true;
      }());
