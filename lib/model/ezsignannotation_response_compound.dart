...
class EzsignannotationResponseCompound {
  /// Returns a new [EzsignannotationResponseCompound] instance.
  ...
  @override
  String toString() => 'EzsignannotationResponseCompound[pkiEzsignannotationID=$pkiEzsignannotationID, fkiEzsigndocumentID=$fkiEzsigndocumentID, eEzsignannotationHorizontalalignment=$eEzsignannotationHorizontalalignment, eEzsignannotationVerticalalignment=$eEzsignannotationVerticalalignment, eEzsignannotationType=$eEzsignannotationType, iEzsignannotationX=$iEzsignannotationX, iEzsignannotationY=$iEzsignannotationY, iEzsignannotationWidth=$iEzsignannotationWidth, iEzsignannotationHeight=$iEzsignannotationHeight, sEzsignannotationText=$sEzsignannotationText, iEzsignpagePagenumber=$iEzsignpagePagenumber, objTextstylestatic=$objTextstylestatic]';
  ...
  /// Returns a new [EzsignannotationResponseCompound] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsignannotationResponseCompound? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<EzsignannotationResponseCompound> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsignannotationResponseCompound>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsignannotationResponseCompound.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsignannotationResponseCompound> mapFromJson(dynamic json) {
    final map = <String, EzsignannotationResponseCompound>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsignannotationResponseCompound.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsignannotationResponseCompound-objects as value to a dart map
  static Map<String, List<EzsignannotationResponseCompound>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsignannotationResponseCompound>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsignannotationResponseCompound.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
