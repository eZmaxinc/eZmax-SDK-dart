...
class GlaccountcontainerGetAutocompleteV2ResponseMPayload {
  ...
  static GlaccountcontainerGetAutocompleteV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objGlaccountcontainer'), 'Required key "GlaccountcontainerGetAutocompleteV2ResponseMPayload[a_objGlaccountcontainer]" is missing from JSON.');
        assert(json[r'a_objGlaccountcontainer'] != null, 'Required key "GlaccountcontainerGetAutocompleteV2ResponseMPayload[a_objGlaccountcontainer]" has a null value in JSON.');
        return true;
      }());
