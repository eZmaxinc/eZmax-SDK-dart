...
class EzsignfolderGetEzsignfoldersignerassociationsV1Response {
  ...
  @override
  String toString() => 'EzsignfolderGetEzsignfoldersignerassociationsV1Response[mPayload=$mPayload, objDebugPayload=$objDebugPayload, objDebug=$objDebug]';
  ...
  static List<EzsignfolderGetEzsignfoldersignerassociationsV1Response> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(EzsignfolderGetEzsignfoldersignerassociationsV1Response.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <EzsignfolderGetEzsignfoldersignerassociationsV1Response>[];
  ...
  static Map<String, EzsignfolderGetEzsignfoldersignerassociationsV1Response> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = EzsignfolderGetEzsignfoldersignerassociationsV1Response.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of EzsignfolderGetEzsignfoldersignerassociationsV1Response-objects as value to a dart map
  static Map<String, List<EzsignfolderGetEzsignfoldersignerassociationsV1Response>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<EzsignfolderGetEzsignfoldersignerassociationsV1Response>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = EzsignfolderGetEzsignfoldersignerassociationsV1Response.listFromJson(
            value,
