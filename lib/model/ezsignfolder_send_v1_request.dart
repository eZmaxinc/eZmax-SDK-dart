...
class EzsignfolderSendV1Request {
  ...
  static EzsignfolderSendV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'tExtraMessage'), 'Required key "EzsignfolderSendV1Request[tExtraMessage]" is missing from JSON.');
        assert(json[r'tExtraMessage'] != null, 'Required key "EzsignfolderSendV1Request[tExtraMessage]" has a null value in JSON.');
        return true;
      }());
