...
class EzsignsignerResponseCompound {
  ...
  static EzsignsignerResponseCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsignsignerID'), 'Required key "EzsignsignerResponseCompound[pkiEzsignsignerID]" is missing from JSON.');
        assert(json[r'pkiEzsignsignerID'] != null, 'Required key "EzsignsignerResponseCompound[pkiEzsignsignerID]" has a null value in JSON.');
        assert(json.containsKey(r'fkiTaxassignmentID'), 'Required key "EzsignsignerResponseCompound[fkiTaxassignmentID]" is missing from JSON.');
        assert(json[r'fkiTaxassignmentID'] != null, 'Required key "EzsignsignerResponseCompound[fkiTaxassignmentID]" has a null value in JSON.');
        assert(json.containsKey(r'fkiUserlogintypeID'), 'Required key "EzsignsignerResponseCompound[fkiUserlogintypeID]" is missing from JSON.');
        assert(json[r'fkiUserlogintypeID'] != null, 'Required key "EzsignsignerResponseCompound[fkiUserlogintypeID]" has a null value in JSON.');
        assert(json.containsKey(r'sUserlogintypeDescriptionX'), 'Required key "EzsignsignerResponseCompound[sUserlogintypeDescriptionX]" is missing from JSON.');
        assert(json[r'sUserlogintypeDescriptionX'] != null, 'Required key "EzsignsignerResponseCompound[sUserlogintypeDescriptionX]" has a null value in JSON.');
        assert(json.containsKey(r'objContact'), 'Required key "EzsignsignerResponseCompound[objContact]" is missing from JSON.');
        assert(json[r'objContact'] != null, 'Required key "EzsignsignerResponseCompound[objContact]" has a null value in JSON.');
        return true;
      }());
