...
class EzsignsignatureCreateObjectV1Response {
  ...
  static List<EzsignsignatureCreateObjectV1Response> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(EzsignsignatureCreateObjectV1Response.fromJson).toList(growable: true == growable)
  ...
  static Map<String, EzsignsignatureCreateObjectV1Response> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = EzsignsignatureCreateObjectV1Response.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of EzsignsignatureCreateObjectV1Response-objects as value to a dart map
  static Map<String, List<EzsignsignatureCreateObjectV1Response>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<EzsignsignatureCreateObjectV1Response>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = EzsignsignatureCreateObjectV1Response.listFromJson(
            value,
