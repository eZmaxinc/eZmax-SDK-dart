...
class SystemconfigurationRequestV2 {
  /// Returns a new [SystemconfigurationRequestV2] instance.
  SystemconfigurationRequestV2({
    ...
    required this.iSystemconfigurationEzsignreminderhoursend,
  });
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SystemconfigurationRequestV2 &&
  ...
  /// Returns a new [SystemconfigurationRequestV2] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SystemconfigurationRequestV2? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'eSystemconfigurationNewexternaluseraction'), 'Required key "SystemconfigurationRequestV2[eSystemconfigurationNewexternaluseraction]" is missing from JSON.');
        assert(json[r'eSystemconfigurationNewexternaluseraction'] != null, 'Required key "SystemconfigurationRequestV2[eSystemconfigurationNewexternaluseraction]" has a null value in JSON.');
        assert(json.containsKey(r'eSystemconfigurationLanguage1'), 'Required key "SystemconfigurationRequestV2[eSystemconfigurationLanguage1]" is missing from JSON.');
        assert(json[r'eSystemconfigurationLanguage1'] != null, 'Required key "SystemconfigurationRequestV2[eSystemconfigurationLanguage1]" has a null value in JSON.');
        assert(json.containsKey(r'eSystemconfigurationLanguage2'), 'Required key "SystemconfigurationRequestV2[eSystemconfigurationLanguage2]" is missing from JSON.');
        assert(json[r'eSystemconfigurationLanguage2'] != null, 'Required key "SystemconfigurationRequestV2[eSystemconfigurationLanguage2]" has a null value in JSON.');
        assert(json.containsKey(r'bSystemconfigurationEzsignpersonnal'), 'Required key "SystemconfigurationRequestV2[bSystemconfigurationEzsignpersonnal]" is missing from JSON.');
        assert(json[r'bSystemconfigurationEzsignpersonnal'] != null, 'Required key "SystemconfigurationRequestV2[bSystemconfigurationEzsignpersonnal]" has a null value in JSON.');
        assert(json.containsKey(r'bSystemconfigurationSspr'), 'Required key "SystemconfigurationRequestV2[bSystemconfigurationSspr]" is missing from JSON.');
        assert(json[r'bSystemconfigurationSspr'] != null, 'Required key "SystemconfigurationRequestV2[bSystemconfigurationSspr]" has a null value in JSON.');
        assert(json.containsKey(r'iSystemconfigurationEzsignreminderhoursend'), 'Required key "SystemconfigurationRequestV2[iSystemconfigurationEzsignreminderhoursend]" is missing from JSON.');
        assert(json[r'iSystemconfigurationEzsignreminderhoursend'] != null, 'Required key "SystemconfigurationRequestV2[iSystemconfigurationEzsignreminderhoursend]" has a null value in JSON.');
        return true;
      }());

      return SystemconfigurationRequestV2(
  ...
  static List<SystemconfigurationRequestV2> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SystemconfigurationRequestV2>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SystemconfigurationRequestV2.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SystemconfigurationRequestV2> mapFromJson(dynamic json) {
    final map = <String, SystemconfigurationRequestV2>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SystemconfigurationRequestV2.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SystemconfigurationRequestV2-objects as value to a dart map
  static Map<String, List<SystemconfigurationRequestV2>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SystemconfigurationRequestV2>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SystemconfigurationRequestV2.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
