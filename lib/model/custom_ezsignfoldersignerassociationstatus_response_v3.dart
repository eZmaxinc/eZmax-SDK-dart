...
class CustomEzsignfoldersignerassociationstatusResponseV3 {
  /// Returns a new [CustomEzsignfoldersignerassociationstatusResponseV3] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CustomEzsignfoldersignerassociationstatusResponseV3 &&
  ...
  /// Returns a new [CustomEzsignfoldersignerassociationstatusResponseV3] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CustomEzsignfoldersignerassociationstatusResponseV3? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CustomEzsignfoldersignerassociationstatusResponseV3(
  ...
  static List<CustomEzsignfoldersignerassociationstatusResponseV3> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CustomEzsignfoldersignerassociationstatusResponseV3>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CustomEzsignfoldersignerassociationstatusResponseV3.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CustomEzsignfoldersignerassociationstatusResponseV3> mapFromJson(dynamic json) {
    final map = <String, CustomEzsignfoldersignerassociationstatusResponseV3>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CustomEzsignfoldersignerassociationstatusResponseV3.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CustomEzsignfoldersignerassociationstatusResponseV3-objects as value to a dart map
  static Map<String, List<CustomEzsignfoldersignerassociationstatusResponseV3>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CustomEzsignfoldersignerassociationstatusResponseV3>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CustomEzsignfoldersignerassociationstatusResponseV3.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
