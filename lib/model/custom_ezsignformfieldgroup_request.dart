...
class CustomEzsignformfieldgroupRequest {
  ...
  static CustomEzsignformfieldgroupRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsignformfield'), 'Required key "CustomEzsignformfieldgroupRequest[a_objEzsignformfield]" is missing from JSON.');
        assert(json[r'a_objEzsignformfield'] != null, 'Required key "CustomEzsignformfieldgroupRequest[a_objEzsignformfield]" has a null value in JSON.');
        return true;
      }());
