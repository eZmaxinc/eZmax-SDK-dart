...
class InscriptiontempGetCommunicationsendersV1ResponseMPayload {
  ...
  static InscriptiontempGetCommunicationsendersV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objCommunicationsenders'), 'Required key "InscriptiontempGetCommunicationsendersV1ResponseMPayload[a_objCommunicationsenders]" is missing from JSON.');
        assert(json[r'a_objCommunicationsenders'] != null, 'Required key "InscriptiontempGetCommunicationsendersV1ResponseMPayload[a_objCommunicationsenders]" has a null value in JSON.');
        return true;
      }());
