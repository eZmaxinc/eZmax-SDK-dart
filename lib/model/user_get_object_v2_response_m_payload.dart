...
class UserGetObjectV2ResponseMPayload {
  ...
  static UserGetObjectV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objUser'), 'Required key "UserGetObjectV2ResponseMPayload[objUser]" is missing from JSON.');
        assert(json[r'objUser'] != null, 'Required key "UserGetObjectV2ResponseMPayload[objUser]" has a null value in JSON.');
        return true;
      }());
