...
class UsergroupdelegationResponseCompound {
  /// Returns a new [UsergroupdelegationResponseCompound] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UsergroupdelegationResponseCompound &&
  ...
  /// Returns a new [UsergroupdelegationResponseCompound] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UsergroupdelegationResponseCompound? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<UsergroupdelegationResponseCompound> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <UsergroupdelegationResponseCompound>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UsergroupdelegationResponseCompound.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UsergroupdelegationResponseCompound> mapFromJson(dynamic json) {
    final map = <String, UsergroupdelegationResponseCompound>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UsergroupdelegationResponseCompound.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of UsergroupdelegationResponseCompound-objects as value to a dart map
  static Map<String, List<UsergroupdelegationResponseCompound>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UsergroupdelegationResponseCompound>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UsergroupdelegationResponseCompound.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
