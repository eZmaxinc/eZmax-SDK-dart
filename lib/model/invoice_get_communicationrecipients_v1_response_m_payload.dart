...
class InvoiceGetCommunicationrecipientsV1ResponseMPayload {
  ...
  static InvoiceGetCommunicationrecipientsV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objCommunicationrecipientsgroup'), 'Required key "InvoiceGetCommunicationrecipientsV1ResponseMPayload[a_objCommunicationrecipientsgroup]" is missing from JSON.');
        assert(json[r'a_objCommunicationrecipientsgroup'] != null, 'Required key "InvoiceGetCommunicationrecipientsV1ResponseMPayload[a_objCommunicationrecipientsgroup]" has a null value in JSON.');
        return true;
      }());
