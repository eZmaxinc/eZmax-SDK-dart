...
class EzsigntemplatesignerResponse {
  /// Returns a new [EzsigntemplatesignerResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsigntemplatesignerResponse &&
  ...
  @override
  String toString() => 'EzsigntemplatesignerResponse[pkiEzsigntemplatesignerID=$pkiEzsigntemplatesignerID, fkiEzsigntemplateID=$fkiEzsigntemplateID, fkiUserID=$fkiUserID, fkiUsergroupID=$fkiUsergroupID, fkiEzdoctemplatedocumentID=$fkiEzdoctemplatedocumentID, bEzsigntemplatesignerReceivecopy=$bEzsigntemplatesignerReceivecopy, eEzsigntemplatesignerMapping=$eEzsigntemplatesignerMapping, sEzsigntemplatesignerDescription=$sEzsigntemplatesignerDescription, sUserName=$sUserName, sUsergroupNameX=$sUsergroupNameX]';
  ...
  /// Returns a new [EzsigntemplatesignerResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsigntemplatesignerResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsigntemplatesignerID'), 'Required key "EzsigntemplatesignerResponse[pkiEzsigntemplatesignerID]" is missing from JSON.');
        assert(json[r'pkiEzsigntemplatesignerID'] != null, 'Required key "EzsigntemplatesignerResponse[pkiEzsigntemplatesignerID]" has a null value in JSON.');
        assert(json.containsKey(r'fkiEzsigntemplateID'), 'Required key "EzsigntemplatesignerResponse[fkiEzsigntemplateID]" is missing from JSON.');
        assert(json[r'fkiEzsigntemplateID'] != null, 'Required key "EzsigntemplatesignerResponse[fkiEzsigntemplateID]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsigntemplatesignerDescription'), 'Required key "EzsigntemplatesignerResponse[sEzsigntemplatesignerDescription]" is missing from JSON.');
        assert(json[r'sEzsigntemplatesignerDescription'] != null, 'Required key "EzsigntemplatesignerResponse[sEzsigntemplatesignerDescription]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<EzsigntemplatesignerResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigntemplatesignerResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigntemplatesignerResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigntemplatesignerResponse> mapFromJson(dynamic json) {
    final map = <String, EzsigntemplatesignerResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplatesignerResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigntemplatesignerResponse-objects as value to a dart map
  static Map<String, List<EzsigntemplatesignerResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigntemplatesignerResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplatesignerResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
