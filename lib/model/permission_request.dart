...
class PermissionRequest {
  ...
  static PermissionRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiModulesectionID'), 'Required key "PermissionRequest[fkiModulesectionID]" is missing from JSON.');
        assert(json[r'fkiModulesectionID'] != null, 'Required key "PermissionRequest[fkiModulesectionID]" has a null value in JSON.');
        return true;
      }());
