...
class CorsResponseCompound {
  ...
  static CorsResponseCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiCorsID'), 'Required key "CorsResponseCompound[pkiCorsID]" is missing from JSON.');
        assert(json[r'pkiCorsID'] != null, 'Required key "CorsResponseCompound[pkiCorsID]" has a null value in JSON.');
        assert(json.containsKey(r'fkiApikeyID'), 'Required key "CorsResponseCompound[fkiApikeyID]" is missing from JSON.');
        assert(json[r'fkiApikeyID'] != null, 'Required key "CorsResponseCompound[fkiApikeyID]" has a null value in JSON.');
        assert(json.containsKey(r'sCorsEntryurl'), 'Required key "CorsResponseCompound[sCorsEntryurl]" is missing from JSON.');
        assert(json[r'sCorsEntryurl'] != null, 'Required key "CorsResponseCompound[sCorsEntryurl]" has a null value in JSON.');
        return true;
      }());
