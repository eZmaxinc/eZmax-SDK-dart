...
class ProvinceGetAutocompleteV2ResponseMPayload {
  ...
  static ProvinceGetAutocompleteV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objProvince'), 'Required key "ProvinceGetAutocompleteV2ResponseMPayload[a_objProvince]" is missing from JSON.');
        assert(json[r'a_objProvince'] != null, 'Required key "ProvinceGetAutocompleteV2ResponseMPayload[a_objProvince]" has a null value in JSON.');
        return true;
      }());
