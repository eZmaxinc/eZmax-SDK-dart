...
class UserCreateObjectV2Request {
  ...
  static UserCreateObjectV2Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objUser'), 'Required key "UserCreateObjectV2Request[a_objUser]" is missing from JSON.');
        assert(json[r'a_objUser'] != null, 'Required key "UserCreateObjectV2Request[a_objUser]" has a null value in JSON.');
        return true;
      }());
