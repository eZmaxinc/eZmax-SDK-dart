...
class BrandingGetObjectV3ResponseMPayload {
  ...
  static BrandingGetObjectV3ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objBranding'), 'Required key "BrandingGetObjectV3ResponseMPayload[objBranding]" is missing from JSON.');
        assert(json[r'objBranding'] != null, 'Required key "BrandingGetObjectV3ResponseMPayload[objBranding]" has a null value in JSON.');
        return true;
      }());
