...
class UserCreateObjectV2ResponseMPayload {
  ...
  static UserCreateObjectV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiUserID'), 'Required key "UserCreateObjectV2ResponseMPayload[a_pkiUserID]" is missing from JSON.');
        assert(json[r'a_pkiUserID'] != null, 'Required key "UserCreateObjectV2ResponseMPayload[a_pkiUserID]" has a null value in JSON.');
        return true;
      }());
