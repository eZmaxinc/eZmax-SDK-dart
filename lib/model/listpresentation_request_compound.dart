...
class ListpresentationRequestCompound {
  /// Returns a new [ListpresentationRequestCompound] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ListpresentationRequestCompound &&
  ...
  @override
  String toString() => 'ListpresentationRequestCompound[sListpresentationDescription=$sListpresentationDescription, sListpresentationFilter=$sListpresentationFilter, sListpresentationOrderby=$sListpresentationOrderby, aSColumnName=$aSColumnName, iListpresentationRowMax=$iListpresentationRowMax, iListpresentationRowOffset=$iListpresentationRowOffset, bListpresentationDefault=$bListpresentationDefault]';
  ...
  /// Returns a new [ListpresentationRequestCompound] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ListpresentationRequestCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ListpresentationRequestCompound[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ListpresentationRequestCompound[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ListpresentationRequestCompound(
  ...
  static List<ListpresentationRequestCompound>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ListpresentationRequestCompound>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ListpresentationRequestCompound.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ListpresentationRequestCompound> mapFromJson(dynamic json) {
    final map = <String, ListpresentationRequestCompound>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ListpresentationRequestCompound.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ListpresentationRequestCompound-objects as value to a dart map
  static Map<String, List<ListpresentationRequestCompound>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ListpresentationRequestCompound>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ListpresentationRequestCompound.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
