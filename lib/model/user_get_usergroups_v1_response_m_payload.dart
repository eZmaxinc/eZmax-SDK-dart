...
class UserGetUsergroupsV1ResponseMPayload {
  ...
  static UserGetUsergroupsV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objUsergroup'), 'Required key "UserGetUsergroupsV1ResponseMPayload[a_objUsergroup]" is missing from JSON.');
        assert(json[r'a_objUsergroup'] != null, 'Required key "UserGetUsergroupsV1ResponseMPayload[a_objUsergroup]" has a null value in JSON.');
        return true;
      }());
