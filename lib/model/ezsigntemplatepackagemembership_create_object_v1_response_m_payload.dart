...
class EzsigntemplatepackagemembershipCreateObjectV1ResponseMPayload {
  ...
  bool operator ==(Object other) => identical(this, other) || other is EzsigntemplatepackagemembershipCreateObjectV1ResponseMPayload &&
    _deepEquality.equals(other.aPkiEzsigntemplatepackagemembershipID, aPkiEzsigntemplatepackagemembershipID) &&
  ...
  static EzsigntemplatepackagemembershipCreateObjectV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiEzsigntemplatepackagemembershipID'), 'Required key "EzsigntemplatepackagemembershipCreateObjectV1ResponseMPayload[a_pkiEzsigntemplatepackagemembershipID]" is missing from JSON.');
        assert(json[r'a_pkiEzsigntemplatepackagemembershipID'] != null, 'Required key "EzsigntemplatepackagemembershipCreateObjectV1ResponseMPayload[a_pkiEzsigntemplatepackagemembershipID]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsigntemplatepackageNeedvalidation'), 'Required key "EzsigntemplatepackagemembershipCreateObjectV1ResponseMPayload[bEzsigntemplatepackageNeedvalidation]" is missing from JSON.');
        assert(json[r'bEzsigntemplatepackageNeedvalidation'] != null, 'Required key "EzsigntemplatepackagemembershipCreateObjectV1ResponseMPayload[bEzsigntemplatepackageNeedvalidation]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsignbulksendNeedvalidation'), 'Required key "EzsigntemplatepackagemembershipCreateObjectV1ResponseMPayload[bEzsignbulksendNeedvalidation]" is missing from JSON.');
        assert(json[r'bEzsignbulksendNeedvalidation'] != null, 'Required key "EzsigntemplatepackagemembershipCreateObjectV1ResponseMPayload[bEzsignbulksendNeedvalidation]" has a null value in JSON.');
        return true;
      }());

      return EzsigntemplatepackagemembershipCreateObjectV1ResponseMPayload(
        aPkiEzsigntemplatepackagemembershipID: json[r'a_pkiEzsigntemplatepackagemembershipID'] is Iterable
            ? (json[r'a_pkiEzsigntemplatepackagemembershipID'] as Iterable).cast<int>().toList(growable: false)
            : const [],
  ...
  static Map<String, List<EzsigntemplatepackagemembershipCreateObjectV1ResponseMPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplatepackagemembershipCreateObjectV1ResponseMPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
