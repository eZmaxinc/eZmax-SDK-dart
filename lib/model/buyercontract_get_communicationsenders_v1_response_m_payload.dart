...
class BuyercontractGetCommunicationsendersV1ResponseMPayload {
  ...
  static BuyercontractGetCommunicationsendersV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objCommunicationsenders'), 'Required key "BuyercontractGetCommunicationsendersV1ResponseMPayload[a_objCommunicationsenders]" is missing from JSON.');
        assert(json[r'a_objCommunicationsenders'] != null, 'Required key "BuyercontractGetCommunicationsendersV1ResponseMPayload[a_objCommunicationsenders]" has a null value in JSON.');
        return true;
      }());
