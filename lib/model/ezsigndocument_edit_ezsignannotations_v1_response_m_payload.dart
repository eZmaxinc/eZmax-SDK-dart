...
class EzsigndocumentEditEzsignannotationsV1ResponseMPayload {
  ...
  static EzsigndocumentEditEzsignannotationsV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiEzsignannotationID'), 'Required key "EzsigndocumentEditEzsignannotationsV1ResponseMPayload[a_pkiEzsignannotationID]" is missing from JSON.');
        assert(json[r'a_pkiEzsignannotationID'] != null, 'Required key "EzsigndocumentEditEzsignannotationsV1ResponseMPayload[a_pkiEzsignannotationID]" has a null value in JSON.');
        return true;
      }());
