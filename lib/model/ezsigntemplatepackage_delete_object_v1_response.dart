...
class EzsigntemplatepackageDeleteObjectV1Response {
  ...
  static EzsigntemplatepackageDeleteObjectV1Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "EzsigntemplatepackageDeleteObjectV1Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "EzsigntemplatepackageDeleteObjectV1Response[objDebugPayload]" has a null value in JSON.');
        return true;
      }());
