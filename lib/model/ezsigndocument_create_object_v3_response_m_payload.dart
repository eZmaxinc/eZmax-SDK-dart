...
class EzsigndocumentCreateObjectV3ResponseMPayload {
  ...
  static EzsigndocumentCreateObjectV3ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsigndocument'), 'Required key "EzsigndocumentCreateObjectV3ResponseMPayload[a_objEzsigndocument]" is missing from JSON.');
        assert(json[r'a_objEzsigndocument'] != null, 'Required key "EzsigndocumentCreateObjectV3ResponseMPayload[a_objEzsigndocument]" has a null value in JSON.');
        return true;
      }());
