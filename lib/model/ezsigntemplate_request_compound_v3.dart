...
class EzsigntemplateRequestCompoundV3 {
  /// Returns a new [EzsigntemplateRequestCompoundV3] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsigntemplateRequestCompoundV3 &&
  ...
  /// Returns a new [EzsigntemplateRequestCompoundV3] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsigntemplateRequestCompoundV3? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiLanguageID'), 'Required key "EzsigntemplateRequestCompoundV3[fkiLanguageID]" is missing from JSON.');
        assert(json[r'fkiLanguageID'] != null, 'Required key "EzsigntemplateRequestCompoundV3[fkiLanguageID]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsigntemplateDescription'), 'Required key "EzsigntemplateRequestCompoundV3[sEzsigntemplateDescription]" is missing from JSON.');
        assert(json[r'sEzsigntemplateDescription'] != null, 'Required key "EzsigntemplateRequestCompoundV3[sEzsigntemplateDescription]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsigntemplateAdminonly'), 'Required key "EzsigntemplateRequestCompoundV3[bEzsigntemplateAdminonly]" is missing from JSON.');
        assert(json[r'bEzsigntemplateAdminonly'] != null, 'Required key "EzsigntemplateRequestCompoundV3[bEzsigntemplateAdminonly]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsigntemplateType'), 'Required key "EzsigntemplateRequestCompoundV3[eEzsigntemplateType]" is missing from JSON.');
        assert(json[r'eEzsigntemplateType'] != null, 'Required key "EzsigntemplateRequestCompoundV3[eEzsigntemplateType]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<EzsigntemplateRequestCompoundV3> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigntemplateRequestCompoundV3>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigntemplateRequestCompoundV3.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigntemplateRequestCompoundV3> mapFromJson(dynamic json) {
    final map = <String, EzsigntemplateRequestCompoundV3>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplateRequestCompoundV3.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigntemplateRequestCompoundV3-objects as value to a dart map
  static Map<String, List<EzsigntemplateRequestCompoundV3>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigntemplateRequestCompoundV3>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplateRequestCompoundV3.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
