...
class EzsigntemplatepublicResetUrlV1ResponseMPayload {
  ...
  static EzsigntemplatepublicResetUrlV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'sEzsigntemplatepublicUrl'), 'Required key "EzsigntemplatepublicResetUrlV1ResponseMPayload[sEzsigntemplatepublicUrl]" is missing from JSON.');
        assert(json[r'sEzsigntemplatepublicUrl'] != null, 'Required key "EzsigntemplatepublicResetUrlV1ResponseMPayload[sEzsigntemplatepublicUrl]" has a null value in JSON.');
        return true;
      }());
