...
class EzsigntemplatesignaturecustomdateRequestV2 {
  /// Returns a new [EzsigntemplatesignaturecustomdateRequestV2] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsigntemplatesignaturecustomdateRequestV2 &&
  ...
  /// Returns a new [EzsigntemplatesignaturecustomdateRequestV2] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsigntemplatesignaturecustomdateRequestV2? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'iEzsigntemplatesignaturecustomdateOffsetx'), 'Required key "EzsigntemplatesignaturecustomdateRequestV2[iEzsigntemplatesignaturecustomdateOffsetx]" is missing from JSON.');
        assert(json[r'iEzsigntemplatesignaturecustomdateOffsetx'] != null, 'Required key "EzsigntemplatesignaturecustomdateRequestV2[iEzsigntemplatesignaturecustomdateOffsetx]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsigntemplatesignaturecustomdateOffsety'), 'Required key "EzsigntemplatesignaturecustomdateRequestV2[iEzsigntemplatesignaturecustomdateOffsety]" is missing from JSON.');
        assert(json[r'iEzsigntemplatesignaturecustomdateOffsety'] != null, 'Required key "EzsigntemplatesignaturecustomdateRequestV2[iEzsigntemplatesignaturecustomdateOffsety]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsigntemplatesignaturecustomdateFormat'), 'Required key "EzsigntemplatesignaturecustomdateRequestV2[sEzsigntemplatesignaturecustomdateFormat]" is missing from JSON.');
        assert(json[r'sEzsigntemplatesignaturecustomdateFormat'] != null, 'Required key "EzsigntemplatesignaturecustomdateRequestV2[sEzsigntemplatesignaturecustomdateFormat]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<EzsigntemplatesignaturecustomdateRequestV2> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigntemplatesignaturecustomdateRequestV2>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigntemplatesignaturecustomdateRequestV2.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigntemplatesignaturecustomdateRequestV2> mapFromJson(dynamic json) {
    final map = <String, EzsigntemplatesignaturecustomdateRequestV2>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplatesignaturecustomdateRequestV2.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigntemplatesignaturecustomdateRequestV2-objects as value to a dart map
  static Map<String, List<EzsigntemplatesignaturecustomdateRequestV2>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigntemplatesignaturecustomdateRequestV2>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplatesignaturecustomdateRequestV2.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
