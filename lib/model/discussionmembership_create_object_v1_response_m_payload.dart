...
class DiscussionmembershipCreateObjectV1ResponseMPayload {
  ...
  static DiscussionmembershipCreateObjectV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiDiscussionmembershipID'), 'Required key "DiscussionmembershipCreateObjectV1ResponseMPayload[a_pkiDiscussionmembershipID]" is missing from JSON.');
        assert(json[r'a_pkiDiscussionmembershipID'] != null, 'Required key "DiscussionmembershipCreateObjectV1ResponseMPayload[a_pkiDiscussionmembershipID]" has a null value in JSON.');
        return true;
      }());
