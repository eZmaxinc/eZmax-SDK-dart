  ...
  static List<FieldESystemconfigurationEzsignofficeplan> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FieldESystemconfigurationEzsignofficeplan.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [FieldESystemconfigurationEzsignofficeplan] to String,
/// and [decode] dynamic data back to [FieldESystemconfigurationEzsignofficeplan].
class FieldESystemconfigurationEzsignofficeplanTypeTransformer {
  factory FieldESystemconfigurationEzsignofficeplanTypeTransformer() => _instance ??= const FieldESystemconfigurationEzsignofficeplanTypeTransformer._();
  ...
  FieldESystemconfigurationEzsignofficeplan? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'Pro': return FieldESystemconfigurationEzsignofficeplan.pro;
        default:
          if (!allowNull) {
