...
class BrandingRequestV2 {
  ...
  /// Returns a new [BrandingRequestV2] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static BrandingRequestV2? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<BrandingRequestV2> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <BrandingRequestV2>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = BrandingRequestV2.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, BrandingRequestV2> mapFromJson(dynamic json) {
    final map = <String, BrandingRequestV2>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = BrandingRequestV2.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of BrandingRequestV2-objects as value to a dart map
  static Map<String, List<BrandingRequestV2>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<BrandingRequestV2>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = BrandingRequestV2.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
