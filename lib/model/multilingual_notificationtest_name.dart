...
class MultilingualNotificationtestName {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (sNotificationtestName1 != null) {
      _json[r'sNotificationtestName1'] = sNotificationtestName1;
    } else {
      _json[r'sNotificationtestName1'] = null;
    }
    if (sNotificationtestName2 != null) {
      _json[r'sNotificationtestName2'] = sNotificationtestName2;
    } else {
      _json[r'sNotificationtestName2'] = null;
    }
    return _json;
  }
  ...
  static Map<String, List<MultilingualNotificationtestName>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MultilingualNotificationtestName.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
