...
class EzsignsignergroupGetEzsignsignergroupmembershipsV1Response {
  ...
  @override
  String toString() => 'EzsignsignergroupGetEzsignsignergroupmembershipsV1Response[objDebugPayload=$objDebugPayload, objDebug=$objDebug, mPayload=$mPayload]';
  ...
  static EzsignsignergroupGetEzsignsignergroupmembershipsV1Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "EzsignsignergroupGetEzsignsignergroupmembershipsV1Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "EzsignsignergroupGetEzsignsignergroupmembershipsV1Response[objDebugPayload]" has a null value in JSON.');
        assert(json.containsKey(r'mPayload'), 'Required key "EzsignsignergroupGetEzsignsignergroupmembershipsV1Response[mPayload]" is missing from JSON.');
        assert(json[r'mPayload'] != null, 'Required key "EzsignsignergroupGetEzsignsignergroupmembershipsV1Response[mPayload]" has a null value in JSON.');
        return true;
      }());
