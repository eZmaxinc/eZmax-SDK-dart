...
class BillingentityexternalGenerateFederationTokenV1Request {
  ...
  static BillingentityexternalGenerateFederationTokenV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fksEzmaxcustomerCode'), 'Required key "BillingentityexternalGenerateFederationTokenV1Request[fksEzmaxcustomerCode]" is missing from JSON.');
        assert(json[r'fksEzmaxcustomerCode'] != null, 'Required key "BillingentityexternalGenerateFederationTokenV1Request[fksEzmaxcustomerCode]" has a null value in JSON.');
        return true;
      }());
