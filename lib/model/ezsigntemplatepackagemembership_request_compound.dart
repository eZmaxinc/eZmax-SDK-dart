...
class EzsigntemplatepackagemembershipRequestCompound {
  ...
  static EzsigntemplatepackagemembershipRequestCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiEzsigntemplatepackageID'), 'Required key "EzsigntemplatepackagemembershipRequestCompound[fkiEzsigntemplatepackageID]" is missing from JSON.');
        assert(json[r'fkiEzsigntemplatepackageID'] != null, 'Required key "EzsigntemplatepackagemembershipRequestCompound[fkiEzsigntemplatepackageID]" has a null value in JSON.');
        assert(json.containsKey(r'fkiEzsigntemplateID'), 'Required key "EzsigntemplatepackagemembershipRequestCompound[fkiEzsigntemplateID]" is missing from JSON.');
        assert(json[r'fkiEzsigntemplateID'] != null, 'Required key "EzsigntemplatepackagemembershipRequestCompound[fkiEzsigntemplateID]" has a null value in JSON.');
        return true;
      }());
