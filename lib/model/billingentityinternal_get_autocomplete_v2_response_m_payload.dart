...
class BillingentityinternalGetAutocompleteV2ResponseMPayload {
  ...
  static BillingentityinternalGetAutocompleteV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objBillingentityinternal'), 'Required key "BillingentityinternalGetAutocompleteV2ResponseMPayload[a_objBillingentityinternal]" is missing from JSON.');
        assert(json[r'a_objBillingentityinternal'] != null, 'Required key "BillingentityinternalGetAutocompleteV2ResponseMPayload[a_objBillingentityinternal]" has a null value in JSON.');
        return true;
      }());
