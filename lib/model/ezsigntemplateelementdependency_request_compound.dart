...
class EzsigntemplateelementdependencyRequestCompound {
  /// Returns a new [EzsigntemplateelementdependencyRequestCompound] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsigntemplateelementdependencyRequestCompound &&
  ...
  /// Returns a new [EzsigntemplateelementdependencyRequestCompound] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsigntemplateelementdependencyRequestCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'eEzsigntemplateelementdependencyValidation'), 'Required key "EzsigntemplateelementdependencyRequestCompound[eEzsigntemplateelementdependencyValidation]" is missing from JSON.');
        assert(json[r'eEzsigntemplateelementdependencyValidation'] != null, 'Required key "EzsigntemplateelementdependencyRequestCompound[eEzsigntemplateelementdependencyValidation]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<EzsigntemplateelementdependencyRequestCompound> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigntemplateelementdependencyRequestCompound>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigntemplateelementdependencyRequestCompound.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigntemplateelementdependencyRequestCompound> mapFromJson(dynamic json) {
    final map = <String, EzsigntemplateelementdependencyRequestCompound>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplateelementdependencyRequestCompound.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigntemplateelementdependencyRequestCompound-objects as value to a dart map
  static Map<String, List<EzsigntemplateelementdependencyRequestCompound>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigntemplateelementdependencyRequestCompound>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplateelementdependencyRequestCompound.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
