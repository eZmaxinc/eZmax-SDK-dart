...
class EzsignfoldertypeRequestV4 {
  /// Returns a new [EzsignfoldertypeRequestV4] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsignfoldertypeRequestV4 &&
  ...
  /// Returns a new [EzsignfoldertypeRequestV4] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsignfoldertypeRequestV4? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objEzsignfoldertypeName'), 'Required key "EzsignfoldertypeRequestV4[objEzsignfoldertypeName]" is missing from JSON.');
        assert(json[r'objEzsignfoldertypeName'] != null, 'Required key "EzsignfoldertypeRequestV4[objEzsignfoldertypeName]" has a null value in JSON.');
        assert(json.containsKey(r'fkiBrandingID'), 'Required key "EzsignfoldertypeRequestV4[fkiBrandingID]" is missing from JSON.');
        assert(json[r'fkiBrandingID'] != null, 'Required key "EzsignfoldertypeRequestV4[fkiBrandingID]" has a null value in JSON.');
        assert(json.containsKey(r'a_fkiUserlogintypeID'), 'Required key "EzsignfoldertypeRequestV4[a_fkiUserlogintypeID]" is missing from JSON.');
        assert(json[r'a_fkiUserlogintypeID'] != null, 'Required key "EzsignfoldertypeRequestV4[a_fkiUserlogintypeID]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsignfoldertypeSignaturedatedisplay'), 'Required key "EzsignfoldertypeRequestV4[eEzsignfoldertypeSignaturedatedisplay]" is missing from JSON.');
        assert(json[r'eEzsignfoldertypeSignaturedatedisplay'] != null, 'Required key "EzsignfoldertypeRequestV4[eEzsignfoldertypeSignaturedatedisplay]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsignfoldertypePrivacylevel'), 'Required key "EzsignfoldertypeRequestV4[eEzsignfoldertypePrivacylevel]" is missing from JSON.');
        assert(json[r'eEzsignfoldertypePrivacylevel'] != null, 'Required key "EzsignfoldertypeRequestV4[eEzsignfoldertypePrivacylevel]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsignfoldertypeArchivaldays'), 'Required key "EzsignfoldertypeRequestV4[iEzsignfoldertypeArchivaldays]" is missing from JSON.');
        assert(json[r'iEzsignfoldertypeArchivaldays'] != null, 'Required key "EzsignfoldertypeRequestV4[iEzsignfoldertypeArchivaldays]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsignfoldertypeDisposal'), 'Required key "EzsignfoldertypeRequestV4[eEzsignfoldertypeDisposal]" is missing from JSON.');
        assert(json[r'eEzsignfoldertypeDisposal'] != null, 'Required key "EzsignfoldertypeRequestV4[eEzsignfoldertypeDisposal]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsignfoldertypeCompletion'), 'Required key "EzsignfoldertypeRequestV4[eEzsignfoldertypeCompletion]" is missing from JSON.');
        assert(json[r'eEzsignfoldertypeCompletion'] != null, 'Required key "EzsignfoldertypeRequestV4[eEzsignfoldertypeCompletion]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsignfoldertypeDeadlinedays'), 'Required key "EzsignfoldertypeRequestV4[iEzsignfoldertypeDeadlinedays]" is missing from JSON.');
        assert(json[r'iEzsignfoldertypeDeadlinedays'] != null, 'Required key "EzsignfoldertypeRequestV4[iEzsignfoldertypeDeadlinedays]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsignfoldertypeSendsignedtodocumentowner'), 'Required key "EzsignfoldertypeRequestV4[bEzsignfoldertypeSendsignedtodocumentowner]" is missing from JSON.');
        assert(json[r'bEzsignfoldertypeSendsignedtodocumentowner'] != null, 'Required key "EzsignfoldertypeRequestV4[bEzsignfoldertypeSendsignedtodocumentowner]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsignfoldertypeSendsignedtofolderowner'), 'Required key "EzsignfoldertypeRequestV4[bEzsignfoldertypeSendsignedtofolderowner]" is missing from JSON.');
        assert(json[r'bEzsignfoldertypeSendsignedtofolderowner'] != null, 'Required key "EzsignfoldertypeRequestV4[bEzsignfoldertypeSendsignedtofolderowner]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsignfoldertypeSendsignedtocolleague'), 'Required key "EzsignfoldertypeRequestV4[bEzsignfoldertypeSendsignedtocolleague]" is missing from JSON.');
        assert(json[r'bEzsignfoldertypeSendsignedtocolleague'] != null, 'Required key "EzsignfoldertypeRequestV4[bEzsignfoldertypeSendsignedtocolleague]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsignfoldertypeSendsummarytodocumentowner'), 'Required key "EzsignfoldertypeRequestV4[bEzsignfoldertypeSendsummarytodocumentowner]" is missing from JSON.');
        assert(json[r'bEzsignfoldertypeSendsummarytodocumentowner'] != null, 'Required key "EzsignfoldertypeRequestV4[bEzsignfoldertypeSendsummarytodocumentowner]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsignfoldertypeSendsummarytofolderowner'), 'Required key "EzsignfoldertypeRequestV4[bEzsignfoldertypeSendsummarytofolderowner]" is missing from JSON.');
        assert(json[r'bEzsignfoldertypeSendsummarytofolderowner'] != null, 'Required key "EzsignfoldertypeRequestV4[bEzsignfoldertypeSendsummarytofolderowner]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsignfoldertypeSendsummarytocolleague'), 'Required key "EzsignfoldertypeRequestV4[bEzsignfoldertypeSendsummarytocolleague]" is missing from JSON.');
        assert(json[r'bEzsignfoldertypeSendsummarytocolleague'] != null, 'Required key "EzsignfoldertypeRequestV4[bEzsignfoldertypeSendsummarytocolleague]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsignfoldertypeIsactive'), 'Required key "EzsignfoldertypeRequestV4[bEzsignfoldertypeIsactive]" is missing from JSON.');
        assert(json[r'bEzsignfoldertypeIsactive'] != null, 'Required key "EzsignfoldertypeRequestV4[bEzsignfoldertypeIsactive]" has a null value in JSON.');
        return true;
      }());

      return EzsignfoldertypeRequestV4(
  ...
  static List<EzsignfoldertypeRequestV4> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsignfoldertypeRequestV4>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsignfoldertypeRequestV4.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsignfoldertypeRequestV4> mapFromJson(dynamic json) {
    final map = <String, EzsignfoldertypeRequestV4>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsignfoldertypeRequestV4.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsignfoldertypeRequestV4-objects as value to a dart map
  static Map<String, List<EzsignfoldertypeRequestV4>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsignfoldertypeRequestV4>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsignfoldertypeRequestV4.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
