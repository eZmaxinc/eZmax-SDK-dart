...
class ModuleGetAutocompleteV2ResponseMPayload {
  ...
  static ModuleGetAutocompleteV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objModule'), 'Required key "ModuleGetAutocompleteV2ResponseMPayload[a_objModule]" is missing from JSON.');
        assert(json[r'a_objModule'] != null, 'Required key "ModuleGetAutocompleteV2ResponseMPayload[a_objModule]" has a null value in JSON.');
        return true;
      }());
