...
class ActivesessionGetListV1ResponseMPayload {
  ...
  static ActivesessionGetListV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'iRowReturned'), 'Required key "ActivesessionGetListV1ResponseMPayload[iRowReturned]" is missing from JSON.');
        assert(json[r'iRowReturned'] != null, 'Required key "ActivesessionGetListV1ResponseMPayload[iRowReturned]" has a null value in JSON.');
        assert(json.containsKey(r'iRowFiltered'), 'Required key "ActivesessionGetListV1ResponseMPayload[iRowFiltered]" is missing from JSON.');
        assert(json[r'iRowFiltered'] != null, 'Required key "ActivesessionGetListV1ResponseMPayload[iRowFiltered]" has a null value in JSON.');
        assert(json.containsKey(r'a_objActivesession'), 'Required key "ActivesessionGetListV1ResponseMPayload[a_objActivesession]" is missing from JSON.');
        assert(json[r'a_objActivesession'] != null, 'Required key "ActivesessionGetListV1ResponseMPayload[a_objActivesession]" has a null value in JSON.');
        return true;
      }());
