...
class EzsignfolderResponseV3 {
  /// Returns a new [EzsignfolderResponseV3] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsignfolderResponseV3 &&
  ...
  /// Returns a new [EzsignfolderResponseV3] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsignfolderResponseV3? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsignfolderID'), 'Required key "EzsignfolderResponseV3[pkiEzsignfolderID]" is missing from JSON.');
        assert(json[r'pkiEzsignfolderID'] != null, 'Required key "EzsignfolderResponseV3[pkiEzsignfolderID]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsignfolderCompletion'), 'Required key "EzsignfolderResponseV3[eEzsignfolderCompletion]" is missing from JSON.');
        assert(json[r'eEzsignfolderCompletion'] != null, 'Required key "EzsignfolderResponseV3[eEzsignfolderCompletion]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsignfolderDescription'), 'Required key "EzsignfolderResponseV3[sEzsignfolderDescription]" is missing from JSON.');
        assert(json[r'sEzsignfolderDescription'] != null, 'Required key "EzsignfolderResponseV3[sEzsignfolderDescription]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<EzsignfolderResponseV3> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsignfolderResponseV3>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsignfolderResponseV3.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsignfolderResponseV3> mapFromJson(dynamic json) {
    final map = <String, EzsignfolderResponseV3>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsignfolderResponseV3.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsignfolderResponseV3-objects as value to a dart map
  static Map<String, List<EzsignfolderResponseV3>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsignfolderResponseV3>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsignfolderResponseV3.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
