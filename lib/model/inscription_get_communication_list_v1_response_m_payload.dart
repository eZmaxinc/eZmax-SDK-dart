...
class InscriptionGetCommunicationListV1ResponseMPayload {
  ...
  static InscriptionGetCommunicationListV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objCommunication'), 'Required key "InscriptionGetCommunicationListV1ResponseMPayload[a_objCommunication]" is missing from JSON.');
        assert(json[r'a_objCommunication'] != null, 'Required key "InscriptionGetCommunicationListV1ResponseMPayload[a_objCommunication]" has a null value in JSON.');
        return true;
      }());
