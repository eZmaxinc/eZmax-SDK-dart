...
class ApikeyEditObjectV1Request {
  ...
  static ApikeyEditObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objApikey'), 'Required key "ApikeyEditObjectV1Request[objApikey]" is missing from JSON.');
        assert(json[r'objApikey'] != null, 'Required key "ApikeyEditObjectV1Request[objApikey]" has a null value in JSON.');
        return true;
      }());
