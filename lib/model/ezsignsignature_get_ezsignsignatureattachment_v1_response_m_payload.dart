...
class EzsignsignatureGetEzsignsignatureattachmentV1ResponseMPayload {
  ...
  static EzsignsignatureGetEzsignsignatureattachmentV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsignsignatureattachment'), 'Required key "EzsignsignatureGetEzsignsignatureattachmentV1ResponseMPayload[a_objEzsignsignatureattachment]" is missing from JSON.');
        assert(json[r'a_objEzsignsignatureattachment'] != null, 'Required key "EzsignsignatureGetEzsignsignatureattachmentV1ResponseMPayload[a_objEzsignsignatureattachment]" has a null value in JSON.');
        return true;
      }());
