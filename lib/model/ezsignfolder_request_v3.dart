...
class EzsignfolderRequestV3 {
  /// Returns a new [EzsignfolderRequestV3] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsignfolderRequestV3 &&
  ...
  @override
  String toString() => 'EzsignfolderRequestV3[pkiEzsignfolderID=$pkiEzsignfolderID, fkiEzsignfoldertypeID=$fkiEzsignfoldertypeID, fkiTimezoneID=$fkiTimezoneID, fkiEzsigntsarequirementID=$fkiEzsigntsarequirementID, eEzsignfolderDocumentdependency=$eEzsignfolderDocumentdependency, sEzsignfolderDescription=$sEzsignfolderDescription, tEzsignfolderNote=$tEzsignfolderNote, tEzsignfolderMessage=$tEzsignfolderMessage, iEzsignfolderSendreminderfirstdays=$iEzsignfolderSendreminderfirstdays, iEzsignfolderSendreminderotherdays=$iEzsignfolderSendreminderotherdays, sEzsignfolderExternalid=$sEzsignfolderExternalid]';
  ...
  /// Returns a new [EzsignfolderRequestV3] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsignfolderRequestV3? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<EzsignfolderRequestV3> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsignfolderRequestV3>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsignfolderRequestV3.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsignfolderRequestV3> mapFromJson(dynamic json) {
    final map = <String, EzsignfolderRequestV3>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsignfolderRequestV3.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsignfolderRequestV3-objects as value to a dart map
  static Map<String, List<EzsignfolderRequestV3>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsignfolderRequestV3>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsignfolderRequestV3.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
