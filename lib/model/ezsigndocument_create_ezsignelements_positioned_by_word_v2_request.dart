    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EzsigndocumentCreateEzsignelementsPositionedByWordV2Request[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EzsigndocumentCreateEzsignelementsPositionedByWordV2Request[$key]" has a null value in JSON.');
        });
        return true;
      }());
