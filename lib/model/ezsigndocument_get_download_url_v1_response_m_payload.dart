...
class EzsigndocumentGetDownloadUrlV1ResponseMPayload {
  ...
  static EzsigndocumentGetDownloadUrlV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'sDownloadUrl'), 'Required key "EzsigndocumentGetDownloadUrlV1ResponseMPayload[sDownloadUrl]" is missing from JSON.');
        assert(json[r'sDownloadUrl'] != null, 'Required key "EzsigndocumentGetDownloadUrlV1ResponseMPayload[sDownloadUrl]" has a null value in JSON.');
        return true;
      }());
