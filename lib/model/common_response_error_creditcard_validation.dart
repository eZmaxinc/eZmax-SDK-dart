...
class CommonResponseErrorCreditcardValidation {
  ...
  static CommonResponseErrorCreditcardValidation? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'sErrorMessage'), 'Required key "CommonResponseErrorCreditcardValidation[sErrorMessage]" is missing from JSON.');
        assert(json[r'sErrorMessage'] != null, 'Required key "CommonResponseErrorCreditcardValidation[sErrorMessage]" has a null value in JSON.');
        assert(json.containsKey(r'eErrorCode'), 'Required key "CommonResponseErrorCreditcardValidation[eErrorCode]" is missing from JSON.');
        assert(json[r'eErrorCode'] != null, 'Required key "CommonResponseErrorCreditcardValidation[eErrorCode]" has a null value in JSON.');
        return true;
      }());
