...
class EzsignsignergroupEditEzsignsignergroupmembershipsV1ResponseMPayload {
  ...
  static EzsignsignergroupEditEzsignsignergroupmembershipsV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiEzsignsignergroupmembershipID'), 'Required key "EzsignsignergroupEditEzsignsignergroupmembershipsV1ResponseMPayload[a_pkiEzsignsignergroupmembershipID]" is missing from JSON.');
        assert(json[r'a_pkiEzsignsignergroupmembershipID'] != null, 'Required key "EzsignsignergroupEditEzsignsignergroupmembershipsV1ResponseMPayload[a_pkiEzsignsignergroupmembershipID]" has a null value in JSON.');
        return true;
      }());
