...
class UsergroupexternalCreateObjectV1Request {
  ...
  static UsergroupexternalCreateObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objUsergroupexternal'), 'Required key "UsergroupexternalCreateObjectV1Request[a_objUsergroupexternal]" is missing from JSON.');
        assert(json[r'a_objUsergroupexternal'] != null, 'Required key "UsergroupexternalCreateObjectV1Request[a_objUsergroupexternal]" has a null value in JSON.');
        return true;
      }());
