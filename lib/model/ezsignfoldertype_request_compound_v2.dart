...
class EzsignfoldertypeRequestCompoundV2 {
  /// Returns a new [EzsignfoldertypeRequestCompoundV2] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsignfoldertypeRequestCompoundV2 &&
  ...
  /// Returns a new [EzsignfoldertypeRequestCompoundV2] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsignfoldertypeRequestCompoundV2? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EzsignfoldertypeRequestCompoundV2[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EzsignfoldertypeRequestCompoundV2[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<EzsignfoldertypeRequestCompoundV2> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsignfoldertypeRequestCompoundV2>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsignfoldertypeRequestCompoundV2.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsignfoldertypeRequestCompoundV2> mapFromJson(dynamic json) {
    final map = <String, EzsignfoldertypeRequestCompoundV2>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsignfoldertypeRequestCompoundV2.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsignfoldertypeRequestCompoundV2-objects as value to a dart map
  static Map<String, List<EzsignfoldertypeRequestCompoundV2>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsignfoldertypeRequestCompoundV2>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsignfoldertypeRequestCompoundV2.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
