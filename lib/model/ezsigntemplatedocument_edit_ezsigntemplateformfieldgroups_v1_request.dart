...
class EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1Request {
  ...
  static EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsigntemplateformfieldgroup'), 'Required key "EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1Request[a_objEzsigntemplateformfieldgroup]" is missing from JSON.');
        assert(json[r'a_objEzsigntemplateformfieldgroup'] != null, 'Required key "EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1Request[a_objEzsigntemplateformfieldgroup]" has a null value in JSON.');
        return true;
      }());
  ...
  static Map<String, List<EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1Request>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1Request.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
