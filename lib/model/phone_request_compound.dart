...
class PhoneRequestCompound {
  ...
  static PhoneRequestCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiPhonetypeID'), 'Required key "PhoneRequestCompound[fkiPhonetypeID]" is missing from JSON.');
        assert(json[r'fkiPhonetypeID'] != null, 'Required key "PhoneRequestCompound[fkiPhonetypeID]" has a null value in JSON.');
        return true;
      }());
