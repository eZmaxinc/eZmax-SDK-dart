...
class VariableexpenseGetListV1ResponseMPayload {
  ...
  static VariableexpenseGetListV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'iRowReturned'), 'Required key "VariableexpenseGetListV1ResponseMPayload[iRowReturned]" is missing from JSON.');
        assert(json[r'iRowReturned'] != null, 'Required key "VariableexpenseGetListV1ResponseMPayload[iRowReturned]" has a null value in JSON.');
        assert(json.containsKey(r'iRowFiltered'), 'Required key "VariableexpenseGetListV1ResponseMPayload[iRowFiltered]" is missing from JSON.');
        assert(json[r'iRowFiltered'] != null, 'Required key "VariableexpenseGetListV1ResponseMPayload[iRowFiltered]" has a null value in JSON.');
        assert(json.containsKey(r'a_objVariableexpense'), 'Required key "VariableexpenseGetListV1ResponseMPayload[a_objVariableexpense]" is missing from JSON.');
        assert(json[r'a_objVariableexpense'] != null, 'Required key "VariableexpenseGetListV1ResponseMPayload[a_objVariableexpense]" has a null value in JSON.');
        return true;
      }());
