...
class EzsigndocumentEditObjectV1Request {
  ...
  static EzsigndocumentEditObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objEzsigndocument'), 'Required key "EzsigndocumentEditObjectV1Request[objEzsigndocument]" is missing from JSON.');
        assert(json[r'objEzsigndocument'] != null, 'Required key "EzsigndocumentEditObjectV1Request[objEzsigndocument]" has a null value in JSON.');
        return true;
      }());
