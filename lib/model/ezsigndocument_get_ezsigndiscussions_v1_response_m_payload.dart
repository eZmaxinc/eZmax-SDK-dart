...
class EzsigndocumentGetEzsigndiscussionsV1ResponseMPayload {
  ...
  static EzsigndocumentGetEzsigndiscussionsV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsigndiscussion'), 'Required key "EzsigndocumentGetEzsigndiscussionsV1ResponseMPayload[a_objEzsigndiscussion]" is missing from JSON.');
        assert(json[r'a_objEzsigndiscussion'] != null, 'Required key "EzsigndocumentGetEzsigndiscussionsV1ResponseMPayload[a_objEzsigndiscussion]" has a null value in JSON.');
        return true;
      }());
