...
class UserEditObjectV1Request {
  ...
  static UserEditObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objUser'), 'Required key "UserEditObjectV1Request[objUser]" is missing from JSON.');
        assert(json[r'objUser'] != null, 'Required key "UserEditObjectV1Request[objUser]" has a null value in JSON.');
        return true;
      }());
