...
class EzsigntemplatesignatureRequestCompoundV2 {
  /// Returns a new [EzsigntemplatesignatureRequestCompoundV2] instance.
  ...
  List<EzsigntemplatesignaturecustomdateRequestCompoundV2> aObjEzsigntemplatesignaturecustomdate;

  List<EzsigntemplateelementdependencyRequestCompound> aObjEzsigntemplateelementdependency;

  List<EzsigntemplatesignaturepaymentdetailRequestCompound> aObjEzsigntemplatesignaturepaymentdetail;

  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsigntemplatesignatureRequestCompoundV2 &&
  ...
  /// Returns a new [EzsigntemplatesignatureRequestCompoundV2] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsigntemplatesignatureRequestCompoundV2? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiEzsigntemplatedocumentID'), 'Required key "EzsigntemplatesignatureRequestCompoundV2[fkiEzsigntemplatedocumentID]" is missing from JSON.');
        assert(json[r'fkiEzsigntemplatedocumentID'] != null, 'Required key "EzsigntemplatesignatureRequestCompoundV2[fkiEzsigntemplatedocumentID]" has a null value in JSON.');
        assert(json.containsKey(r'fkiEzsigntemplatesignerID'), 'Required key "EzsigntemplatesignatureRequestCompoundV2[fkiEzsigntemplatesignerID]" is missing from JSON.');
        assert(json[r'fkiEzsigntemplatesignerID'] != null, 'Required key "EzsigntemplatesignatureRequestCompoundV2[fkiEzsigntemplatesignerID]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsigntemplatedocumentpagePagenumber'), 'Required key "EzsigntemplatesignatureRequestCompoundV2[iEzsigntemplatedocumentpagePagenumber]" is missing from JSON.');
        assert(json[r'iEzsigntemplatedocumentpagePagenumber'] != null, 'Required key "EzsigntemplatesignatureRequestCompoundV2[iEzsigntemplatedocumentpagePagenumber]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsigntemplatesignatureStep'), 'Required key "EzsigntemplatesignatureRequestCompoundV2[iEzsigntemplatesignatureStep]" is missing from JSON.');
        assert(json[r'iEzsigntemplatesignatureStep'] != null, 'Required key "EzsigntemplatesignatureRequestCompoundV2[iEzsigntemplatesignatureStep]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsigntemplatesignatureType'), 'Required key "EzsigntemplatesignatureRequestCompoundV2[eEzsigntemplatesignatureType]" is missing from JSON.');
        assert(json[r'eEzsigntemplatesignatureType'] != null, 'Required key "EzsigntemplatesignatureRequestCompoundV2[eEzsigntemplatesignatureType]" has a null value in JSON.');
        return true;
      }());
      ...
      return EzsigntemplatesignatureRequestCompoundV2(
        ...
        aObjEzsigntemplatesignaturecustomdate: EzsigntemplatesignaturecustomdateRequestCompoundV2.listFromJson(json[r'a_objEzsigntemplatesignaturecustomdate']),
        ...
        aObjEzsigntemplatesignaturepaymentdetail: EzsigntemplatesignaturepaymentdetailRequestCompound.listFromJson(json[r'a_objEzsigntemplatesignaturepaymentdetail']),
      );
    }
    return null;
  }

  static List<EzsigntemplatesignatureRequestCompoundV2> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigntemplatesignatureRequestCompoundV2>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigntemplatesignatureRequestCompoundV2.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigntemplatesignatureRequestCompoundV2> mapFromJson(dynamic json) {
    final map = <String, EzsigntemplatesignatureRequestCompoundV2>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplatesignatureRequestCompoundV2.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigntemplatesignatureRequestCompoundV2-objects as value to a dart map
  static Map<String, List<EzsigntemplatesignatureRequestCompoundV2>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigntemplatesignatureRequestCompoundV2>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplatesignatureRequestCompoundV2.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
