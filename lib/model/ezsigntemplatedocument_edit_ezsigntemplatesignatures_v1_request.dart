...
class EzsigntemplatedocumentEditEzsigntemplatesignaturesV1Request {
  ...
  static EzsigntemplatedocumentEditEzsigntemplatesignaturesV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsigntemplatesignature'), 'Required key "EzsigntemplatedocumentEditEzsigntemplatesignaturesV1Request[a_objEzsigntemplatesignature]" is missing from JSON.');
        assert(json[r'a_objEzsigntemplatesignature'] != null, 'Required key "EzsigntemplatedocumentEditEzsigntemplatesignaturesV1Request[a_objEzsigntemplatesignature]" has a null value in JSON.');
        return true;
      }());
