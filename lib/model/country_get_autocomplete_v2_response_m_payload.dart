...
class CountryGetAutocompleteV2ResponseMPayload {
  ...
  static CountryGetAutocompleteV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objCountry'), 'Required key "CountryGetAutocompleteV2ResponseMPayload[a_objCountry]" is missing from JSON.');
        assert(json[r'a_objCountry'] != null, 'Required key "CountryGetAutocompleteV2ResponseMPayload[a_objCountry]" has a null value in JSON.');
        return true;
      }());
