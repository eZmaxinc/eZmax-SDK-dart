...
class FieldEEzsigntemplateformfieldPositioning {
  ...
  const FieldEEzsigntemplateformfieldPositioning._(this.value);
  ...
  static const perCoordinates = FieldEEzsigntemplateformfieldPositioning._(r'PerCoordinates');
  static const perPositioningPattern = FieldEEzsigntemplateformfieldPositioning._(r'PerPositioningPattern');

  /// List of all possible values in this [enum][FieldEEzsigntemplateformfieldPositioning].
  static const values = <FieldEEzsigntemplateformfieldPositioning>[
    perCoordinates,
...
class FieldEEzsigntemplateformfieldPositioningTypeTransformer {
  ...
  String encode(FieldEEzsigntemplateformfieldPositioning data) => data.value;

  /// Decodes a [dynamic value][data] to a FieldEEzsigntemplateformfieldPositioning.
  ///
  ...
  /// Singleton [FieldEEzsigntemplateformfieldPositioningTypeTransformer] instance.
