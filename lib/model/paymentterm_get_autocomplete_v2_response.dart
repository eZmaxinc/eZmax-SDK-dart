...
class PaymenttermGetAutocompleteV2Response {
  ...
  @override
  String toString() => 'PaymenttermGetAutocompleteV2Response[objDebugPayload=$objDebugPayload, objDebug=$objDebug, mPayload=$mPayload]';
  ...
  static PaymenttermGetAutocompleteV2Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "PaymenttermGetAutocompleteV2Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "PaymenttermGetAutocompleteV2Response[objDebugPayload]" has a null value in JSON.');
        assert(json.containsKey(r'mPayload'), 'Required key "PaymenttermGetAutocompleteV2Response[mPayload]" is missing from JSON.');
        assert(json[r'mPayload'] != null, 'Required key "PaymenttermGetAutocompleteV2Response[mPayload]" has a null value in JSON.');
        return true;
      }());
