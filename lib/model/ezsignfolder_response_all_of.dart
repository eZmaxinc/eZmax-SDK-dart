...
class EzsignfolderResponseAllOf {
  /// Returns a new [EzsignfolderResponseAllOf] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsignfolderResponseAllOf &&
  ...
  @override
  String toString() => 'EzsignfolderResponseAllOf[fkiEzsignfoldertypeID=$fkiEzsignfoldertypeID, fkiEzsigntsarequirementID=$fkiEzsigntsarequirementID, sEzsignfolderDescription=$sEzsignfolderDescription, tEzsignfolderNote=$tEzsignfolderNote, eEzsignfolderSendreminderfrequency=$eEzsignfolderSendreminderfrequency, pkiEzsignfolderID=$pkiEzsignfolderID, dtEzsignfolderSentdate=$dtEzsignfolderSentdate, eEzsignfolderStep=$eEzsignfolderStep, dtEzsignfolderClose=$dtEzsignfolderClose, objAudit=$objAudit]';
  ...
  /// Returns a new [EzsignfolderResponseAllOf] instance and imports its values from
  /// [json] if it's non-null, null if [json] is null.
  static EzsignfolderResponseAllOf fromJson(Map<String, dynamic> json) => json == null
    ? null
    : EzsignfolderResponseAllOf(
  ...
  static List<EzsignfolderResponseAllOf> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <EzsignfolderResponseAllOf>[]
      : json.map((v) => EzsignfolderResponseAllOf.fromJson(v)).toList(growable: true == growable);

  static Map<String, EzsignfolderResponseAllOf> mapFromJson(Map<String, dynamic> json) {
    final map = <String, EzsignfolderResponseAllOf>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = EzsignfolderResponseAllOf.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of EzsignfolderResponseAllOf-objects as value to a dart map
  static Map<String, List<EzsignfolderResponseAllOf>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<EzsignfolderResponseAllOf>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = EzsignfolderResponseAllOf.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
