...
class EzsigntemplatesignerResponseV3 {
  /// Returns a new [EzsigntemplatesignerResponseV3] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsigntemplatesignerResponseV3 &&
  ...
  @override
  String toString() => 'EzsigntemplatesignerResponseV3[pkiEzsigntemplatesignerID=$pkiEzsigntemplatesignerID, fkiEzsigntemplateID=$fkiEzsigntemplateID, fkiUserID=$fkiUserID, fkiUsergroupID=$fkiUsergroupID, fkiEzdoctemplatedocumentID=$fkiEzdoctemplatedocumentID, eEzsigntemplatesignerRole=$eEzsigntemplatesignerRole, eEzsigntemplatesignerMapping=$eEzsigntemplatesignerMapping, sEzsigntemplatesignerDescription=$sEzsigntemplatesignerDescription, sUserName=$sUserName, sUsergroupNameX=$sUsergroupNameX]';
  ...
  /// Returns a new [EzsigntemplatesignerResponseV3] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsigntemplatesignerResponseV3? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsigntemplatesignerID'), 'Required key "EzsigntemplatesignerResponseV3[pkiEzsigntemplatesignerID]" is missing from JSON.');
        assert(json[r'pkiEzsigntemplatesignerID'] != null, 'Required key "EzsigntemplatesignerResponseV3[pkiEzsigntemplatesignerID]" has a null value in JSON.');
        assert(json.containsKey(r'fkiEzsigntemplateID'), 'Required key "EzsigntemplatesignerResponseV3[fkiEzsigntemplateID]" is missing from JSON.');
        assert(json[r'fkiEzsigntemplateID'] != null, 'Required key "EzsigntemplatesignerResponseV3[fkiEzsigntemplateID]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsigntemplatesignerDescription'), 'Required key "EzsigntemplatesignerResponseV3[sEzsigntemplatesignerDescription]" is missing from JSON.');
        assert(json[r'sEzsigntemplatesignerDescription'] != null, 'Required key "EzsigntemplatesignerResponseV3[sEzsigntemplatesignerDescription]" has a null value in JSON.');
        return true;
      }());

      return EzsigntemplatesignerResponseV3(
  ...
  static List<EzsigntemplatesignerResponseV3> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigntemplatesignerResponseV3>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigntemplatesignerResponseV3.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigntemplatesignerResponseV3> mapFromJson(dynamic json) {
    final map = <String, EzsigntemplatesignerResponseV3>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplatesignerResponseV3.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigntemplatesignerResponseV3-objects as value to a dart map
  static Map<String, List<EzsigntemplatesignerResponseV3>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigntemplatesignerResponseV3>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplatesignerResponseV3.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
