...
class EzdoctemplatefieldtypecategoryGetAutocompleteV2ResponseMPayload {
  ...
  static EzdoctemplatefieldtypecategoryGetAutocompleteV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzdoctemplatefieldtypecategory'), 'Required key "EzdoctemplatefieldtypecategoryGetAutocompleteV2ResponseMPayload[a_objEzdoctemplatefieldtypecategory]" is missing from JSON.');
        assert(json[r'a_objEzdoctemplatefieldtypecategory'] != null, 'Required key "EzdoctemplatefieldtypecategoryGetAutocompleteV2ResponseMPayload[a_objEzdoctemplatefieldtypecategory]" has a null value in JSON.');
        return true;
      }());
