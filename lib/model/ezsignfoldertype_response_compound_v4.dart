...
class EzsignfoldertypeResponseCompoundV4 {
  ...
  static EzsignfoldertypeResponseCompoundV4? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsignfoldertypeID'), 'Required key "EzsignfoldertypeResponseCompoundV4[pkiEzsignfoldertypeID]" is missing from JSON.');
        assert(json[r'pkiEzsignfoldertypeID'] != null, 'Required key "EzsignfoldertypeResponseCompoundV4[pkiEzsignfoldertypeID]" has a null value in JSON.');
        assert(json.containsKey(r'objEzsignfoldertypeName'), 'Required key "EzsignfoldertypeResponseCompoundV4[objEzsignfoldertypeName]" is missing from JSON.');
        assert(json[r'objEzsignfoldertypeName'] != null, 'Required key "EzsignfoldertypeResponseCompoundV4[objEzsignfoldertypeName]" has a null value in JSON.');
        assert(json.containsKey(r'fkiBrandingID'), 'Required key "EzsignfoldertypeResponseCompoundV4[fkiBrandingID]" is missing from JSON.');
        assert(json[r'fkiBrandingID'] != null, 'Required key "EzsignfoldertypeResponseCompoundV4[fkiBrandingID]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsignfoldertypeSignaturedatedisplay'), 'Required key "EzsignfoldertypeResponseCompoundV4[eEzsignfoldertypeSignaturedatedisplay]" is missing from JSON.');
        assert(json[r'eEzsignfoldertypeSignaturedatedisplay'] != null, 'Required key "EzsignfoldertypeResponseCompoundV4[eEzsignfoldertypeSignaturedatedisplay]" has a null value in JSON.');
        assert(json.containsKey(r'sBrandingDescriptionX'), 'Required key "EzsignfoldertypeResponseCompoundV4[sBrandingDescriptionX]" is missing from JSON.');
        assert(json[r'sBrandingDescriptionX'] != null, 'Required key "EzsignfoldertypeResponseCompoundV4[sBrandingDescriptionX]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsignfoldertypePrivacylevel'), 'Required key "EzsignfoldertypeResponseCompoundV4[eEzsignfoldertypePrivacylevel]" is missing from JSON.');
        assert(json[r'eEzsignfoldertypePrivacylevel'] != null, 'Required key "EzsignfoldertypeResponseCompoundV4[eEzsignfoldertypePrivacylevel]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsignfoldertypeArchivaldays'), 'Required key "EzsignfoldertypeResponseCompoundV4[iEzsignfoldertypeArchivaldays]" is missing from JSON.');
        assert(json[r'iEzsignfoldertypeArchivaldays'] != null, 'Required key "EzsignfoldertypeResponseCompoundV4[iEzsignfoldertypeArchivaldays]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsignfoldertypeDisposal'), 'Required key "EzsignfoldertypeResponseCompoundV4[eEzsignfoldertypeDisposal]" is missing from JSON.');
        assert(json[r'eEzsignfoldertypeDisposal'] != null, 'Required key "EzsignfoldertypeResponseCompoundV4[eEzsignfoldertypeDisposal]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsignfoldertypeCompletion'), 'Required key "EzsignfoldertypeResponseCompoundV4[eEzsignfoldertypeCompletion]" is missing from JSON.');
        assert(json[r'eEzsignfoldertypeCompletion'] != null, 'Required key "EzsignfoldertypeResponseCompoundV4[eEzsignfoldertypeCompletion]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsignfoldertypeDeadlinedays'), 'Required key "EzsignfoldertypeResponseCompoundV4[iEzsignfoldertypeDeadlinedays]" is missing from JSON.');
        assert(json[r'iEzsignfoldertypeDeadlinedays'] != null, 'Required key "EzsignfoldertypeResponseCompoundV4[iEzsignfoldertypeDeadlinedays]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsignfoldertypeSendsignedtodocumentowner'), 'Required key "EzsignfoldertypeResponseCompoundV4[bEzsignfoldertypeSendsignedtodocumentowner]" is missing from JSON.');
        assert(json[r'bEzsignfoldertypeSendsignedtodocumentowner'] != null, 'Required key "EzsignfoldertypeResponseCompoundV4[bEzsignfoldertypeSendsignedtodocumentowner]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsignfoldertypeSendsignedtofolderowner'), 'Required key "EzsignfoldertypeResponseCompoundV4[bEzsignfoldertypeSendsignedtofolderowner]" is missing from JSON.');
        assert(json[r'bEzsignfoldertypeSendsignedtofolderowner'] != null, 'Required key "EzsignfoldertypeResponseCompoundV4[bEzsignfoldertypeSendsignedtofolderowner]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsignfoldertypeSendsignedtocolleague'), 'Required key "EzsignfoldertypeResponseCompoundV4[bEzsignfoldertypeSendsignedtocolleague]" is missing from JSON.');
        assert(json[r'bEzsignfoldertypeSendsignedtocolleague'] != null, 'Required key "EzsignfoldertypeResponseCompoundV4[bEzsignfoldertypeSendsignedtocolleague]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsignfoldertypeSendsummarytodocumentowner'), 'Required key "EzsignfoldertypeResponseCompoundV4[bEzsignfoldertypeSendsummarytodocumentowner]" is missing from JSON.');
        assert(json[r'bEzsignfoldertypeSendsummarytodocumentowner'] != null, 'Required key "EzsignfoldertypeResponseCompoundV4[bEzsignfoldertypeSendsummarytodocumentowner]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsignfoldertypeSendsummarytofolderowner'), 'Required key "EzsignfoldertypeResponseCompoundV4[bEzsignfoldertypeSendsummarytofolderowner]" is missing from JSON.');
        assert(json[r'bEzsignfoldertypeSendsummarytofolderowner'] != null, 'Required key "EzsignfoldertypeResponseCompoundV4[bEzsignfoldertypeSendsummarytofolderowner]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsignfoldertypeSendsummarytocolleague'), 'Required key "EzsignfoldertypeResponseCompoundV4[bEzsignfoldertypeSendsummarytocolleague]" is missing from JSON.');
        assert(json[r'bEzsignfoldertypeSendsummarytocolleague'] != null, 'Required key "EzsignfoldertypeResponseCompoundV4[bEzsignfoldertypeSendsummarytocolleague]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsignfoldertypeIsactive'), 'Required key "EzsignfoldertypeResponseCompoundV4[bEzsignfoldertypeIsactive]" is missing from JSON.');
        assert(json[r'bEzsignfoldertypeIsactive'] != null, 'Required key "EzsignfoldertypeResponseCompoundV4[bEzsignfoldertypeIsactive]" has a null value in JSON.');
        assert(json.containsKey(r'a_objUserlogintype'), 'Required key "EzsignfoldertypeResponseCompoundV4[a_objUserlogintype]" is missing from JSON.');
        assert(json[r'a_objUserlogintype'] != null, 'Required key "EzsignfoldertypeResponseCompoundV4[a_objUserlogintype]" has a null value in JSON.');
        assert(json.containsKey(r'objAudit'), 'Required key "EzsignfoldertypeResponseCompoundV4[objAudit]" is missing from JSON.');
        assert(json[r'objAudit'] != null, 'Required key "EzsignfoldertypeResponseCompoundV4[objAudit]" has a null value in JSON.');
        return true;
      }());
