...
class UsergroupmembershipRequestCompound {
  ...
  static UsergroupmembershipRequestCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiUsergroupID'), 'Required key "UsergroupmembershipRequestCompound[fkiUsergroupID]" is missing from JSON.');
        assert(json[r'fkiUsergroupID'] != null, 'Required key "UsergroupmembershipRequestCompound[fkiUsergroupID]" has a null value in JSON.');
        return true;
      }());
