...
class WebhookEzsignDocumentCompletedAllOf {
  ...
  static WebhookEzsignDocumentCompletedAllOf? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "WebhookEzsignDocumentCompletedAllOf[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "WebhookEzsignDocumentCompletedAllOf[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return WebhookEzsignDocumentCompletedAllOf(
  ...
  static List<WebhookEzsignDocumentCompletedAllOf> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <WebhookEzsignDocumentCompletedAllOf>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = WebhookEzsignDocumentCompletedAllOf.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, WebhookEzsignDocumentCompletedAllOf> mapFromJson(dynamic json) {
    final map = <String, WebhookEzsignDocumentCompletedAllOf>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = WebhookEzsignDocumentCompletedAllOf.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<WebhookEzsignDocumentCompletedAllOf>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<WebhookEzsignDocumentCompletedAllOf>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = WebhookEzsignDocumentCompletedAllOf.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
