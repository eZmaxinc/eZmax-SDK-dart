...
class WebhookEzsignDocumentCompletedAllOf {
  ...
  static List<WebhookEzsignDocumentCompletedAllOf> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(WebhookEzsignDocumentCompletedAllOf.fromJson).toList(growable: true == growable)
  ...
  static Map<String, WebhookEzsignDocumentCompletedAllOf> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = WebhookEzsignDocumentCompletedAllOf.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of WebhookEzsignDocumentCompletedAllOf-objects as value to a dart map
  static Map<String, List<WebhookEzsignDocumentCompletedAllOf>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<WebhookEzsignDocumentCompletedAllOf>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = WebhookEzsignDocumentCompletedAllOf.listFromJson(
            value,
