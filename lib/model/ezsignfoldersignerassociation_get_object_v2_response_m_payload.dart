...
class EzsignfoldersignerassociationGetObjectV2ResponseMPayload {
  ...
  static EzsignfoldersignerassociationGetObjectV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objEzsignfoldersignerassociation'), 'Required key "EzsignfoldersignerassociationGetObjectV2ResponseMPayload[objEzsignfoldersignerassociation]" is missing from JSON.');
        assert(json[r'objEzsignfoldersignerassociation'] != null, 'Required key "EzsignfoldersignerassociationGetObjectV2ResponseMPayload[objEzsignfoldersignerassociation]" has a null value in JSON.');
        return true;
      }());
