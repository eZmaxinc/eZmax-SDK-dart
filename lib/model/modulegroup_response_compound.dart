...
class ModulegroupResponseCompound {
  ...
  static ModulegroupResponseCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiModulegroupID'), 'Required key "ModulegroupResponseCompound[pkiModulegroupID]" is missing from JSON.');
        assert(json[r'pkiModulegroupID'] != null, 'Required key "ModulegroupResponseCompound[pkiModulegroupID]" has a null value in JSON.');
        assert(json.containsKey(r'sModulegroupNameX'), 'Required key "ModulegroupResponseCompound[sModulegroupNameX]" is missing from JSON.');
        assert(json[r'sModulegroupNameX'] != null, 'Required key "ModulegroupResponseCompound[sModulegroupNameX]" has a null value in JSON.');
        return true;
      }());
