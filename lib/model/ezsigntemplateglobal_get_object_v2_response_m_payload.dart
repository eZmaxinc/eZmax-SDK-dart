...
class EzsigntemplateglobalGetObjectV2ResponseMPayload {
  ...
  static EzsigntemplateglobalGetObjectV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objEzsigntemplateglobal'), 'Required key "EzsigntemplateglobalGetObjectV2ResponseMPayload[objEzsigntemplateglobal]" is missing from JSON.');
        assert(json[r'objEzsigntemplateglobal'] != null, 'Required key "EzsigntemplateglobalGetObjectV2ResponseMPayload[objEzsigntemplateglobal]" has a null value in JSON.');
        return true;
      }());
