...
class EzsignfolderGetAttachmentCountV1ResponseMPayload {
  ...
  static EzsignfolderGetAttachmentCountV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'iAttachmentCount'), 'Required key "EzsignfolderGetAttachmentCountV1ResponseMPayload[iAttachmentCount]" is missing from JSON.');
        assert(json[r'iAttachmentCount'] != null, 'Required key "EzsignfolderGetAttachmentCountV1ResponseMPayload[iAttachmentCount]" has a null value in JSON.');
        return true;
      }());
