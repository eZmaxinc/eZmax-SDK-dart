...
class WebhookheaderRequest {
  ...
  static WebhookheaderRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'sWebhookheaderName'), 'Required key "WebhookheaderRequest[sWebhookheaderName]" is missing from JSON.');
        assert(json[r'sWebhookheaderName'] != null, 'Required key "WebhookheaderRequest[sWebhookheaderName]" has a null value in JSON.');
        assert(json.containsKey(r'sWebhookheaderValue'), 'Required key "WebhookheaderRequest[sWebhookheaderValue]" is missing from JSON.');
        assert(json[r'sWebhookheaderValue'] != null, 'Required key "WebhookheaderRequest[sWebhookheaderValue]" has a null value in JSON.');
        return true;
      }());
