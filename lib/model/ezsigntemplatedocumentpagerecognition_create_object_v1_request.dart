...
class EzsigntemplatedocumentpagerecognitionCreateObjectV1Request {
  ...
  static EzsigntemplatedocumentpagerecognitionCreateObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsigntemplatedocumentpagerecognition'), 'Required key "EzsigntemplatedocumentpagerecognitionCreateObjectV1Request[a_objEzsigntemplatedocumentpagerecognition]" is missing from JSON.');
        assert(json[r'a_objEzsigntemplatedocumentpagerecognition'] != null, 'Required key "EzsigntemplatedocumentpagerecognitionCreateObjectV1Request[a_objEzsigntemplatedocumentpagerecognition]" has a null value in JSON.');
        return true;
      }());
