...
class WebhookEzsignEzsignsignerAcceptclause {
  ...
  static WebhookEzsignEzsignsignerAcceptclause? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objWebhook'), 'Required key "WebhookEzsignEzsignsignerAcceptclause[objWebhook]" is missing from JSON.');
        assert(json[r'objWebhook'] != null, 'Required key "WebhookEzsignEzsignsignerAcceptclause[objWebhook]" has a null value in JSON.');
        assert(json.containsKey(r'a_objAttempt'), 'Required key "WebhookEzsignEzsignsignerAcceptclause[a_objAttempt]" is missing from JSON.');
        assert(json[r'a_objAttempt'] != null, 'Required key "WebhookEzsignEzsignsignerAcceptclause[a_objAttempt]" has a null value in JSON.');
        assert(json.containsKey(r'objEzsignfoldersignerassociation'), 'Required key "WebhookEzsignEzsignsignerAcceptclause[objEzsignfoldersignerassociation]" is missing from JSON.');
        assert(json[r'objEzsignfoldersignerassociation'] != null, 'Required key "WebhookEzsignEzsignsignerAcceptclause[objEzsignfoldersignerassociation]" has a null value in JSON.');
        return true;
      }());
