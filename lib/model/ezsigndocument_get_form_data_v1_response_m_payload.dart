...
class EzsigndocumentGetFormDataV1ResponseMPayload {
  ...
  static EzsigndocumentGetFormDataV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objFormDataDocument'), 'Required key "EzsigndocumentGetFormDataV1ResponseMPayload[objFormDataDocument]" is missing from JSON.');
        assert(json[r'objFormDataDocument'] != null, 'Required key "EzsigndocumentGetFormDataV1ResponseMPayload[objFormDataDocument]" has a null value in JSON.');
        return true;
      }());
  ...
  static Map<String, List<EzsigndocumentGetFormDataV1ResponseMPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsigndocumentGetFormDataV1ResponseMPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
