...
class AuthenticationexternalGetAutocompleteV2ResponseMPayload {
  ...
  static AuthenticationexternalGetAutocompleteV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objAuthenticationexternal'), 'Required key "AuthenticationexternalGetAutocompleteV2ResponseMPayload[a_objAuthenticationexternal]" is missing from JSON.');
        assert(json[r'a_objAuthenticationexternal'] != null, 'Required key "AuthenticationexternalGetAutocompleteV2ResponseMPayload[a_objAuthenticationexternal]" has a null value in JSON.');
        return true;
      }());
