...
class EzsigntemplatesignerRequest {
  ...
  @override
  String toString() => 'EzsigntemplatesignerRequest[pkiEzsigntemplatesignerID=$pkiEzsigntemplatesignerID, fkiEzsigntemplateID=$fkiEzsigntemplateID, fkiUserID=$fkiUserID, fkiUsergroupID=$fkiUsergroupID, fkiEzdoctemplatedocumentID=$fkiEzdoctemplatedocumentID, bEzsigntemplatesignerReceivecopy=$bEzsigntemplatesignerReceivecopy, eEzsigntemplatesignerMapping=$eEzsigntemplatesignerMapping, sEzsigntemplatesignerDescription=$sEzsigntemplatesignerDescription]';
  ...
  static EzsigntemplatesignerRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiEzsigntemplateID'), 'Required key "EzsigntemplatesignerRequest[fkiEzsigntemplateID]" is missing from JSON.');
        assert(json[r'fkiEzsigntemplateID'] != null, 'Required key "EzsigntemplatesignerRequest[fkiEzsigntemplateID]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsigntemplatesignerDescription'), 'Required key "EzsigntemplatesignerRequest[sEzsigntemplatesignerDescription]" is missing from JSON.');
        assert(json[r'sEzsigntemplatesignerDescription'] != null, 'Required key "EzsigntemplatesignerRequest[sEzsigntemplatesignerDescription]" has a null value in JSON.');
        return true;
      }());
  ...
  static Map<String, List<EzsigntemplatesignerRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplatesignerRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
