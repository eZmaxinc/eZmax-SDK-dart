...
class EzsigntemplatesignaturecustomdateResponseV2 {
  /// Returns a new [EzsigntemplatesignaturecustomdateResponseV2] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsigntemplatesignaturecustomdateResponseV2 &&
  ...
  @override
  String toString() => 'EzsigntemplatesignaturecustomdateResponseV2[pkiEzsigntemplatesignaturecustomdateID=$pkiEzsigntemplatesignaturecustomdateID, iEzsigntemplatesignaturecustomdateOffsetx=$iEzsigntemplatesignaturecustomdateOffsetx, iEzsigntemplatesignaturecustomdateOffsety=$iEzsigntemplatesignaturecustomdateOffsety, sEzsigntemplatesignaturecustomdateFormat=$sEzsigntemplatesignaturecustomdateFormat]';
  ...
  /// Returns a new [EzsigntemplatesignaturecustomdateResponseV2] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsigntemplatesignaturecustomdateResponseV2? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsigntemplatesignaturecustomdateID'), 'Required key "EzsigntemplatesignaturecustomdateResponseV2[pkiEzsigntemplatesignaturecustomdateID]" is missing from JSON.');
        assert(json[r'pkiEzsigntemplatesignaturecustomdateID'] != null, 'Required key "EzsigntemplatesignaturecustomdateResponseV2[pkiEzsigntemplatesignaturecustomdateID]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsigntemplatesignaturecustomdateOffsetx'), 'Required key "EzsigntemplatesignaturecustomdateResponseV2[iEzsigntemplatesignaturecustomdateOffsetx]" is missing from JSON.');
        assert(json[r'iEzsigntemplatesignaturecustomdateOffsetx'] != null, 'Required key "EzsigntemplatesignaturecustomdateResponseV2[iEzsigntemplatesignaturecustomdateOffsetx]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsigntemplatesignaturecustomdateOffsety'), 'Required key "EzsigntemplatesignaturecustomdateResponseV2[iEzsigntemplatesignaturecustomdateOffsety]" is missing from JSON.');
        assert(json[r'iEzsigntemplatesignaturecustomdateOffsety'] != null, 'Required key "EzsigntemplatesignaturecustomdateResponseV2[iEzsigntemplatesignaturecustomdateOffsety]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsigntemplatesignaturecustomdateFormat'), 'Required key "EzsigntemplatesignaturecustomdateResponseV2[sEzsigntemplatesignaturecustomdateFormat]" is missing from JSON.');
        assert(json[r'sEzsigntemplatesignaturecustomdateFormat'] != null, 'Required key "EzsigntemplatesignaturecustomdateResponseV2[sEzsigntemplatesignaturecustomdateFormat]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<EzsigntemplatesignaturecustomdateResponseV2> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigntemplatesignaturecustomdateResponseV2>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigntemplatesignaturecustomdateResponseV2.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigntemplatesignaturecustomdateResponseV2> mapFromJson(dynamic json) {
    final map = <String, EzsigntemplatesignaturecustomdateResponseV2>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplatesignaturecustomdateResponseV2.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigntemplatesignaturecustomdateResponseV2-objects as value to a dart map
  static Map<String, List<EzsigntemplatesignaturecustomdateResponseV2>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigntemplatesignaturecustomdateResponseV2>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplatesignaturecustomdateResponseV2.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
