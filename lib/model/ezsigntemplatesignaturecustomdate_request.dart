...
class EzsigntemplatesignaturecustomdateRequest {
  /// Returns a new [EzsigntemplatesignaturecustomdateRequest] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsigntemplatesignaturecustomdateRequest &&
  ...
  /// Returns a new [EzsigntemplatesignaturecustomdateRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsigntemplatesignaturecustomdateRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'sEzsigntemplatesignaturecustomdateFormat'), 'Required key "EzsigntemplatesignaturecustomdateRequest[sEzsigntemplatesignaturecustomdateFormat]" is missing from JSON.');
        assert(json[r'sEzsigntemplatesignaturecustomdateFormat'] != null, 'Required key "EzsigntemplatesignaturecustomdateRequest[sEzsigntemplatesignaturecustomdateFormat]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<EzsigntemplatesignaturecustomdateRequest> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigntemplatesignaturecustomdateRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigntemplatesignaturecustomdateRequest> mapFromJson(dynamic json) {
    final map = <String, EzsigntemplatesignaturecustomdateRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplatesignaturecustomdateRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigntemplatesignaturecustomdateRequest-objects as value to a dart map
