...
class CreditcardclientAutocompleteElementResponse {
  ...
  static CreditcardclientAutocompleteElementResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiCreditcardclientID'), 'Required key "CreditcardclientAutocompleteElementResponse[pkiCreditcardclientID]" is missing from JSON.');
        assert(json[r'pkiCreditcardclientID'] != null, 'Required key "CreditcardclientAutocompleteElementResponse[pkiCreditcardclientID]" has a null value in JSON.');
        assert(json.containsKey(r'sCreditcardclientDescription'), 'Required key "CreditcardclientAutocompleteElementResponse[sCreditcardclientDescription]" is missing from JSON.');
        assert(json[r'sCreditcardclientDescription'] != null, 'Required key "CreditcardclientAutocompleteElementResponse[sCreditcardclientDescription]" has a null value in JSON.');
        return true;
      }());
