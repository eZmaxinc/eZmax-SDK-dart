...
class EzsigntemplatedocumentCreateObjectV1ResponseMPayload {
  ...
  bool operator ==(Object other) => identical(this, other) || other is EzsigntemplatedocumentCreateObjectV1ResponseMPayload &&
    _deepEquality.equals(other.aPkiEzsigntemplatedocumentID, aPkiEzsigntemplatedocumentID);
  ...
  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'a_pkiEzsigntemplatedocumentID'] = this.aPkiEzsigntemplatedocumentID;
    return json;
  }
  ...
  static EzsigntemplatedocumentCreateObjectV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiEzsigntemplatedocumentID'), 'Required key "EzsigntemplatedocumentCreateObjectV1ResponseMPayload[a_pkiEzsigntemplatedocumentID]" is missing from JSON.');
        assert(json[r'a_pkiEzsigntemplatedocumentID'] != null, 'Required key "EzsigntemplatedocumentCreateObjectV1ResponseMPayload[a_pkiEzsigntemplatedocumentID]" has a null value in JSON.');
        return true;
      }());

      return EzsigntemplatedocumentCreateObjectV1ResponseMPayload(
        aPkiEzsigntemplatedocumentID: json[r'a_pkiEzsigntemplatedocumentID'] is Iterable
            ? (json[r'a_pkiEzsigntemplatedocumentID'] as Iterable).cast<int>().toList(growable: false)
            : const [],
      );
    }
    return null;
  ...
  static Map<String, List<EzsigntemplatedocumentCreateObjectV1ResponseMPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplatedocumentCreateObjectV1ResponseMPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
