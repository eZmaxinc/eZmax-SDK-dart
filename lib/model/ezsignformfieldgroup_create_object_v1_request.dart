...
class EzsignformfieldgroupCreateObjectV1Request {
  ...
  static EzsignformfieldgroupCreateObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsignformfieldgroup'), 'Required key "EzsignformfieldgroupCreateObjectV1Request[a_objEzsignformfieldgroup]" is missing from JSON.');
        assert(json[r'a_objEzsignformfieldgroup'] != null, 'Required key "EzsignformfieldgroupCreateObjectV1Request[a_objEzsignformfieldgroup]" has a null value in JSON.');
        return true;
      }());
