...
class EzsignfolderReorderV2Request {
  ...
  static EzsignfolderReorderV2Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsigndocument'), 'Required key "EzsignfolderReorderV2Request[a_objEzsigndocument]" is missing from JSON.');
        assert(json[r'a_objEzsigndocument'] != null, 'Required key "EzsignfolderReorderV2Request[a_objEzsigndocument]" has a null value in JSON.');
        return true;
      }());
