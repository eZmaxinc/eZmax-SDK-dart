...
class SupplyRequestCompound {
  /// Returns a new [SupplyRequestCompound] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SupplyRequestCompound &&
  ...
  /// Returns a new [SupplyRequestCompound] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SupplyRequestCompound? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<SupplyRequestCompound> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SupplyRequestCompound>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SupplyRequestCompound.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SupplyRequestCompound> mapFromJson(dynamic json) {
    final map = <String, SupplyRequestCompound>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SupplyRequestCompound.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SupplyRequestCompound-objects as value to a dart map
  static Map<String, List<SupplyRequestCompound>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SupplyRequestCompound>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SupplyRequestCompound.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
