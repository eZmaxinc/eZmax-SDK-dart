...
class ApikeyGetSubnetsV1ResponseMPayload {
  ...
  static ApikeyGetSubnetsV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objSubnet'), 'Required key "ApikeyGetSubnetsV1ResponseMPayload[a_objSubnet]" is missing from JSON.');
        assert(json[r'a_objSubnet'] != null, 'Required key "ApikeyGetSubnetsV1ResponseMPayload[a_objSubnet]" has a null value in JSON.');
        return true;
      }());
