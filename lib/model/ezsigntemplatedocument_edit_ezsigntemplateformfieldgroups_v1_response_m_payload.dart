...
class EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1ResponseMPayload {
  ...
  static EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiEzsigntemplateformfieldgroupID'), 'Required key "EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1ResponseMPayload[a_pkiEzsigntemplateformfieldgroupID]" is missing from JSON.');
        assert(json[r'a_pkiEzsigntemplateformfieldgroupID'] != null, 'Required key "EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1ResponseMPayload[a_pkiEzsigntemplateformfieldgroupID]" has a null value in JSON.');
        return true;
      }());
  ...
  static Map<String, List<EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1ResponseMPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1ResponseMPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
