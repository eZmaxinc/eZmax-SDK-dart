...
class UserGetListV1ResponseMPayload {
  ...
  static UserGetListV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'iRowReturned'), 'Required key "UserGetListV1ResponseMPayload[iRowReturned]" is missing from JSON.');
        assert(json[r'iRowReturned'] != null, 'Required key "UserGetListV1ResponseMPayload[iRowReturned]" has a null value in JSON.');
        assert(json.containsKey(r'iRowFiltered'), 'Required key "UserGetListV1ResponseMPayload[iRowFiltered]" is missing from JSON.');
        assert(json[r'iRowFiltered'] != null, 'Required key "UserGetListV1ResponseMPayload[iRowFiltered]" has a null value in JSON.');
        assert(json.containsKey(r'a_objUser'), 'Required key "UserGetListV1ResponseMPayload[a_objUser]" is missing from JSON.');
        assert(json[r'a_objUser'] != null, 'Required key "UserGetListV1ResponseMPayload[a_objUser]" has a null value in JSON.');
        return true;
      }());
