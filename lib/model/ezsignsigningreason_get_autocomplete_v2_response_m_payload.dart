...
class EzsignsigningreasonGetAutocompleteV2ResponseMPayload {
  ...
  static EzsignsigningreasonGetAutocompleteV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsignsigningreason'), 'Required key "EzsignsigningreasonGetAutocompleteV2ResponseMPayload[a_objEzsignsigningreason]" is missing from JSON.');
        assert(json[r'a_objEzsignsigningreason'] != null, 'Required key "EzsignsigningreasonGetAutocompleteV2ResponseMPayload[a_objEzsignsigningreason]" has a null value in JSON.');
        return true;
      }());
