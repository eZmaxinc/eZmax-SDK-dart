...
class EzsigntemplateCopyV1ResponseMPayload {
  ...
  static EzsigntemplateCopyV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiEzsigntemplateID'), 'Required key "EzsigntemplateCopyV1ResponseMPayload[a_pkiEzsigntemplateID]" is missing from JSON.');
        assert(json[r'a_pkiEzsigntemplateID'] != null, 'Required key "EzsigntemplateCopyV1ResponseMPayload[a_pkiEzsigntemplateID]" has a null value in JSON.');
        return true;
      }());
  ...
  static Map<String, List<EzsigntemplateCopyV1ResponseMPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplateCopyV1ResponseMPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
