...
class EzsignfolderGetObjectV1ResponseMPayload {
  ...
  static EzsignfolderGetObjectV1ResponseMPayload fromJson(Map<String, dynamic> json) => json == null
    ? null
    : EzsignfolderGetObjectV1ResponseMPayload(
  ...
  static List<EzsignfolderGetObjectV1ResponseMPayload> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <EzsignfolderGetObjectV1ResponseMPayload>[]
      : json.map((v) => EzsignfolderGetObjectV1ResponseMPayload.fromJson(v)).toList(growable: true == growable);

  static Map<String, EzsignfolderGetObjectV1ResponseMPayload> mapFromJson(Map<String, dynamic> json) {
    final map = <String, EzsignfolderGetObjectV1ResponseMPayload>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = EzsignfolderGetObjectV1ResponseMPayload.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of EzsignfolderGetObjectV1ResponseMPayload-objects as value to a dart map
  static Map<String, List<EzsignfolderGetObjectV1ResponseMPayload>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<EzsignfolderGetObjectV1ResponseMPayload>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = EzsignfolderGetObjectV1ResponseMPayload.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
