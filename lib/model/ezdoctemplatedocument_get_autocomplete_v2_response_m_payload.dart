...
class EzdoctemplatedocumentGetAutocompleteV2ResponseMPayload {
  ...
  static EzdoctemplatedocumentGetAutocompleteV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzdoctemplatedocument'), 'Required key "EzdoctemplatedocumentGetAutocompleteV2ResponseMPayload[a_objEzdoctemplatedocument]" is missing from JSON.');
        assert(json[r'a_objEzdoctemplatedocument'] != null, 'Required key "EzdoctemplatedocumentGetAutocompleteV2ResponseMPayload[a_objEzdoctemplatedocument]" has a null value in JSON.');
        return true;
      }());
