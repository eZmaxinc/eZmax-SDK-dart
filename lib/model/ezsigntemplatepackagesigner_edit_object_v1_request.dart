...
class EzsigntemplatepackagesignerEditObjectV1Request {
  ...
  static EzsigntemplatepackagesignerEditObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objEzsigntemplatepackagesigner'), 'Required key "EzsigntemplatepackagesignerEditObjectV1Request[objEzsigntemplatepackagesigner]" is missing from JSON.');
        assert(json[r'objEzsigntemplatepackagesigner'] != null, 'Required key "EzsigntemplatepackagesignerEditObjectV1Request[objEzsigntemplatepackagesigner]" has a null value in JSON.');
        return true;
      }());
