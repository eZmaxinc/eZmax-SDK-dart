...
class EzsigntemplatepackageEditObjectV1Request {
  ...
  static EzsigntemplatepackageEditObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objEzsigntemplatepackage'), 'Required key "EzsigntemplatepackageEditObjectV1Request[objEzsigntemplatepackage]" is missing from JSON.');
        assert(json[r'objEzsigntemplatepackage'] != null, 'Required key "EzsigntemplatepackageEditObjectV1Request[objEzsigntemplatepackage]" has a null value in JSON.');
        return true;
      }());
