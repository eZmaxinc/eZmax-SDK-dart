...
class CommonResponseErrorSTemporaryFileUrl {
  ...
  static CommonResponseErrorSTemporaryFileUrl? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'sErrorMessage'), 'Required key "CommonResponseErrorSTemporaryFileUrl[sErrorMessage]" is missing from JSON.');
        assert(json[r'sErrorMessage'] != null, 'Required key "CommonResponseErrorSTemporaryFileUrl[sErrorMessage]" has a null value in JSON.');
        assert(json.containsKey(r'eErrorCode'), 'Required key "CommonResponseErrorSTemporaryFileUrl[eErrorCode]" is missing from JSON.');
        assert(json[r'eErrorCode'] != null, 'Required key "CommonResponseErrorSTemporaryFileUrl[eErrorCode]" has a null value in JSON.');
        return true;
      }());
