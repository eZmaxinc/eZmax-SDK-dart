...
class WebhookheaderRequestCompound {
  /// Returns a new [WebhookheaderRequestCompound] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is WebhookheaderRequestCompound &&
  ...
  @override
  String toString() => 'WebhookheaderRequestCompound[pkiWebhookheaderID=$pkiWebhookheaderID, sWebhookheaderName=$sWebhookheaderName, sWebhookheaderValue=$sWebhookheaderValue]';
  ...
  /// Returns a new [WebhookheaderRequestCompound] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static WebhookheaderRequestCompound? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<WebhookheaderRequestCompound> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <WebhookheaderRequestCompound>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = WebhookheaderRequestCompound.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, WebhookheaderRequestCompound> mapFromJson(dynamic json) {
    final map = <String, WebhookheaderRequestCompound>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = WebhookheaderRequestCompound.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of WebhookheaderRequestCompound-objects as value to a dart map
  static Map<String, List<WebhookheaderRequestCompound>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<WebhookheaderRequestCompound>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = WebhookheaderRequestCompound.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
