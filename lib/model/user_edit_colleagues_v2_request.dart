...
class UserEditColleaguesV2Request {
  ...
  static UserEditColleaguesV2Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objColleague'), 'Required key "UserEditColleaguesV2Request[a_objColleague]" is missing from JSON.');
        assert(json[r'a_objColleague'] != null, 'Required key "UserEditColleaguesV2Request[a_objColleague]" has a null value in JSON.');
        return true;
      }());
