...
class EzsigntemplatepublicCreateObjectV1ResponseMPayload {
  ...
  static EzsigntemplatepublicCreateObjectV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiEzsigntemplatepublicID'), 'Required key "EzsigntemplatepublicCreateObjectV1ResponseMPayload[a_pkiEzsigntemplatepublicID]" is missing from JSON.');
        assert(json[r'a_pkiEzsigntemplatepublicID'] != null, 'Required key "EzsigntemplatepublicCreateObjectV1ResponseMPayload[a_pkiEzsigntemplatepublicID]" has a null value in JSON.');
        return true;
      }());
