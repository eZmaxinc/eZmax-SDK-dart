...
class EzsignbulksendGetObjectV3ResponseMPayload {
  ...
  static EzsignbulksendGetObjectV3ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objEzsignbulksend'), 'Required key "EzsignbulksendGetObjectV3ResponseMPayload[objEzsignbulksend]" is missing from JSON.');
        assert(json[r'objEzsignbulksend'] != null, 'Required key "EzsignbulksendGetObjectV3ResponseMPayload[objEzsignbulksend]" has a null value in JSON.');
        return true;
      }());
