...
class EzsigndocumentCreateEzsignelementsPositionedByWordV1Request {
  ...
  static EzsigndocumentCreateEzsignelementsPositionedByWordV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsignformfieldgroup'), 'Required key "EzsigndocumentCreateEzsignelementsPositionedByWordV1Request[a_objEzsignformfieldgroup]" is missing from JSON.');
        assert(json[r'a_objEzsignformfieldgroup'] != null, 'Required key "EzsigndocumentCreateEzsignelementsPositionedByWordV1Request[a_objEzsignformfieldgroup]" has a null value in JSON.');
        assert(json.containsKey(r'a_objEzsignsignature'), 'Required key "EzsigndocumentCreateEzsignelementsPositionedByWordV1Request[a_objEzsignsignature]" is missing from JSON.');
        assert(json[r'a_objEzsignsignature'] != null, 'Required key "EzsigndocumentCreateEzsignelementsPositionedByWordV1Request[a_objEzsignsignature]" has a null value in JSON.');
        return true;
      }());
