...
class EzsignbulksendsignermappingRequestCompound {
  /// Returns a new [EzsignbulksendsignermappingRequestCompound] instance.
  ...
  /// Returns a new [EzsignbulksendsignermappingRequestCompound] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsignbulksendsignermappingRequestCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiEzsignbulksendID'), 'Required key "EzsignbulksendsignermappingRequestCompound[fkiEzsignbulksendID]" is missing from JSON.');
        assert(json[r'fkiEzsignbulksendID'] != null, 'Required key "EzsignbulksendsignermappingRequestCompound[fkiEzsignbulksendID]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsignbulksendsignermappingDescription'), 'Required key "EzsignbulksendsignermappingRequestCompound[sEzsignbulksendsignermappingDescription]" is missing from JSON.');
        assert(json[r'sEzsignbulksendsignermappingDescription'] != null, 'Required key "EzsignbulksendsignermappingRequestCompound[sEzsignbulksendsignermappingDescription]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<EzsignbulksendsignermappingRequestCompound> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsignbulksendsignermappingRequestCompound.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsignbulksendsignermappingRequestCompound> mapFromJson(dynamic json) {
    final map = <String, EzsignbulksendsignermappingRequestCompound>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsignbulksendsignermappingRequestCompound.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsignbulksendsignermappingRequestCompound-objects as value to a dart map
