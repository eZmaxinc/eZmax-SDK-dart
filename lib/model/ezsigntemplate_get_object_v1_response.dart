...
class EzsigntemplateGetObjectV1Response {
  ...
  @override
  String toString() => 'EzsigntemplateGetObjectV1Response[objDebugPayload=$objDebugPayload, objDebug=$objDebug, mPayload=$mPayload]';
  ...
  static Map<String, List<EzsigntemplateGetObjectV1Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplateGetObjectV1Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
