...
class WebhookEzsignFolderCompleted {
  ...
  static WebhookEzsignFolderCompleted? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objWebhook'), 'Required key "WebhookEzsignFolderCompleted[objWebhook]" is missing from JSON.');
        assert(json[r'objWebhook'] != null, 'Required key "WebhookEzsignFolderCompleted[objWebhook]" has a null value in JSON.');
        assert(json.containsKey(r'a_objAttempt'), 'Required key "WebhookEzsignFolderCompleted[a_objAttempt]" is missing from JSON.');
        assert(json[r'a_objAttempt'] != null, 'Required key "WebhookEzsignFolderCompleted[a_objAttempt]" has a null value in JSON.');
        assert(json.containsKey(r'objEzsignfolder'), 'Required key "WebhookEzsignFolderCompleted[objEzsignfolder]" is missing from JSON.');
        assert(json[r'objEzsignfolder'] != null, 'Required key "WebhookEzsignFolderCompleted[objEzsignfolder]" has a null value in JSON.');
        return true;
      }());
