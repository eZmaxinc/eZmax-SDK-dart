...
class EzsignannotationRequest {
  /// Returns a new [EzsignannotationRequest] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsignannotationRequest &&
  ...
  @override
  String toString() => 'EzsignannotationRequest[pkiEzsignannotationID=$pkiEzsignannotationID, fkiEzsigndocumentID=$fkiEzsigndocumentID, eEzsignannotationHorizontalalignment=$eEzsignannotationHorizontalalignment, eEzsignannotationVerticalalignment=$eEzsignannotationVerticalalignment, eEzsignannotationType=$eEzsignannotationType, iEzsignannotationX=$iEzsignannotationX, iEzsignannotationY=$iEzsignannotationY, iEzsignannotationWidth=$iEzsignannotationWidth, iEzsignannotationHeight=$iEzsignannotationHeight, sEzsignannotationText=$sEzsignannotationText, iEzsignpagePagenumber=$iEzsignpagePagenumber]';
  ...
  /// Returns a new [EzsignannotationRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsignannotationRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiEzsigndocumentID'), 'Required key "EzsignannotationRequest[fkiEzsigndocumentID]" is missing from JSON.');
        assert(json[r'fkiEzsigndocumentID'] != null, 'Required key "EzsignannotationRequest[fkiEzsigndocumentID]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsignannotationType'), 'Required key "EzsignannotationRequest[eEzsignannotationType]" is missing from JSON.');
        assert(json[r'eEzsignannotationType'] != null, 'Required key "EzsignannotationRequest[eEzsignannotationType]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsignannotationX'), 'Required key "EzsignannotationRequest[iEzsignannotationX]" is missing from JSON.');
        assert(json[r'iEzsignannotationX'] != null, 'Required key "EzsignannotationRequest[iEzsignannotationX]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsignannotationY'), 'Required key "EzsignannotationRequest[iEzsignannotationY]" is missing from JSON.');
        assert(json[r'iEzsignannotationY'] != null, 'Required key "EzsignannotationRequest[iEzsignannotationY]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsignpagePagenumber'), 'Required key "EzsignannotationRequest[iEzsignpagePagenumber]" is missing from JSON.');
        assert(json[r'iEzsignpagePagenumber'] != null, 'Required key "EzsignannotationRequest[iEzsignpagePagenumber]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<EzsignannotationRequest> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsignannotationRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsignannotationRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsignannotationRequest> mapFromJson(dynamic json) {
    final map = <String, EzsignannotationRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsignannotationRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsignannotationRequest-objects as value to a dart map
  static Map<String, List<EzsignannotationRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsignannotationRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsignannotationRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
