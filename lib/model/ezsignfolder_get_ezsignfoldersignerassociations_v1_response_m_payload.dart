...
class EzsignfolderGetEzsignfoldersignerassociationsV1ResponseMPayload {
  ...
  static EzsignfolderGetEzsignfoldersignerassociationsV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsignfoldersignerassociation'), 'Required key "EzsignfolderGetEzsignfoldersignerassociationsV1ResponseMPayload[a_objEzsignfoldersignerassociation]" is missing from JSON.');
        assert(json[r'a_objEzsignfoldersignerassociation'] != null, 'Required key "EzsignfolderGetEzsignfoldersignerassociationsV1ResponseMPayload[a_objEzsignfoldersignerassociation]" has a null value in JSON.');
        return true;
      }());
  ...
  static Map<String, List<EzsignfolderGetEzsignfoldersignerassociationsV1ResponseMPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsignfolderGetEzsignfoldersignerassociationsV1ResponseMPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
