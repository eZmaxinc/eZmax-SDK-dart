...
class UsergroupdelegationEditObjectV1Request {
  ...
  static UsergroupdelegationEditObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objUsergroupdelegation'), 'Required key "UsergroupdelegationEditObjectV1Request[objUsergroupdelegation]" is missing from JSON.');
        assert(json[r'objUsergroupdelegation'] != null, 'Required key "UsergroupdelegationEditObjectV1Request[objUsergroupdelegation]" has a null value in JSON.');
        return true;
      }());
