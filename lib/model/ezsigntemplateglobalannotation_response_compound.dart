...
class EzsigntemplateglobalannotationResponseCompound {
  ...
  /// Returns a new [EzsigntemplateglobalannotationResponseCompound] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsigntemplateglobalannotationResponseCompound? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<EzsigntemplateglobalannotationResponseCompound> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigntemplateglobalannotationResponseCompound>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigntemplateglobalannotationResponseCompound.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigntemplateglobalannotationResponseCompound> mapFromJson(dynamic json) {
    final map = <String, EzsigntemplateglobalannotationResponseCompound>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplateglobalannotationResponseCompound.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigntemplateglobalannotationResponseCompound-objects as value to a dart map
  static Map<String, List<EzsigntemplateglobalannotationResponseCompound>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigntemplateglobalannotationResponseCompound>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplateglobalannotationResponseCompound.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
