...
class EzsigndocumentDeclineToSignV1Request {
  ...
  static EzsigndocumentDeclineToSignV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'sReason'), 'Required key "EzsigndocumentDeclineToSignV1Request[sReason]" is missing from JSON.');
        assert(json[r'sReason'] != null, 'Required key "EzsigndocumentDeclineToSignV1Request[sReason]" has a null value in JSON.');
        return true;
      }());
