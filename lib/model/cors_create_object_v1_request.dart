...
class CorsCreateObjectV1Request {
  ...
  static CorsCreateObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objCors'), 'Required key "CorsCreateObjectV1Request[a_objCors]" is missing from JSON.');
        assert(json[r'a_objCors'] != null, 'Required key "CorsCreateObjectV1Request[a_objCors]" has a null value in JSON.');
        return true;
      }());
