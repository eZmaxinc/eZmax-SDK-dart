...
class ApikeyRequest {
  ...
  static ApikeyRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiUserID'), 'Required key "ApikeyRequest[fkiUserID]" is missing from JSON.');
        assert(json[r'fkiUserID'] != null, 'Required key "ApikeyRequest[fkiUserID]" has a null value in JSON.');
        assert(json.containsKey(r'objApikeyDescription'), 'Required key "ApikeyRequest[objApikeyDescription]" is missing from JSON.');
        assert(json[r'objApikeyDescription'] != null, 'Required key "ApikeyRequest[objApikeyDescription]" has a null value in JSON.');
        return true;
      }());
