...
class SsprResetPasswordRequestV1Request {
  /// Returns a new [SsprResetPasswordRequestV1Request] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SsprResetPasswordRequestV1Request &&
  ...
  @override
  String toString() => 'SsprResetPasswordRequestV1Request[pksCustomerCode=$pksCustomerCode, fkiLanguageID=$fkiLanguageID, eUserTypeSSPR=$eUserTypeSSPR, sEmailAddress=$sEmailAddress, sUserLoginname=$sUserLoginname]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SsprResetPasswordRequestV1Request[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SsprResetPasswordRequestV1Request[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SsprResetPasswordRequestV1Request>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SsprResetPasswordRequestV1Request>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SsprResetPasswordRequestV1Request.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SsprResetPasswordRequestV1Request> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = SsprResetPasswordRequestV1Request.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<SsprResetPasswordRequestV1Request>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SsprResetPasswordRequestV1Request>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SsprResetPasswordRequestV1Request.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
