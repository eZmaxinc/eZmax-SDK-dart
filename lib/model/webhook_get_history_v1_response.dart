...
class WebhookGetHistoryV1Response {
  ...
  static WebhookGetHistoryV1Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "WebhookGetHistoryV1Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "WebhookGetHistoryV1Response[objDebugPayload]" has a null value in JSON.');
        assert(json.containsKey(r'mPayload'), 'Required key "WebhookGetHistoryV1Response[mPayload]" is missing from JSON.');
        assert(json[r'mPayload'] != null, 'Required key "WebhookGetHistoryV1Response[mPayload]" has a null value in JSON.');
        return true;
      }());
