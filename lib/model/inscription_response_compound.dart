  ...
  static InscriptionResponseCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        ...
        assert(json.containsKey(r'fkiCompanyID'), 'Required key "InscriptionResponseCompound[fkiCompanyID]" is missing from JSON.');
        assert(json[r'fkiCompanyID'] != null, 'Required key "InscriptionResponseCompound[fkiCompanyID]" has a null value in JSON.');
        assert(json.containsKey(r'fkiDepartmentID'), 'Required key "InscriptionResponseCompound[fkiDepartmentID]" is missing from JSON.');
        assert(json[r'fkiDepartmentID'] != null, 'Required key "InscriptionResponseCompound[fkiDepartmentID]" has a null value in JSON.');
        ...
        assert(json.containsKey(r'sInscriptionMLS'), 'Required key "InscriptionResponseCompound[sInscriptionMLS]" is missing from JSON.');
        assert(json[r'sInscriptionMLS'] != null, 'Required key "InscriptionResponseCompound[sInscriptionMLS]" has a null value in JSON.');
        ...
        assert(json.containsKey(r'dtInscriptionDate'), 'Required key "InscriptionResponseCompound[dtInscriptionDate]" is missing from JSON.');
        assert(json[r'dtInscriptionDate'] != null, 'Required key "InscriptionResponseCompound[dtInscriptionDate]" has a null value in JSON.');
        assert(json.containsKey(r'dtInscriptionCancellationdate'), 'Required key "InscriptionResponseCompound[dtInscriptionCancellationdate]" is missing from JSON.');
        assert(json[r'dtInscriptionCancellationdate'] != null, 'Required key "InscriptionResponseCompound[dtInscriptionCancellationdate]" has a null value in JSON.');
        assert(json.containsKey(r'dtInscriptionInitialexpirationdate'), 'Required key "InscriptionResponseCompound[dtInscriptionInitialexpirationdate]" is missing from JSON.');
        assert(json[r'dtInscriptionInitialexpirationdate'] != null, 'Required key "InscriptionResponseCompound[dtInscriptionInitialexpirationdate]" has a null value in JSON.');
        assert(json.containsKey(r'dtInscriptionExpirationdate'), 'Required key "InscriptionResponseCompound[dtInscriptionExpirationdate]" is missing from JSON.');
        assert(json[r'dtInscriptionExpirationdate'] != null, 'Required key "InscriptionResponseCompound[dtInscriptionExpirationdate]" has a null value in JSON.');
        assert(json.containsKey(r'dtInscriptionNotarydate'), 'Required key "InscriptionResponseCompound[dtInscriptionNotarydate]" is missing from JSON.');
        assert(json[r'dtInscriptionNotarydate'] != null, 'Required key "InscriptionResponseCompound[dtInscriptionNotarydate]" has a null value in JSON.');
        assert(json.containsKey(r'dtInscriptionNotaryentereddate'), 'Required key "InscriptionResponseCompound[dtInscriptionNotaryentereddate]" is missing from JSON.');
        assert(json[r'dtInscriptionNotaryentereddate'] != null, 'Required key "InscriptionResponseCompound[dtInscriptionNotaryentereddate]" has a null value in JSON.');
