...
class EzsignsigningreasonGetObjectV2Response {
  ...
  static EzsignsigningreasonGetObjectV2Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "EzsignsigningreasonGetObjectV2Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "EzsignsigningreasonGetObjectV2Response[objDebugPayload]" has a null value in JSON.');
        assert(json.containsKey(r'mPayload'), 'Required key "EzsignsigningreasonGetObjectV2Response[mPayload]" is missing from JSON.');
        assert(json[r'mPayload'] != null, 'Required key "EzsignsigningreasonGetObjectV2Response[mPayload]" has a null value in JSON.');
        return true;
      }());
