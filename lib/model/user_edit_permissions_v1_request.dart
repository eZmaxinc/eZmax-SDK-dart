...
class UserEditPermissionsV1Request {
  ...
  static UserEditPermissionsV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objPermission'), 'Required key "UserEditPermissionsV1Request[a_objPermission]" is missing from JSON.');
        assert(json[r'a_objPermission'] != null, 'Required key "UserEditPermissionsV1Request[a_objPermission]" has a null value in JSON.');
        return true;
      }());
