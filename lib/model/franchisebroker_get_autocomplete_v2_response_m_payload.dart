...
class FranchisebrokerGetAutocompleteV2ResponseMPayload {
  ...
  bool operator ==(Object other) => identical(this, other) || other is FranchisebrokerGetAutocompleteV2ResponseMPayload &&
    _deepEquality.equals(other.aObjFranchisebroker, aObjFranchisebroker);
  ...
  static FranchisebrokerGetAutocompleteV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objFranchisebroker'), 'Required key "FranchisebrokerGetAutocompleteV2ResponseMPayload[a_objFranchisebroker]" is missing from JSON.');
        assert(json[r'a_objFranchisebroker'] != null, 'Required key "FranchisebrokerGetAutocompleteV2ResponseMPayload[a_objFranchisebroker]" has a null value in JSON.');
        return true;
      }());

      return FranchisebrokerGetAutocompleteV2ResponseMPayload(
        aObjFranchisebroker: FranchisebrokerAutocompleteElementResponse.listFromJson(json[r'a_objFranchisebroker']),
      );
    }
    return null;
  }
  ...
  static Map<String, List<FranchisebrokerGetAutocompleteV2ResponseMPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = FranchisebrokerGetAutocompleteV2ResponseMPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
