...
class ActivesessionGenerateFederationTokenV1ResponseMPayload {
  ...
  static ActivesessionGenerateFederationTokenV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objApikeyfederation'), 'Required key "ActivesessionGenerateFederationTokenV1ResponseMPayload[objApikeyfederation]" is missing from JSON.');
        assert(json[r'objApikeyfederation'] != null, 'Required key "ActivesessionGenerateFederationTokenV1ResponseMPayload[objApikeyfederation]" has a null value in JSON.');
        assert(json.containsKey(r'sEzmaxcustomercodeUrl'), 'Required key "ActivesessionGenerateFederationTokenV1ResponseMPayload[sEzmaxcustomercodeUrl]" is missing from JSON.');
        assert(json[r'sEzmaxcustomercodeUrl'] != null, 'Required key "ActivesessionGenerateFederationTokenV1ResponseMPayload[sEzmaxcustomercodeUrl]" has a null value in JSON.');
        return true;
      }());
