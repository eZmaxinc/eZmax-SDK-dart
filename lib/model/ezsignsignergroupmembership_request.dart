...
class EzsignsignergroupmembershipRequest {
  /// Returns a new [EzsignsignergroupmembershipRequest] instance.
  ...
  /// Returns a new [EzsignsignergroupmembershipRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsignsignergroupmembershipRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiEzsignsignergroupID'), 'Required key "EzsignsignergroupmembershipRequest[fkiEzsignsignergroupID]" is missing from JSON.');
        assert(json[r'fkiEzsignsignergroupID'] != null, 'Required key "EzsignsignergroupmembershipRequest[fkiEzsignsignergroupID]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<EzsignsignergroupmembershipRequest> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsignsignergroupmembershipRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsignsignergroupmembershipRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsignsignergroupmembershipRequest> mapFromJson(dynamic json) {
    final map = <String, EzsignsignergroupmembershipRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsignsignergroupmembershipRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsignsignergroupmembershipRequest-objects as value to a dart map
  static Map<String, List<EzsignsignergroupmembershipRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsignsignergroupmembershipRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsignsignergroupmembershipRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
