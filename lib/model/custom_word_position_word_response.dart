...
class CustomWordPositionWordResponse {
  ...
  static CustomWordPositionWordResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'sWord'), 'Required key "CustomWordPositionWordResponse[sWord]" is missing from JSON.');
        assert(json[r'sWord'] != null, 'Required key "CustomWordPositionWordResponse[sWord]" has a null value in JSON.');
        assert(json.containsKey(r'a_objWordPositionOccurence'), 'Required key "CustomWordPositionWordResponse[a_objWordPositionOccurence]" is missing from JSON.');
        assert(json[r'a_objWordPositionOccurence'] != null, 'Required key "CustomWordPositionWordResponse[a_objWordPositionOccurence]" has a null value in JSON.');
        return true;
      }());
