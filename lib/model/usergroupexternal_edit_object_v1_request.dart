...
class UsergroupexternalEditObjectV1Request {
  ...
  static UsergroupexternalEditObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objUsergroupexternal'), 'Required key "UsergroupexternalEditObjectV1Request[objUsergroupexternal]" is missing from JSON.');
        assert(json[r'objUsergroupexternal'] != null, 'Required key "UsergroupexternalEditObjectV1Request[objUsergroupexternal]" has a null value in JSON.');
        return true;
      }());
