...
class EzsignfoldersignerassociationDeleteObjectV1Response {
  ...
  static List<EzsignfoldersignerassociationDeleteObjectV1Response> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(EzsignfoldersignerassociationDeleteObjectV1Response.fromJson).toList(growable: true == growable)
  ...
  static Map<String, EzsignfoldersignerassociationDeleteObjectV1Response> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = EzsignfoldersignerassociationDeleteObjectV1Response.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of EzsignfoldersignerassociationDeleteObjectV1Response-objects as value to a dart map
  static Map<String, List<EzsignfoldersignerassociationDeleteObjectV1Response>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<EzsignfoldersignerassociationDeleteObjectV1Response>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = EzsignfoldersignerassociationDeleteObjectV1Response.listFromJson(
            value,
