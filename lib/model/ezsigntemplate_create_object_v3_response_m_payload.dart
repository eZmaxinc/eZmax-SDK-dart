...
class EzsigntemplateCreateObjectV3ResponseMPayload {
  ...
  static EzsigntemplateCreateObjectV3ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiEzsigntemplateID'), 'Required key "EzsigntemplateCreateObjectV3ResponseMPayload[a_pkiEzsigntemplateID]" is missing from JSON.');
        assert(json[r'a_pkiEzsigntemplateID'] != null, 'Required key "EzsigntemplateCreateObjectV3ResponseMPayload[a_pkiEzsigntemplateID]" has a null value in JSON.');
        return true;
      }());
