...
class EzsigntemplateformfieldgroupsignerRequest {
  ...
  static EzsigntemplateformfieldgroupsignerRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiEzsigntemplatesignerID'), 'Required key "EzsigntemplateformfieldgroupsignerRequest[fkiEzsigntemplatesignerID]" is missing from JSON.');
        assert(json[r'fkiEzsigntemplatesignerID'] != null, 'Required key "EzsigntemplateformfieldgroupsignerRequest[fkiEzsigntemplatesignerID]" has a null value in JSON.');
        return true;
      }());
  ...
  static Map<String, List<EzsigntemplateformfieldgroupsignerRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplateformfieldgroupsignerRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
