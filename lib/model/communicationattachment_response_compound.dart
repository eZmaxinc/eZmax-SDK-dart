...
class CommunicationattachmentResponseCompound {
  /// Returns a new [CommunicationattachmentResponseCompound] instance.
  ...
  /// Returns a new [CommunicationattachmentResponseCompound] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CommunicationattachmentResponseCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CommunicationattachmentResponseCompound[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CommunicationattachmentResponseCompound[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CommunicationattachmentResponseCompound> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CommunicationattachmentResponseCompound>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CommunicationattachmentResponseCompound.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CommunicationattachmentResponseCompound> mapFromJson(dynamic json) {
    final map = <String, CommunicationattachmentResponseCompound>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CommunicationattachmentResponseCompound.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CommunicationattachmentResponseCompound-objects as value to a dart map
  static Map<String, List<CommunicationattachmentResponseCompound>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CommunicationattachmentResponseCompound>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CommunicationattachmentResponseCompound.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
