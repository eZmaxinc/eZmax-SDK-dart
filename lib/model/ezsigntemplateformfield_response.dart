...
class EzsigntemplateformfieldResponse {
  /// Returns a new [EzsigntemplateformfieldResponse] instance.
  ...
  /// Returns a new [EzsigntemplateformfieldResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsigntemplateformfieldResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsigntemplateformfieldID'), 'Required key "EzsigntemplateformfieldResponse[pkiEzsigntemplateformfieldID]" is missing from JSON.');
        assert(json[r'pkiEzsigntemplateformfieldID'] != null, 'Required key "EzsigntemplateformfieldResponse[pkiEzsigntemplateformfieldID]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsigntemplatedocumentpagePagenumber'), 'Required key "EzsigntemplateformfieldResponse[iEzsigntemplatedocumentpagePagenumber]" is missing from JSON.');
        assert(json[r'iEzsigntemplatedocumentpagePagenumber'] != null, 'Required key "EzsigntemplateformfieldResponse[iEzsigntemplatedocumentpagePagenumber]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsigntemplateformfieldLabel'), 'Required key "EzsigntemplateformfieldResponse[sEzsigntemplateformfieldLabel]" is missing from JSON.');
        assert(json[r'sEzsigntemplateformfieldLabel'] != null, 'Required key "EzsigntemplateformfieldResponse[sEzsigntemplateformfieldLabel]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsigntemplateformfieldWidth'), 'Required key "EzsigntemplateformfieldResponse[iEzsigntemplateformfieldWidth]" is missing from JSON.');
        assert(json[r'iEzsigntemplateformfieldWidth'] != null, 'Required key "EzsigntemplateformfieldResponse[iEzsigntemplateformfieldWidth]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsigntemplateformfieldHeight'), 'Required key "EzsigntemplateformfieldResponse[iEzsigntemplateformfieldHeight]" is missing from JSON.');
        assert(json[r'iEzsigntemplateformfieldHeight'] != null, 'Required key "EzsigntemplateformfieldResponse[iEzsigntemplateformfieldHeight]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<EzsigntemplateformfieldResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigntemplateformfieldResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigntemplateformfieldResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigntemplateformfieldResponse> mapFromJson(dynamic json) {
    final map = <String, EzsigntemplateformfieldResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplateformfieldResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigntemplateformfieldResponse-objects as value to a dart map
  static Map<String, List<EzsigntemplateformfieldResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigntemplateformfieldResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplateformfieldResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
