...
class EzsigntemplatedocumentpagerecognitionEditObjectV1Request {
  ...
  static EzsigntemplatedocumentpagerecognitionEditObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objEzsigntemplatedocumentpagerecognition'), 'Required key "EzsigntemplatedocumentpagerecognitionEditObjectV1Request[objEzsigntemplatedocumentpagerecognition]" is missing from JSON.');
        assert(json[r'objEzsigntemplatedocumentpagerecognition'] != null, 'Required key "EzsigntemplatedocumentpagerecognitionEditObjectV1Request[objEzsigntemplatedocumentpagerecognition]" has a null value in JSON.');
        return true;
      }());
