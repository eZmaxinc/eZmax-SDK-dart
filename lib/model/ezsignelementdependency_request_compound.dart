...
class EzsignelementdependencyRequestCompound {
  /// Returns a new [EzsignelementdependencyRequestCompound] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsignelementdependencyRequestCompound &&
  ...
  /// Returns a new [EzsignelementdependencyRequestCompound] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsignelementdependencyRequestCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'eEzsignelementdependencyValidation'), 'Required key "EzsignelementdependencyRequestCompound[eEzsignelementdependencyValidation]" is missing from JSON.');
        assert(json[r'eEzsignelementdependencyValidation'] != null, 'Required key "EzsignelementdependencyRequestCompound[eEzsignelementdependencyValidation]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<EzsignelementdependencyRequestCompound> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsignelementdependencyRequestCompound>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsignelementdependencyRequestCompound.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsignelementdependencyRequestCompound> mapFromJson(dynamic json) {
    final map = <String, EzsignelementdependencyRequestCompound>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsignelementdependencyRequestCompound.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsignelementdependencyRequestCompound-objects as value to a dart map
  static Map<String, List<EzsignelementdependencyRequestCompound>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsignelementdependencyRequestCompound>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsignelementdependencyRequestCompound.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
