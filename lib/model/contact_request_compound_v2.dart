...
class ContactRequestCompoundV2 {
  /// Returns a new [ContactRequestCompoundV2] instance.
  ...
  ContactinformationsRequestCompoundV2 objContactinformations;

  @override
  bool operator ==(Object other) => identical(this, other) || other is ContactRequestCompoundV2 &&
  ...
  @override
  String toString() => 'ContactRequestCompoundV2[fkiContacttitleID=$fkiContacttitleID, fkiLanguageID=$fkiLanguageID, eContactType=$eContactType, sContactFirstname=$sContactFirstname, sContactLastname=$sContactLastname, sContactCompany=$sContactCompany, dtContactBirthdate=$dtContactBirthdate, sContactOccupation=$sContactOccupation, tContactNote=$tContactNote, bContactIsactive=$bContactIsactive, objContactinformations=$objContactinformations]';
  ...
  /// Returns a new [ContactRequestCompoundV2] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ContactRequestCompoundV2? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ContactRequestCompoundV2(
        ...
        objContactinformations: ContactinformationsRequestCompoundV2.fromJson(json[r'objContactinformations'])!,
      );
    }
    return null;
  }

  static List<ContactRequestCompoundV2> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ContactRequestCompoundV2>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ContactRequestCompoundV2.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ContactRequestCompoundV2> mapFromJson(dynamic json) {
    final map = <String, ContactRequestCompoundV2>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ContactRequestCompoundV2.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ContactRequestCompoundV2-objects as value to a dart map
  static Map<String, List<ContactRequestCompoundV2>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ContactRequestCompoundV2>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ContactRequestCompoundV2.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
