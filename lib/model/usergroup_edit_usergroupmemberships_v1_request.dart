...
class UsergroupEditUsergroupmembershipsV1Request {
  ...
  static UsergroupEditUsergroupmembershipsV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objUsergroupmembership'), 'Required key "UsergroupEditUsergroupmembershipsV1Request[a_objUsergroupmembership]" is missing from JSON.');
        assert(json[r'a_objUsergroupmembership'] != null, 'Required key "UsergroupEditUsergroupmembershipsV1Request[a_objUsergroupmembership]" has a null value in JSON.');
        return true;
      }());
