...
class EzsigndocumentGetObjectV3ResponseMPayload {
  ...
  static EzsigndocumentGetObjectV3ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objEzsigndocument'), 'Required key "EzsigndocumentGetObjectV3ResponseMPayload[objEzsigndocument]" is missing from JSON.');
        assert(json[r'objEzsigndocument'] != null, 'Required key "EzsigndocumentGetObjectV3ResponseMPayload[objEzsigndocument]" has a null value in JSON.');
        return true;
      }());
