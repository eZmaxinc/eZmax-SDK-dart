...
class UsergroupEditPermissionsV1ResponseMPayload {
  ...
  static UsergroupEditPermissionsV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiPermissionID'), 'Required key "UsergroupEditPermissionsV1ResponseMPayload[a_pkiPermissionID]" is missing from JSON.');
        assert(json[r'a_pkiPermissionID'] != null, 'Required key "UsergroupEditPermissionsV1ResponseMPayload[a_pkiPermissionID]" has a null value in JSON.');
        return true;
      }());
