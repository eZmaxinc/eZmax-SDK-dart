...
class EzsigntemplatepackagesignerRequestCompoundV2 {
  /// Returns a new [EzsigntemplatepackagesignerRequestCompoundV2] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsigntemplatepackagesignerRequestCompoundV2 &&
  ...
  /// Returns a new [EzsigntemplatepackagesignerRequestCompoundV2] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsigntemplatepackagesignerRequestCompoundV2? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiEzsigntemplatepackageID'), 'Required key "EzsigntemplatepackagesignerRequestCompoundV2[fkiEzsigntemplatepackageID]" is missing from JSON.');
        assert(json[r'fkiEzsigntemplatepackageID'] != null, 'Required key "EzsigntemplatepackagesignerRequestCompoundV2[fkiEzsigntemplatepackageID]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsigntemplatepackagesignerDescription'), 'Required key "EzsigntemplatepackagesignerRequestCompoundV2[sEzsigntemplatepackagesignerDescription]" is missing from JSON.');
        assert(json[r'sEzsigntemplatepackagesignerDescription'] != null, 'Required key "EzsigntemplatepackagesignerRequestCompoundV2[sEzsigntemplatepackagesignerDescription]" has a null value in JSON.');
        return true;
      }());

      return EzsigntemplatepackagesignerRequestCompoundV2(
  ...
  static List<EzsigntemplatepackagesignerRequestCompoundV2> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigntemplatepackagesignerRequestCompoundV2>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigntemplatepackagesignerRequestCompoundV2.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigntemplatepackagesignerRequestCompoundV2> mapFromJson(dynamic json) {
    final map = <String, EzsigntemplatepackagesignerRequestCompoundV2>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplatepackagesignerRequestCompoundV2.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigntemplatepackagesignerRequestCompoundV2-objects as value to a dart map
  static Map<String, List<EzsigntemplatepackagesignerRequestCompoundV2>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigntemplatepackagesignerRequestCompoundV2>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplatepackagesignerRequestCompoundV2.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
