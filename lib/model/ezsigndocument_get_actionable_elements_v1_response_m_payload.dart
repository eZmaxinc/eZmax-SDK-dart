...
class EzsigndocumentGetActionableElementsV1ResponseMPayload {
  ...
  static EzsigndocumentGetActionableElementsV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsignsignature'), 'Required key "EzsigndocumentGetActionableElementsV1ResponseMPayload[a_objEzsignsignature]" is missing from JSON.');
        assert(json[r'a_objEzsignsignature'] != null, 'Required key "EzsigndocumentGetActionableElementsV1ResponseMPayload[a_objEzsignsignature]" has a null value in JSON.');
        assert(json.containsKey(r'a_objEzsignformfieldgroup'), 'Required key "EzsigndocumentGetActionableElementsV1ResponseMPayload[a_objEzsignformfieldgroup]" is missing from JSON.');
        assert(json[r'a_objEzsignformfieldgroup'] != null, 'Required key "EzsigndocumentGetActionableElementsV1ResponseMPayload[a_objEzsignformfieldgroup]" has a null value in JSON.');
        return true;
      }());
