...
class EzsigntemplatepublicCreateObjectV1Request {
  ...
  static EzsigntemplatepublicCreateObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsigntemplatepublic'), 'Required key "EzsigntemplatepublicCreateObjectV1Request[a_objEzsigntemplatepublic]" is missing from JSON.');
        assert(json[r'a_objEzsigntemplatepublic'] != null, 'Required key "EzsigntemplatepublicCreateObjectV1Request[a_objEzsigntemplatepublic]" has a null value in JSON.');
        return true;
      }());
