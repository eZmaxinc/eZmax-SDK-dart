...
class EzsignsignatureRequestCompound {
  ...
  static EzsignsignatureRequestCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiEzsignfoldersignerassociationID'), 'Required key "EzsignsignatureRequestCompound[fkiEzsignfoldersignerassociationID]" is missing from JSON.');
        assert(json[r'fkiEzsignfoldersignerassociationID'] != null, 'Required key "EzsignsignatureRequestCompound[fkiEzsignfoldersignerassociationID]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsignpagePagenumber'), 'Required key "EzsignsignatureRequestCompound[iEzsignpagePagenumber]" is missing from JSON.');
        assert(json[r'iEzsignpagePagenumber'] != null, 'Required key "EzsignsignatureRequestCompound[iEzsignpagePagenumber]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsignsignatureX'), 'Required key "EzsignsignatureRequestCompound[iEzsignsignatureX]" is missing from JSON.');
        assert(json[r'iEzsignsignatureX'] != null, 'Required key "EzsignsignatureRequestCompound[iEzsignsignatureX]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsignsignatureY'), 'Required key "EzsignsignatureRequestCompound[iEzsignsignatureY]" is missing from JSON.');
        assert(json[r'iEzsignsignatureY'] != null, 'Required key "EzsignsignatureRequestCompound[iEzsignsignatureY]" has a null value in JSON.');
        assert(json.containsKey(r'iEzsignsignatureStep'), 'Required key "EzsignsignatureRequestCompound[iEzsignsignatureStep]" is missing from JSON.');
        assert(json[r'iEzsignsignatureStep'] != null, 'Required key "EzsignsignatureRequestCompound[iEzsignsignatureStep]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsignsignatureType'), 'Required key "EzsignsignatureRequestCompound[eEzsignsignatureType]" is missing from JSON.');
        assert(json[r'eEzsignsignatureType'] != null, 'Required key "EzsignsignatureRequestCompound[eEzsignsignatureType]" has a null value in JSON.');
        assert(json.containsKey(r'fkiEzsigndocumentID'), 'Required key "EzsignsignatureRequestCompound[fkiEzsigndocumentID]" is missing from JSON.');
        assert(json[r'fkiEzsigndocumentID'] != null, 'Required key "EzsignsignatureRequestCompound[fkiEzsigndocumentID]" has a null value in JSON.');
        return true;
      }());
