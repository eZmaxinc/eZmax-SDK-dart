...
class UNUSEDEzsigndocumentEditObjectV1Response {
  ...
  static List<UNUSEDEzsigndocumentEditObjectV1Response> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(UNUSEDEzsigndocumentEditObjectV1Response.fromJson).toList(growable: true == growable)
  ...
  static Map<String, UNUSEDEzsigndocumentEditObjectV1Response> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = UNUSEDEzsigndocumentEditObjectV1Response.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of UNUSEDEzsigndocumentEditObjectV1Response-objects as value to a dart map
  static Map<String, List<UNUSEDEzsigndocumentEditObjectV1Response>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<UNUSEDEzsigndocumentEditObjectV1Response>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = UNUSEDEzsigndocumentEditObjectV1Response.listFromJson(
            value,
