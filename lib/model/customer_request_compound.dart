...
class CustomerRequestCompound {
  /// Returns a new [CustomerRequestCompound] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CustomerRequestCompound &&
  ...
  int get hashCode =>
    ...
    (pkiCustomerID == null ? 0 : pkiCustomerID!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.pkiCustomerID != null) {
      json[r'pkiCustomerID'] = this.pkiCustomerID;
    } else {
      json[r'pkiCustomerID'] = null;
    }
  ...
  /// Returns a new [CustomerRequestCompound] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CustomerRequestCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CustomerRequestCompound[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CustomerRequestCompound[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CustomerRequestCompound> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CustomerRequestCompound>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CustomerRequestCompound.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CustomerRequestCompound> mapFromJson(dynamic json) {
    final map = <String, CustomerRequestCompound>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CustomerRequestCompound.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CustomerRequestCompound-objects as value to a dart map
  static Map<String, List<CustomerRequestCompound>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CustomerRequestCompound>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CustomerRequestCompound.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
