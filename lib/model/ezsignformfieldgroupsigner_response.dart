...
class EzsignformfieldgroupsignerResponse {
  ...
  static EzsignformfieldgroupsignerResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsignformfieldgroupsignerID'), 'Required key "EzsignformfieldgroupsignerResponse[pkiEzsignformfieldgroupsignerID]" is missing from JSON.');
        assert(json[r'pkiEzsignformfieldgroupsignerID'] != null, 'Required key "EzsignformfieldgroupsignerResponse[pkiEzsignformfieldgroupsignerID]" has a null value in JSON.');
        assert(json.containsKey(r'fkiEzsignfoldersignerassociationID'), 'Required key "EzsignformfieldgroupsignerResponse[fkiEzsignfoldersignerassociationID]" is missing from JSON.');
        assert(json[r'fkiEzsignfoldersignerassociationID'] != null, 'Required key "EzsignformfieldgroupsignerResponse[fkiEzsignfoldersignerassociationID]" has a null value in JSON.');
        return true;
      }());
