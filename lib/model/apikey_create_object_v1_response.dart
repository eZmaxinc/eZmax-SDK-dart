...
class ApikeyCreateObjectV1Response {
  ...
  static List<ApikeyCreateObjectV1Response> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(ApikeyCreateObjectV1Response.fromJson).toList(growable: true == growable)
  ...
  static Map<String, ApikeyCreateObjectV1Response> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = ApikeyCreateObjectV1Response.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of ApikeyCreateObjectV1Response-objects as value to a dart map
  static Map<String, List<ApikeyCreateObjectV1Response>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<ApikeyCreateObjectV1Response>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = ApikeyCreateObjectV1Response.listFromJson(
            value,
