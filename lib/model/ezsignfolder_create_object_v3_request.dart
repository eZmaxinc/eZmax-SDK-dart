...
class EzsignfolderCreateObjectV3Request {
  ...
  static EzsignfolderCreateObjectV3Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsignfolder'), 'Required key "EzsignfolderCreateObjectV3Request[a_objEzsignfolder]" is missing from JSON.');
        assert(json[r'a_objEzsignfolder'] != null, 'Required key "EzsignfolderCreateObjectV3Request[a_objEzsignfolder]" has a null value in JSON.');
        return true;
      }());
