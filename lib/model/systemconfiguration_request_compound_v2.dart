...
class SystemconfigurationRequestCompoundV2 {
  /// Returns a new [SystemconfigurationRequestCompoundV2] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SystemconfigurationRequestCompoundV2 &&
  ...
  /// Returns a new [SystemconfigurationRequestCompoundV2] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SystemconfigurationRequestCompoundV2? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return SystemconfigurationRequestCompoundV2(
  ...
  static List<SystemconfigurationRequestCompoundV2> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SystemconfigurationRequestCompoundV2>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SystemconfigurationRequestCompoundV2.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SystemconfigurationRequestCompoundV2> mapFromJson(dynamic json) {
    final map = <String, SystemconfigurationRequestCompoundV2>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SystemconfigurationRequestCompoundV2.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SystemconfigurationRequestCompoundV2-objects as value to a dart map
  static Map<String, List<SystemconfigurationRequestCompoundV2>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SystemconfigurationRequestCompoundV2>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SystemconfigurationRequestCompoundV2.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
