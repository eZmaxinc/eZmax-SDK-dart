...
class EzsigntemplatepackagesignermembershipRequestCompound {
  /// Returns a new [EzsigntemplatepackagesignermembershipRequestCompound] instance.
  ...
  static EzsigntemplatepackagesignermembershipRequestCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiEzsigntemplatepackagemembershipID'), 'Required key "EzsigntemplatepackagesignermembershipRequestCompound[fkiEzsigntemplatepackagemembershipID]" is missing from JSON.');
        assert(json[r'fkiEzsigntemplatepackagemembershipID'] != null, 'Required key "EzsigntemplatepackagesignermembershipRequestCompound[fkiEzsigntemplatepackagemembershipID]" has a null value in JSON.');
        assert(json.containsKey(r'fkiEzsigntemplatepackagesignerID'), 'Required key "EzsigntemplatepackagesignermembershipRequestCompound[fkiEzsigntemplatepackagesignerID]" is missing from JSON.');
        assert(json[r'fkiEzsigntemplatepackagesignerID'] != null, 'Required key "EzsigntemplatepackagesignermembershipRequestCompound[fkiEzsigntemplatepackagesignerID]" has a null value in JSON.');
        assert(json.containsKey(r'fkiEzsigntemplatesignerID'), 'Required key "EzsigntemplatepackagesignermembershipRequestCompound[fkiEzsigntemplatesignerID]" is missing from JSON.');
        assert(json[r'fkiEzsigntemplatesignerID'] != null, 'Required key "EzsigntemplatepackagesignermembershipRequestCompound[fkiEzsigntemplatesignerID]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<EzsigntemplatepackagesignermembershipRequestCompound> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigntemplatepackagesignermembershipRequestCompound>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigntemplatepackagesignermembershipRequestCompound.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigntemplatepackagesignermembershipRequestCompound> mapFromJson(dynamic json) {
    final map = <String, EzsigntemplatepackagesignermembershipRequestCompound>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplatepackagesignermembershipRequestCompound.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigntemplatepackagesignermembershipRequestCompound-objects as value to a dart map
  static Map<String, List<EzsigntemplatepackagesignermembershipRequestCompound>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigntemplatepackagesignermembershipRequestCompound>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplatepackagesignermembershipRequestCompound.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
