...
class EzsignbulksendsignermappingCreateObjectV1ResponseMPayload {
  ...
  bool operator ==(Object other) => identical(this, other) || other is EzsignbulksendsignermappingCreateObjectV1ResponseMPayload &&
     other.aPkiEzsignbulksendsignermappingID == aPkiEzsignbulksendsignermappingID;
  ...
  Map<String, dynamic> toJson() {
    final _json = <String, dynamic>{};
      _json[r'a_pkiEzsignbulksendsignermappingID'] = aPkiEzsignbulksendsignermappingID;
    return _json;
  }
  ...
  static EzsignbulksendsignermappingCreateObjectV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return EzsignbulksendsignermappingCreateObjectV1ResponseMPayload(
        aPkiEzsignbulksendsignermappingID: json[r'a_pkiEzsignbulksendsignermappingID'] is List
            ? (json[r'a_pkiEzsignbulksendsignermappingID'] as List).cast<int>()
            : const [],
      );
    }
    return null;
  ...
  static Map<String, List<EzsignbulksendsignermappingCreateObjectV1ResponseMPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsignbulksendsignermappingCreateObjectV1ResponseMPayload.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
