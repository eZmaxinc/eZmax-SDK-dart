...
class EzsignbulksendsignermappingCreateObjectV1ResponseMPayload {
  ...
  static EzsignbulksendsignermappingCreateObjectV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiEzsignbulksendsignermappingID'), 'Required key "EzsignbulksendsignermappingCreateObjectV1ResponseMPayload[a_pkiEzsignbulksendsignermappingID]" is missing from JSON.');
        assert(json[r'a_pkiEzsignbulksendsignermappingID'] != null, 'Required key "EzsignbulksendsignermappingCreateObjectV1ResponseMPayload[a_pkiEzsignbulksendsignermappingID]" has a null value in JSON.');
        return true;
      }());
