...
class BrandingCreateObjectV1Response {
  ...
  @override
  String toString() => 'BrandingCreateObjectV1Response[objDebugPayload=$objDebugPayload, objDebug=$objDebug, mPayload=$mPayload]';
  ...
  static Map<String, List<BrandingCreateObjectV1Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = BrandingCreateObjectV1Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
