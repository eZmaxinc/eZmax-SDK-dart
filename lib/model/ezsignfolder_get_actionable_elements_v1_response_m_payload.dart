...
class EzsignfolderGetActionableElementsV1ResponseMPayload {
  ...
  static EzsignfolderGetActionableElementsV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsignsignature'), 'Required key "EzsignfolderGetActionableElementsV1ResponseMPayload[a_objEzsignsignature]" is missing from JSON.');
        assert(json[r'a_objEzsignsignature'] != null, 'Required key "EzsignfolderGetActionableElementsV1ResponseMPayload[a_objEzsignsignature]" has a null value in JSON.');
        assert(json.containsKey(r'a_objEzsignformfieldgroup'), 'Required key "EzsignfolderGetActionableElementsV1ResponseMPayload[a_objEzsignformfieldgroup]" is missing from JSON.');
        assert(json[r'a_objEzsignformfieldgroup'] != null, 'Required key "EzsignfolderGetActionableElementsV1ResponseMPayload[a_objEzsignformfieldgroup]" has a null value in JSON.');
        return true;
      }());
