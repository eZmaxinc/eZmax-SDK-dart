...
class PaymentgatewayResponseCompound {
  /// Returns a new [PaymentgatewayResponseCompound] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PaymentgatewayResponseCompound &&
  ...
  @override
  String toString() => 'PaymentgatewayResponseCompound[pkiPaymentgatewayID=$pkiPaymentgatewayID, fkiCreditcardmerchantID=$fkiCreditcardmerchantID, sCreditcardmerchantDescription=$sCreditcardmerchantDescription, ePaymentgatewayProcessor=$ePaymentgatewayProcessor, objPaymentgatewayDescription=$objPaymentgatewayDescription, objCreditcardmerchant=$objCreditcardmerchant]';
  ...
  /// Returns a new [PaymentgatewayResponseCompound] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PaymentgatewayResponseCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PaymentgatewayResponseCompound(
  ...
  static List<PaymentgatewayResponseCompound> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PaymentgatewayResponseCompound>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PaymentgatewayResponseCompound.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PaymentgatewayResponseCompound> mapFromJson(dynamic json) {
    final map = <String, PaymentgatewayResponseCompound>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PaymentgatewayResponseCompound.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PaymentgatewayResponseCompound-objects as value to a dart map
  static Map<String, List<PaymentgatewayResponseCompound>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PaymentgatewayResponseCompound>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PaymentgatewayResponseCompound.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
