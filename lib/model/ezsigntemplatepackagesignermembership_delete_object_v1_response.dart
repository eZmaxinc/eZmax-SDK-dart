...
class EzsigntemplatepackagesignermembershipDeleteObjectV1Response {
  ...
  @override
  String toString() => 'EzsigntemplatepackagesignermembershipDeleteObjectV1Response[objDebugPayload=$objDebugPayload, objDebug=$objDebug, mPayload=$mPayload]';
  ...
  static EzsigntemplatepackagesignermembershipDeleteObjectV1Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "EzsigntemplatepackagesignermembershipDeleteObjectV1Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "EzsigntemplatepackagesignermembershipDeleteObjectV1Response[objDebugPayload]" has a null value in JSON.');
        assert(json.containsKey(r'mPayload'), 'Required key "EzsigntemplatepackagesignermembershipDeleteObjectV1Response[mPayload]" is missing from JSON.');
        assert(json[r'mPayload'] != null, 'Required key "EzsigntemplatepackagesignermembershipDeleteObjectV1Response[mPayload]" has a null value in JSON.');
        return true;
      }());
