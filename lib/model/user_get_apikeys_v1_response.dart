...
class UserGetApikeysV1Response {
  ...
  static UserGetApikeysV1Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "UserGetApikeysV1Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "UserGetApikeysV1Response[objDebugPayload]" has a null value in JSON.');
        assert(json.containsKey(r'mPayload'), 'Required key "UserGetApikeysV1Response[mPayload]" is missing from JSON.');
        assert(json[r'mPayload'] != null, 'Required key "UserGetApikeysV1Response[mPayload]" has a null value in JSON.');
        return true;
      }());
