...
class EzsigndocumentCreateObjectV2Request {
  ...
  static EzsigndocumentCreateObjectV2Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsigndocument'), 'Required key "EzsigndocumentCreateObjectV2Request[a_objEzsigndocument]" is missing from JSON.');
        assert(json[r'a_objEzsigndocument'] != null, 'Required key "EzsigndocumentCreateObjectV2Request[a_objEzsigndocument]" has a null value in JSON.');
        return true;
      }());
