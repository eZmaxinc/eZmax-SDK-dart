...
class ElectronicfundstransferImportIntoEDMV1Request {
  ...
  static ElectronicfundstransferImportIntoEDMV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objAttachment'), 'Required key "ElectronicfundstransferImportIntoEDMV1Request[a_objAttachment]" is missing from JSON.');
        assert(json[r'a_objAttachment'] != null, 'Required key "ElectronicfundstransferImportIntoEDMV1Request[a_objAttachment]" has a null value in JSON.');
        return true;
      }());
