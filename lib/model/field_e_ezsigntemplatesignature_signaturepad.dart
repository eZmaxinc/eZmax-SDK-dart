...
class FieldEEzsigntemplatesignatureSignaturepad {
  ...
  const FieldEEzsigntemplatesignatureSignaturepad._(this.value);
  ...
  static const topaz = FieldEEzsigntemplatesignatureSignaturepad._(r'Topaz');

  /// List of all possible values in this [enum][FieldEEzsigntemplatesignatureSignaturepad].
  static const values = <FieldEEzsigntemplatesignatureSignaturepad>[
    topaz,
  ];
...
class FieldEEzsigntemplatesignatureSignaturepadTypeTransformer {
  ...
  String encode(FieldEEzsigntemplatesignatureSignaturepad data) => data.value;

  /// Decodes a [dynamic value][data] to a FieldEEzsigntemplatesignatureSignaturepad.
  ///
  ...
  /// Singleton [FieldEEzsigntemplatesignatureSignaturepadTypeTransformer] instance.
