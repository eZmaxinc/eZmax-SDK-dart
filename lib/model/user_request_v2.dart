...
class UserRequestV2 {
  /// Returns a new [UserRequestV2] instance.
  UserRequestV2({
    this.pkiUserID,
    this.fkiAgentID,
    this.fkiBrokerID,
  ...
  /// Returns a new [UserRequestV2] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UserRequestV2? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<UserRequestV2> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <UserRequestV2>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UserRequestV2.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UserRequestV2> mapFromJson(dynamic json) {
    final map = <String, UserRequestV2>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UserRequestV2.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of UserRequestV2-objects as value to a dart map
  static Map<String, List<UserRequestV2>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UserRequestV2>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UserRequestV2.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
