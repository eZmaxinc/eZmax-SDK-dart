...
class FieldEInscriptionRemunerationreferencetype {
  ...
  const FieldEInscriptionRemunerationreferencetype._(this.value);
  ...
  static const percentage = FieldEInscriptionRemunerationreferencetype._(r'Percentage');
  static const dollars = FieldEInscriptionRemunerationreferencetype._(r'Dollars');

  /// List of all possible values in this [enum][FieldEInscriptionRemunerationreferencetype].
  static const values = <FieldEInscriptionRemunerationreferencetype>[
    percentage,
    dollars,
  ];
...
class FieldEInscriptionRemunerationreferencetypeTypeTransformer {
  ...
  String encode(FieldEInscriptionRemunerationreferencetype data) => data.value;

  /// Decodes a [dynamic value][data] to a FieldEInscriptionRemunerationreferencetype.
  ///
  ...
  /// Singleton [FieldEInscriptionRemunerationreferencetypeTypeTransformer] instance.
