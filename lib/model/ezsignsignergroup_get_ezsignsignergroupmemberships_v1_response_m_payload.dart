...
class EzsignsignergroupGetEzsignsignergroupmembershipsV1ResponseMPayload {
  ...
  static EzsignsignergroupGetEzsignsignergroupmembershipsV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsignsignergroupmembership'), 'Required key "EzsignsignergroupGetEzsignsignergroupmembershipsV1ResponseMPayload[a_objEzsignsignergroupmembership]" is missing from JSON.');
        assert(json[r'a_objEzsignsignergroupmembership'] != null, 'Required key "EzsignsignergroupGetEzsignsignergroupmembershipsV1ResponseMPayload[a_objEzsignsignergroupmembership]" has a null value in JSON.');
        return true;
      }());
