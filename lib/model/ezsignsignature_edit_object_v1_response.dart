...
class EzsignsignatureEditObjectV1Response {
  ...
  static EzsignsignatureEditObjectV1Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EzsignsignatureEditObjectV1Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EzsignsignatureEditObjectV1Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<EzsignsignatureEditObjectV1Response> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsignsignatureEditObjectV1Response>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsignsignatureEditObjectV1Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsignsignatureEditObjectV1Response> mapFromJson(dynamic json) {
    final map = <String, EzsignsignatureEditObjectV1Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsignsignatureEditObjectV1Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<EzsignsignatureEditObjectV1Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsignsignatureEditObjectV1Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsignsignatureEditObjectV1Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
