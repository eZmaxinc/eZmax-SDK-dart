...
class EzsigntemplatesignerEditObjectV1Request {
  ...
  static EzsigntemplatesignerEditObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objEzsigntemplatesigner'), 'Required key "EzsigntemplatesignerEditObjectV1Request[objEzsigntemplatesigner]" is missing from JSON.');
        assert(json[r'objEzsigntemplatesigner'] != null, 'Required key "EzsigntemplatesignerEditObjectV1Request[objEzsigntemplatesigner]" has a null value in JSON.');
        return true;
      }());
