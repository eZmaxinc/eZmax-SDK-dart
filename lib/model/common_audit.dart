...
class CommonAudit {
  ...
  static CommonAudit? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objAuditdetailCreated'), 'Required key "CommonAudit[objAuditdetailCreated]" is missing from JSON.');
        assert(json[r'objAuditdetailCreated'] != null, 'Required key "CommonAudit[objAuditdetailCreated]" has a null value in JSON.');
        return true;
      }());
