...
class CommunicationrecipientResponse {
  /// Returns a new [CommunicationrecipientResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CommunicationrecipientResponse &&
  ...
  /// Returns a new [CommunicationrecipientResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CommunicationrecipientResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CommunicationrecipientResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CommunicationrecipientResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CommunicationrecipientResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CommunicationrecipientResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CommunicationrecipientResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CommunicationrecipientResponse> mapFromJson(dynamic json) {
    final map = <String, CommunicationrecipientResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CommunicationrecipientResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CommunicationrecipientResponse-objects as value to a dart map
  static Map<String, List<CommunicationrecipientResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CommunicationrecipientResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CommunicationrecipientResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
