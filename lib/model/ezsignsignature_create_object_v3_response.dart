...
class EzsignsignatureCreateObjectV3Response {
  ...
  static EzsignsignatureCreateObjectV3Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "EzsignsignatureCreateObjectV3Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "EzsignsignatureCreateObjectV3Response[objDebugPayload]" has a null value in JSON.');
        assert(json.containsKey(r'mPayload'), 'Required key "EzsignsignatureCreateObjectV3Response[mPayload]" is missing from JSON.');
        assert(json[r'mPayload'] != null, 'Required key "EzsignsignatureCreateObjectV3Response[mPayload]" has a null value in JSON.');
        return true;
      }());
