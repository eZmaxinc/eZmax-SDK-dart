...
class WebhookSendWebhookV1Request {
  ...
  static WebhookSendWebhookV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'eWebhookModule'), 'Required key "WebhookSendWebhookV1Request[eWebhookModule]" is missing from JSON.');
        assert(json[r'eWebhookModule'] != null, 'Required key "WebhookSendWebhookV1Request[eWebhookModule]" has a null value in JSON.');
        return true;
      }());
