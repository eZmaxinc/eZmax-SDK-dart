...
class EzsigndocumentApplyEzsigntemplateV2Response {
  ...
  @override
  String toString() => 'EzsigndocumentApplyEzsigntemplateV2Response[objDebugPayload=$objDebugPayload, objDebug=$objDebug, aObjWarning=$aObjWarning]';
  ...
  static EzsigndocumentApplyEzsigntemplateV2Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "EzsigndocumentApplyEzsigntemplateV2Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "EzsigndocumentApplyEzsigntemplateV2Response[objDebugPayload]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<EzsigndocumentApplyEzsigntemplateV2Response> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigndocumentApplyEzsigntemplateV2Response>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigndocumentApplyEzsigntemplateV2Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigndocumentApplyEzsigntemplateV2Response> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = EzsigndocumentApplyEzsigntemplateV2Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<EzsigndocumentApplyEzsigntemplateV2Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigndocumentApplyEzsigntemplateV2Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigndocumentApplyEzsigntemplateV2Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
