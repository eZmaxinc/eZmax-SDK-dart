...
class EzsigntemplatesignatureResponseCompoundV3 {
  /// Returns a new [EzsigntemplatesignatureResponseCompoundV3] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsigntemplatesignatureResponseCompoundV3 &&
  ...
  /// Returns a new [EzsigntemplatesignatureResponseCompoundV3] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsigntemplatesignatureResponseCompoundV3? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EzsigntemplatesignatureResponseCompoundV3[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EzsigntemplatesignatureResponseCompoundV3[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return EzsigntemplatesignatureResponseCompoundV3(
        ...
        aObjEzsigntemplatesignaturecustomdate: EzsigntemplatesignaturecustomdateResponseV2.listFromJson(json[r'a_objEzsigntemplatesignaturecustomdate']),
  ...
  static List<EzsigntemplatesignatureResponseCompoundV3> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigntemplatesignatureResponseCompoundV3>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigntemplatesignatureResponseCompoundV3.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigntemplatesignatureResponseCompoundV3> mapFromJson(dynamic json) {
    final map = <String, EzsigntemplatesignatureResponseCompoundV3>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplatesignatureResponseCompoundV3.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigntemplatesignatureResponseCompoundV3-objects as value to a dart map
  static Map<String, List<EzsigntemplatesignatureResponseCompoundV3>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigntemplatesignatureResponseCompoundV3>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplatesignatureResponseCompoundV3.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
