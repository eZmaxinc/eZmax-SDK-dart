...
class EzsigntemplateGetObjectV3ResponseMPayload {
  ...
  static EzsigntemplateGetObjectV3ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objEzsigntemplate'), 'Required key "EzsigntemplateGetObjectV3ResponseMPayload[objEzsigntemplate]" is missing from JSON.');
        assert(json[r'objEzsigntemplate'] != null, 'Required key "EzsigntemplateGetObjectV3ResponseMPayload[objEzsigntemplate]" has a null value in JSON.');
        return true;
      }());
