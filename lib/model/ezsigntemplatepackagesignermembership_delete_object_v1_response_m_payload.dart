...
class EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload {
  ...
  static EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'bEzsigntemplatepackageNeedvalidation'), 'Required key "EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload[bEzsigntemplatepackageNeedvalidation]" is missing from JSON.');
        assert(json[r'bEzsigntemplatepackageNeedvalidation'] != null, 'Required key "EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload[bEzsigntemplatepackageNeedvalidation]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsignbulksendNeedvalidation'), 'Required key "EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload[bEzsignbulksendNeedvalidation]" is missing from JSON.');
        assert(json[r'bEzsignbulksendNeedvalidation'] != null, 'Required key "EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload[bEzsignbulksendNeedvalidation]" has a null value in JSON.');
        return true;
      }());
