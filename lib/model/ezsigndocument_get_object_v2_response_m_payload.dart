...
class EzsigndocumentGetObjectV2ResponseMPayload {
  ...
  static EzsigndocumentGetObjectV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objEzsigndocument'), 'Required key "EzsigndocumentGetObjectV2ResponseMPayload[objEzsigndocument]" is missing from JSON.');
        assert(json[r'objEzsigndocument'] != null, 'Required key "EzsigndocumentGetObjectV2ResponseMPayload[objEzsigndocument]" has a null value in JSON.');
        return true;
      }());
