...
class SubnetCreateObjectV1Request {
  ...
  static SubnetCreateObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objSubnet'), 'Required key "SubnetCreateObjectV1Request[a_objSubnet]" is missing from JSON.');
        assert(json[r'a_objSubnet'] != null, 'Required key "SubnetCreateObjectV1Request[a_objSubnet]" has a null value in JSON.');
        return true;
      }());
