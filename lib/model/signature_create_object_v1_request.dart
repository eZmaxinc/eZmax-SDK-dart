...
class SignatureCreateObjectV1Request {
  ...
  static SignatureCreateObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objSignature'), 'Required key "SignatureCreateObjectV1Request[a_objSignature]" is missing from JSON.');
        assert(json[r'a_objSignature'] != null, 'Required key "SignatureCreateObjectV1Request[a_objSignature]" has a null value in JSON.');
        return true;
      }());
