...
class AuthenticationexternalResponseCompound {
  /// Returns a new [AuthenticationexternalResponseCompound] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AuthenticationexternalResponseCompound &&
  ...
  /// Returns a new [AuthenticationexternalResponseCompound] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AuthenticationexternalResponseCompound? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<AuthenticationexternalResponseCompound> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AuthenticationexternalResponseCompound>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AuthenticationexternalResponseCompound.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AuthenticationexternalResponseCompound> mapFromJson(dynamic json) {
    final map = <String, AuthenticationexternalResponseCompound>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AuthenticationexternalResponseCompound.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AuthenticationexternalResponseCompound-objects as value to a dart map
  static Map<String, List<AuthenticationexternalResponseCompound>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AuthenticationexternalResponseCompound>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AuthenticationexternalResponseCompound.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
