...
enum FieldEEzsigntemplateglobalannotationHorizontalalignment {
  center._(r'Center'),
  left._(r'Left'),
  right._(r'Right'),
  ;
  ...
  const FieldEEzsigntemplateglobalannotationHorizontalalignment._(this._value);
  ...
  /// Returns the instance of [FieldEEzsigntemplateglobalannotationHorizontalalignment] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [FieldEEzsigntemplateglobalannotationHorizontalalignment]
...
class FieldEEzsigntemplateglobalannotationHorizontalalignmentTypeTransformer {
  ...
  /// Encodes this enum as a value suitable for JSON.
  String encode(FieldEEzsigntemplateglobalannotationHorizontalalignment data) => data._value;
  ...
  FieldEEzsigntemplateglobalannotationHorizontalalignment? decode(dynamic data, {bool allowNull = true}) {
    if (data is FieldEEzsigntemplateglobalannotationHorizontalalignment) {
      return data;
    }
    if (data != null) {
      switch (data) {
