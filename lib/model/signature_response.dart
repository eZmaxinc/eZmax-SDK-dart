...
class SignatureResponse {
  ...
  /// Returns a new [SignatureResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SignatureResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiSignatureID'), 'Required key "SignatureResponse[pkiSignatureID]" is missing from JSON.');
        assert(json[r'pkiSignatureID'] != null, 'Required key "SignatureResponse[pkiSignatureID]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<SignatureResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SignatureResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SignatureResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SignatureResponse> mapFromJson(dynamic json) {
    final map = <String, SignatureResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SignatureResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SignatureResponse-objects as value to a dart map
  static Map<String, List<SignatureResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SignatureResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SignatureResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
