...
class PermissionResponseCompound {
  ...
  static PermissionResponseCompound? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiPermissionID'), 'Required key "PermissionResponseCompound[pkiPermissionID]" is missing from JSON.');
        assert(json[r'pkiPermissionID'] != null, 'Required key "PermissionResponseCompound[pkiPermissionID]" has a null value in JSON.');
        assert(json.containsKey(r'fkiModulesectionID'), 'Required key "PermissionResponseCompound[fkiModulesectionID]" is missing from JSON.');
        assert(json[r'fkiModulesectionID'] != null, 'Required key "PermissionResponseCompound[fkiModulesectionID]" has a null value in JSON.');
        return true;
      }());
