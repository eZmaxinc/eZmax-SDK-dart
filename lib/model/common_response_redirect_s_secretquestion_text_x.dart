...
class CommonResponseRedirectSSecretquestionTextX {
  ...
  static CommonResponseRedirectSSecretquestionTextX? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'sSecretquestionTextX'), 'Required key "CommonResponseRedirectSSecretquestionTextX[sSecretquestionTextX]" is missing from JSON.');
        assert(json[r'sSecretquestionTextX'] != null, 'Required key "CommonResponseRedirectSSecretquestionTextX[sSecretquestionTextX]" has a null value in JSON.');
        return true;
      }());
