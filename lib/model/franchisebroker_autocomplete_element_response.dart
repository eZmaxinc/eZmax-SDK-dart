...
class FranchisebrokerAutocompleteElementResponse {
  ...
  Map<String, dynamic> toJson() {
    final _json = <String, dynamic>{};
      _json[r'sFranchisebrokerName'] = sFranchisebrokerName;
      _json[r'pkiFranchisebrokerID'] = pkiFranchisebrokerID;
      _json[r'bFranchisebrokerIsactive'] = bFranchisebrokerIsactive;
    return _json;
  }
  ...
  static Map<String, List<FranchisebrokerAutocompleteElementResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FranchisebrokerAutocompleteElementResponse.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
