...
class EzsigndocumentCreateEzsignelementsPositionedByWordV1ResponseMPayload {
  ...
  static EzsigndocumentCreateEzsignelementsPositionedByWordV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiEzsignsignatureID'), 'Required key "EzsigndocumentCreateEzsignelementsPositionedByWordV1ResponseMPayload[a_pkiEzsignsignatureID]" is missing from JSON.');
        assert(json[r'a_pkiEzsignsignatureID'] != null, 'Required key "EzsigndocumentCreateEzsignelementsPositionedByWordV1ResponseMPayload[a_pkiEzsignsignatureID]" has a null value in JSON.');
        assert(json.containsKey(r'a_pkiEzsignformfieldgroupID'), 'Required key "EzsigndocumentCreateEzsignelementsPositionedByWordV1ResponseMPayload[a_pkiEzsignformfieldgroupID]" is missing from JSON.');
        assert(json[r'a_pkiEzsignformfieldgroupID'] != null, 'Required key "EzsigndocumentCreateEzsignelementsPositionedByWordV1ResponseMPayload[a_pkiEzsignformfieldgroupID]" has a null value in JSON.');
        return true;
      }());
