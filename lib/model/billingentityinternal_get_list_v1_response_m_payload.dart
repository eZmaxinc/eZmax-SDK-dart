...
class BillingentityinternalGetListV1ResponseMPayload {
  ...
  /// Returns a new [BillingentityinternalGetListV1ResponseMPayload] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static BillingentityinternalGetListV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'iRowReturned'), 'Required key "BillingentityinternalGetListV1ResponseMPayload[iRowReturned]" is missing from JSON.');
        assert(json[r'iRowReturned'] != null, 'Required key "BillingentityinternalGetListV1ResponseMPayload[iRowReturned]" has a null value in JSON.');
        assert(json.containsKey(r'iRowFiltered'), 'Required key "BillingentityinternalGetListV1ResponseMPayload[iRowFiltered]" is missing from JSON.');
        assert(json[r'iRowFiltered'] != null, 'Required key "BillingentityinternalGetListV1ResponseMPayload[iRowFiltered]" has a null value in JSON.');
        assert(json.containsKey(r'a_objBillingentityinternal'), 'Required key "BillingentityinternalGetListV1ResponseMPayload[a_objBillingentityinternal]" is missing from JSON.');
        assert(json[r'a_objBillingentityinternal'] != null, 'Required key "BillingentityinternalGetListV1ResponseMPayload[a_objBillingentityinternal]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<BillingentityinternalGetListV1ResponseMPayload> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = BillingentityinternalGetListV1ResponseMPayload.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, BillingentityinternalGetListV1ResponseMPayload> mapFromJson(dynamic json) {
    final map = <String, BillingentityinternalGetListV1ResponseMPayload>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = BillingentityinternalGetListV1ResponseMPayload.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of BillingentityinternalGetListV1ResponseMPayload-objects as value to a dart map
