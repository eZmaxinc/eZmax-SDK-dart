...
class WebsocketRequestServerGetWebsocketIDV1 {
  ...
  static WebsocketRequestServerGetWebsocketIDV1? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'eWebsocketMessagetype'), 'Required key "WebsocketRequestServerGetWebsocketIDV1[eWebsocketMessagetype]" is missing from JSON.');
        assert(json[r'eWebsocketMessagetype'] != null, 'Required key "WebsocketRequestServerGetWebsocketIDV1[eWebsocketMessagetype]" has a null value in JSON.');
        return true;
      }());
