...
class EzsignfolderGetActionableElementsV1Response {
  ...
  static EzsignfolderGetActionableElementsV1Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "EzsignfolderGetActionableElementsV1Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "EzsignfolderGetActionableElementsV1Response[objDebugPayload]" has a null value in JSON.');
        assert(json.containsKey(r'mPayload'), 'Required key "EzsignfolderGetActionableElementsV1Response[mPayload]" is missing from JSON.');
        assert(json[r'mPayload'] != null, 'Required key "EzsignfolderGetActionableElementsV1Response[mPayload]" has a null value in JSON.');
        return true;
      }());
