...
class EzsignbulksendRequest {
  /// Returns a new [EzsignbulksendRequest] instance.
  ...
  static EzsignbulksendRequest? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<EzsignbulksendRequest> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsignbulksendRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsignbulksendRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsignbulksendRequest> mapFromJson(dynamic json) {
    final map = <String, EzsignbulksendRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsignbulksendRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsignbulksendRequest-objects as value to a dart map
  static Map<String, List<EzsignbulksendRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsignbulksendRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsignbulksendRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
