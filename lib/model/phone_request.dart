...
class PhoneRequest {
  ...
  static PhoneRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiPhonetypeID'), 'Required key "PhoneRequest[fkiPhonetypeID]" is missing from JSON.');
        assert(json[r'fkiPhonetypeID'] != null, 'Required key "PhoneRequest[fkiPhonetypeID]" has a null value in JSON.');
        return true;
      }());
