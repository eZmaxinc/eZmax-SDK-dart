...
class EzsigntemplatesignerResponseCompoundV3 {
  /// Returns a new [EzsigntemplatesignerResponseCompoundV3] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EzsigntemplatesignerResponseCompoundV3 &&
  ...
  @override
  String toString() => 'EzsigntemplatesignerResponseCompoundV3[pkiEzsigntemplatesignerID=$pkiEzsigntemplatesignerID, fkiEzsigntemplateID=$fkiEzsigntemplateID, fkiUserID=$fkiUserID, fkiUsergroupID=$fkiUsergroupID, fkiEzdoctemplatedocumentID=$fkiEzdoctemplatedocumentID, eEzsigntemplatesignerRole=$eEzsigntemplatesignerRole, eEzsigntemplatesignerMapping=$eEzsigntemplatesignerMapping, sEzsigntemplatesignerDescription=$sEzsigntemplatesignerDescription, sUserName=$sUserName, sUsergroupNameX=$sUsergroupNameX]';
  ...
  /// Returns a new [EzsigntemplatesignerResponseCompoundV3] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EzsigntemplatesignerResponseCompoundV3? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsigntemplatesignerID'), 'Required key "EzsigntemplatesignerResponseCompoundV3[pkiEzsigntemplatesignerID]" is missing from JSON.');
        assert(json[r'pkiEzsigntemplatesignerID'] != null, 'Required key "EzsigntemplatesignerResponseCompoundV3[pkiEzsigntemplatesignerID]" has a null value in JSON.');
        assert(json.containsKey(r'fkiEzsigntemplateID'), 'Required key "EzsigntemplatesignerResponseCompoundV3[fkiEzsigntemplateID]" is missing from JSON.');
        assert(json[r'fkiEzsigntemplateID'] != null, 'Required key "EzsigntemplatesignerResponseCompoundV3[fkiEzsigntemplateID]" has a null value in JSON.');
        assert(json.containsKey(r'sEzsigntemplatesignerDescription'), 'Required key "EzsigntemplatesignerResponseCompoundV3[sEzsigntemplatesignerDescription]" is missing from JSON.');
        assert(json[r'sEzsigntemplatesignerDescription'] != null, 'Required key "EzsigntemplatesignerResponseCompoundV3[sEzsigntemplatesignerDescription]" has a null value in JSON.');
        return true;
      }());

      return EzsigntemplatesignerResponseCompoundV3(
  ...
  static List<EzsigntemplatesignerResponseCompoundV3> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EzsigntemplatesignerResponseCompoundV3>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EzsigntemplatesignerResponseCompoundV3.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EzsigntemplatesignerResponseCompoundV3> mapFromJson(dynamic json) {
    final map = <String, EzsigntemplatesignerResponseCompoundV3>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplatesignerResponseCompoundV3.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EzsigntemplatesignerResponseCompoundV3-objects as value to a dart map
  static Map<String, List<EzsigntemplatesignerResponseCompoundV3>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EzsigntemplatesignerResponseCompoundV3>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EzsigntemplatesignerResponseCompoundV3.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
