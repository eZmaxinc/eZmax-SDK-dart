...
class TaxassignmentGetAutocompleteV2ResponseMPayload {
  ...
  static TaxassignmentGetAutocompleteV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objTaxassignment'), 'Required key "TaxassignmentGetAutocompleteV2ResponseMPayload[a_objTaxassignment]" is missing from JSON.');
        assert(json[r'a_objTaxassignment'] != null, 'Required key "TaxassignmentGetAutocompleteV2ResponseMPayload[a_objTaxassignment]" has a null value in JSON.');
        return true;
      }());
