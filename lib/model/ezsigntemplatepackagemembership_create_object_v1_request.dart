...
class EzsigntemplatepackagemembershipCreateObjectV1Request {
  ...
  static EzsigntemplatepackagemembershipCreateObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsigntemplatepackagemembership'), 'Required key "EzsigntemplatepackagemembershipCreateObjectV1Request[a_objEzsigntemplatepackagemembership]" is missing from JSON.');
        assert(json[r'a_objEzsigntemplatepackagemembership'] != null, 'Required key "EzsigntemplatepackagemembershipCreateObjectV1Request[a_objEzsigntemplatepackagemembership]" has a null value in JSON.');
        return true;
      }());
