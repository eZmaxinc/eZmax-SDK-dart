...
class EzsigndocumentGetEzsignpagesV1ResponseMPayload {
  ...
  static EzsigndocumentGetEzsignpagesV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsignpage'), 'Required key "EzsigndocumentGetEzsignpagesV1ResponseMPayload[a_objEzsignpage]" is missing from JSON.');
        assert(json[r'a_objEzsignpage'] != null, 'Required key "EzsigndocumentGetEzsignpagesV1ResponseMPayload[a_objEzsignpage]" has a null value in JSON.');
        return true;
      }());
  ...
  static Map<String, List<EzsigndocumentGetEzsignpagesV1ResponseMPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsigndocumentGetEzsignpagesV1ResponseMPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
