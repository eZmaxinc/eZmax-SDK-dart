...
class EzsignbulksendGetListV1ResponseMPayload {
  ...
  static EzsignbulksendGetListV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'iRowReturned'), 'Required key "EzsignbulksendGetListV1ResponseMPayload[iRowReturned]" is missing from JSON.');
        assert(json[r'iRowReturned'] != null, 'Required key "EzsignbulksendGetListV1ResponseMPayload[iRowReturned]" has a null value in JSON.');
        assert(json.containsKey(r'iRowFiltered'), 'Required key "EzsignbulksendGetListV1ResponseMPayload[iRowFiltered]" is missing from JSON.');
        assert(json[r'iRowFiltered'] != null, 'Required key "EzsignbulksendGetListV1ResponseMPayload[iRowFiltered]" has a null value in JSON.');
        assert(json.containsKey(r'a_objEzsignbulksend'), 'Required key "EzsignbulksendGetListV1ResponseMPayload[a_objEzsignbulksend]" is missing from JSON.');
        assert(json[r'a_objEzsignbulksend'] != null, 'Required key "EzsignbulksendGetListV1ResponseMPayload[a_objEzsignbulksend]" has a null value in JSON.');
        return true;
      }());
