...
class EzsignsignergroupmembershipCreateObjectV1Response {
  ...
  static EzsignsignergroupmembershipCreateObjectV1Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "EzsignsignergroupmembershipCreateObjectV1Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "EzsignsignergroupmembershipCreateObjectV1Response[objDebugPayload]" has a null value in JSON.');
        assert(json.containsKey(r'mPayload'), 'Required key "EzsignsignergroupmembershipCreateObjectV1Response[mPayload]" is missing from JSON.');
        assert(json[r'mPayload'] != null, 'Required key "EzsignsignergroupmembershipCreateObjectV1Response[mPayload]" has a null value in JSON.');
        return true;
      }());
