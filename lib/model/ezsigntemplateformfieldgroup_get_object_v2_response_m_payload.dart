...
class EzsigntemplateformfieldgroupGetObjectV2ResponseMPayload {
  ...
  Map<String, dynamic> toJson() {
    final _json = <String, dynamic>{};
      _json[r'objEzsigntemplateformfieldgroup'] = objEzsigntemplateformfieldgroup;
    return _json;
  }
  ...
  static Map<String, List<EzsigntemplateformfieldgroupGetObjectV2ResponseMPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EzsigntemplateformfieldgroupGetObjectV2ResponseMPayload.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
