...
class UserCreateEzsignuserV1ResponseAllOf {
  ...
  static List<UserCreateEzsignuserV1ResponseAllOf> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(UserCreateEzsignuserV1ResponseAllOf.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <UserCreateEzsignuserV1ResponseAllOf>[];
  ...
  static Map<String, UserCreateEzsignuserV1ResponseAllOf> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = UserCreateEzsignuserV1ResponseAllOf.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of UserCreateEzsignuserV1ResponseAllOf-objects as value to a dart map
  static Map<String, List<UserCreateEzsignuserV1ResponseAllOf>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<UserCreateEzsignuserV1ResponseAllOf>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = UserCreateEzsignuserV1ResponseAllOf.listFromJson(
            value,
