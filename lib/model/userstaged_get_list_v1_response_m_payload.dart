...
class UserstagedGetListV1ResponseMPayload {
  ...
  static UserstagedGetListV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'iRowReturned'), 'Required key "UserstagedGetListV1ResponseMPayload[iRowReturned]" is missing from JSON.');
        assert(json[r'iRowReturned'] != null, 'Required key "UserstagedGetListV1ResponseMPayload[iRowReturned]" has a null value in JSON.');
        assert(json.containsKey(r'iRowFiltered'), 'Required key "UserstagedGetListV1ResponseMPayload[iRowFiltered]" is missing from JSON.');
        assert(json[r'iRowFiltered'] != null, 'Required key "UserstagedGetListV1ResponseMPayload[iRowFiltered]" has a null value in JSON.');
        assert(json.containsKey(r'a_objUserstaged'), 'Required key "UserstagedGetListV1ResponseMPayload[a_objUserstaged]" is missing from JSON.');
        assert(json[r'a_objUserstaged'] != null, 'Required key "UserstagedGetListV1ResponseMPayload[a_objUserstaged]" has a null value in JSON.');
        return true;
      }());
