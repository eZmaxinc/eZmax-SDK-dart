...
class PaymentgatewayGetListV1ResponseMPayload {
  ...
  static PaymentgatewayGetListV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'iRowReturned'), 'Required key "PaymentgatewayGetListV1ResponseMPayload[iRowReturned]" is missing from JSON.');
        assert(json[r'iRowReturned'] != null, 'Required key "PaymentgatewayGetListV1ResponseMPayload[iRowReturned]" has a null value in JSON.');
        assert(json.containsKey(r'iRowFiltered'), 'Required key "PaymentgatewayGetListV1ResponseMPayload[iRowFiltered]" is missing from JSON.');
        assert(json[r'iRowFiltered'] != null, 'Required key "PaymentgatewayGetListV1ResponseMPayload[iRowFiltered]" has a null value in JSON.');
        assert(json.containsKey(r'a_objPaymentgateway'), 'Required key "PaymentgatewayGetListV1ResponseMPayload[a_objPaymentgateway]" is missing from JSON.');
        assert(json[r'a_objPaymentgateway'] != null, 'Required key "PaymentgatewayGetListV1ResponseMPayload[a_objPaymentgateway]" has a null value in JSON.');
        return true;
      }());
