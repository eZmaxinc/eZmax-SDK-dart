...
class UsergroupGetUsergroupmembershipsV1ResponseMPayload {
  ...
  static UsergroupGetUsergroupmembershipsV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objUsergroupmembership'), 'Required key "UsergroupGetUsergroupmembershipsV1ResponseMPayload[a_objUsergroupmembership]" is missing from JSON.');
        assert(json[r'a_objUsergroupmembership'] != null, 'Required key "UsergroupGetUsergroupmembershipsV1ResponseMPayload[a_objUsergroupmembership]" has a null value in JSON.');
        return true;
      }());
