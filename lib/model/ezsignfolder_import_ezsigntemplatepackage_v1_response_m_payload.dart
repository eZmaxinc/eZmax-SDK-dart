...
class EzsignfolderImportEzsigntemplatepackageV1ResponseMPayload {
  ...
  static EzsignfolderImportEzsigntemplatepackageV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsigndocument'), 'Required key "EzsignfolderImportEzsigntemplatepackageV1ResponseMPayload[a_objEzsigndocument]" is missing from JSON.');
        assert(json[r'a_objEzsigndocument'] != null, 'Required key "EzsignfolderImportEzsigntemplatepackageV1ResponseMPayload[a_objEzsigndocument]" has a null value in JSON.');
        return true;
      }());
  ...
  static Map<String, List<EzsignfolderImportEzsigntemplatepackageV1ResponseMPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EzsignfolderImportEzsigntemplatepackageV1ResponseMPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
