...
class EzsigntemplatedocumentGetEzsigntemplatedocumentpagerecognitionsV1ResponseMPayload {
  ...
  static EzsigntemplatedocumentGetEzsigntemplatedocumentpagerecognitionsV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_objEzsigntemplatedocumentpagerecognition'), 'Required key "EzsigntemplatedocumentGetEzsigntemplatedocumentpagerecognitionsV1ResponseMPayload[a_objEzsigntemplatedocumentpagerecognition]" is missing from JSON.');
        assert(json[r'a_objEzsigntemplatedocumentpagerecognition'] != null, 'Required key "EzsigntemplatedocumentGetEzsigntemplatedocumentpagerecognitionsV1ResponseMPayload[a_objEzsigntemplatedocumentpagerecognition]" has a null value in JSON.');
        return true;
      }());
