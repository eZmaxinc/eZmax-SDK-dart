...
class CustomEzsignfoldersignerassociationActionableElementResponseV2 {
  /// Returns a new [CustomEzsignfoldersignerassociationActionableElementResponseV2] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CustomEzsignfoldersignerassociationActionableElementResponseV2 &&
  ...
  /// Returns a new [CustomEzsignfoldersignerassociationActionableElementResponseV2] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CustomEzsignfoldersignerassociationActionableElementResponseV2? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'pkiEzsignfoldersignerassociationID'), 'Required key "CustomEzsignfoldersignerassociationActionableElementResponseV2[pkiEzsignfoldersignerassociationID]" is missing from JSON.');
        assert(json[r'pkiEzsignfoldersignerassociationID'] != null, 'Required key "CustomEzsignfoldersignerassociationActionableElementResponseV2[pkiEzsignfoldersignerassociationID]" has a null value in JSON.');
        assert(json.containsKey(r'fkiEzsignfolderID'), 'Required key "CustomEzsignfoldersignerassociationActionableElementResponseV2[fkiEzsignfolderID]" is missing from JSON.');
        assert(json[r'fkiEzsignfolderID'] != null, 'Required key "CustomEzsignfoldersignerassociationActionableElementResponseV2[fkiEzsignfolderID]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsignfoldersignerassociationDelayedsend'), 'Required key "CustomEzsignfoldersignerassociationActionableElementResponseV2[bEzsignfoldersignerassociationDelayedsend]" is missing from JSON.');
        assert(json[r'bEzsignfoldersignerassociationDelayedsend'] != null, 'Required key "CustomEzsignfoldersignerassociationActionableElementResponseV2[bEzsignfoldersignerassociationDelayedsend]" has a null value in JSON.');
        assert(json.containsKey(r'eEzsignfoldersignerassociationRole'), 'Required key "CustomEzsignfoldersignerassociationActionableElementResponseV2[eEzsignfoldersignerassociationRole]" is missing from JSON.');
        assert(json[r'eEzsignfoldersignerassociationRole'] != null, 'Required key "CustomEzsignfoldersignerassociationActionableElementResponseV2[eEzsignfoldersignerassociationRole]" has a null value in JSON.');
        assert(json.containsKey(r'tEzsignfoldersignerassociationMessage'), 'Required key "CustomEzsignfoldersignerassociationActionableElementResponseV2[tEzsignfoldersignerassociationMessage]" is missing from JSON.');
        assert(json[r'tEzsignfoldersignerassociationMessage'] != null, 'Required key "CustomEzsignfoldersignerassociationActionableElementResponseV2[tEzsignfoldersignerassociationMessage]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsignfoldersignerassociationAllowsigninginperson'), 'Required key "CustomEzsignfoldersignerassociationActionableElementResponseV2[bEzsignfoldersignerassociationAllowsigninginperson]" is missing from JSON.');
        assert(json[r'bEzsignfoldersignerassociationAllowsigninginperson'] != null, 'Required key "CustomEzsignfoldersignerassociationActionableElementResponseV2[bEzsignfoldersignerassociationAllowsigninginperson]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsignfoldersignerassociationHasactionableelementsCurrent'), 'Required key "CustomEzsignfoldersignerassociationActionableElementResponseV2[bEzsignfoldersignerassociationHasactionableelementsCurrent]" is missing from JSON.');
        assert(json[r'bEzsignfoldersignerassociationHasactionableelementsCurrent'] != null, 'Required key "CustomEzsignfoldersignerassociationActionableElementResponseV2[bEzsignfoldersignerassociationHasactionableelementsCurrent]" has a null value in JSON.');
        assert(json.containsKey(r'bEzsignfoldersignerassociationHasactionableelementsFuture'), 'Required key "CustomEzsignfoldersignerassociationActionableElementResponseV2[bEzsignfoldersignerassociationHasactionableelementsFuture]" is missing from JSON.');
        assert(json[r'bEzsignfoldersignerassociationHasactionableelementsFuture'] != null, 'Required key "CustomEzsignfoldersignerassociationActionableElementResponseV2[bEzsignfoldersignerassociationHasactionableelementsFuture]" has a null value in JSON.');
        return true;
      }());

      return CustomEzsignfoldersignerassociationActionableElementResponseV2(
  ...
  static List<CustomEzsignfoldersignerassociationActionableElementResponseV2> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CustomEzsignfoldersignerassociationActionableElementResponseV2>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CustomEzsignfoldersignerassociationActionableElementResponseV2.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CustomEzsignfoldersignerassociationActionableElementResponseV2> mapFromJson(dynamic json) {
    final map = <String, CustomEzsignfoldersignerassociationActionableElementResponseV2>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CustomEzsignfoldersignerassociationActionableElementResponseV2.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CustomEzsignfoldersignerassociationActionableElementResponseV2-objects as value to a dart map
  static Map<String, List<CustomEzsignfoldersignerassociationActionableElementResponseV2>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CustomEzsignfoldersignerassociationActionableElementResponseV2>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CustomEzsignfoldersignerassociationActionableElementResponseV2.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
