...
class UserRequestCompoundV2 {
  /// Returns a new [UserRequestCompoundV2] instance.
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  PhoneRequestCompoundV2? objPhoneHome;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UserRequestCompoundV2 &&
  ...
  /// Returns a new [UserRequestCompoundV2] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UserRequestCompoundV2? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'fkiCompanyIDDefault'), 'Required key "UserRequestCompoundV2[fkiCompanyIDDefault]" is missing from JSON.');
        assert(json[r'fkiCompanyIDDefault'] != null, 'Required key "UserRequestCompoundV2[fkiCompanyIDDefault]" has a null value in JSON.');
        assert(json.containsKey(r'fkiDepartmentIDDefault'), 'Required key "UserRequestCompoundV2[fkiDepartmentIDDefault]" is missing from JSON.');
        assert(json[r'fkiDepartmentIDDefault'] != null, 'Required key "UserRequestCompoundV2[fkiDepartmentIDDefault]" has a null value in JSON.');
        assert(json.containsKey(r'fkiTimezoneID'), 'Required key "UserRequestCompoundV2[fkiTimezoneID]" is missing from JSON.');
        assert(json[r'fkiTimezoneID'] != null, 'Required key "UserRequestCompoundV2[fkiTimezoneID]" has a null value in JSON.');
        assert(json.containsKey(r'fkiLanguageID'), 'Required key "UserRequestCompoundV2[fkiLanguageID]" is missing from JSON.');
        assert(json[r'fkiLanguageID'] != null, 'Required key "UserRequestCompoundV2[fkiLanguageID]" has a null value in JSON.');
        assert(json.containsKey(r'objEmail'), 'Required key "UserRequestCompoundV2[objEmail]" is missing from JSON.');
        assert(json[r'objEmail'] != null, 'Required key "UserRequestCompoundV2[objEmail]" has a null value in JSON.');
        assert(json.containsKey(r'fkiBillingentityinternalID'), 'Required key "UserRequestCompoundV2[fkiBillingentityinternalID]" is missing from JSON.');
        assert(json[r'fkiBillingentityinternalID'] != null, 'Required key "UserRequestCompoundV2[fkiBillingentityinternalID]" has a null value in JSON.');
        assert(json.containsKey(r'eUserType'), 'Required key "UserRequestCompoundV2[eUserType]" is missing from JSON.');
        assert(json[r'eUserType'] != null, 'Required key "UserRequestCompoundV2[eUserType]" has a null value in JSON.');
        assert(json.containsKey(r'eUserLogintype'), 'Required key "UserRequestCompoundV2[eUserLogintype]" is missing from JSON.');
        assert(json[r'eUserLogintype'] != null, 'Required key "UserRequestCompoundV2[eUserLogintype]" has a null value in JSON.');
        assert(json.containsKey(r'sUserFirstname'), 'Required key "UserRequestCompoundV2[sUserFirstname]" is missing from JSON.');
        assert(json[r'sUserFirstname'] != null, 'Required key "UserRequestCompoundV2[sUserFirstname]" has a null value in JSON.');
        assert(json.containsKey(r'sUserLastname'), 'Required key "UserRequestCompoundV2[sUserLastname]" is missing from JSON.');
        assert(json[r'sUserLastname'] != null, 'Required key "UserRequestCompoundV2[sUserLastname]" has a null value in JSON.');
        assert(json.containsKey(r'sUserLoginname'), 'Required key "UserRequestCompoundV2[sUserLoginname]" is missing from JSON.');
        assert(json[r'sUserLoginname'] != null, 'Required key "UserRequestCompoundV2[sUserLoginname]" has a null value in JSON.');
        assert(json.containsKey(r'eUserEzsignaccess'), 'Required key "UserRequestCompoundV2[eUserEzsignaccess]" is missing from JSON.');
        assert(json[r'eUserEzsignaccess'] != null, 'Required key "UserRequestCompoundV2[eUserEzsignaccess]" has a null value in JSON.');
        assert(json.containsKey(r'bUserIsactive'), 'Required key "UserRequestCompoundV2[bUserIsactive]" is missing from JSON.');
        assert(json[r'bUserIsactive'] != null, 'Required key "UserRequestCompoundV2[bUserIsactive]" has a null value in JSON.');
        return true;
      }());
      ...
      return UserRequestCompoundV2(
        ...
        objPhoneHome: PhoneRequestCompoundV2.fromJson(json[r'objPhoneHome']),
        objPhoneSMS: PhoneRequestCompoundV2.fromJson(json[r'objPhoneSMS']),
  ...
  static List<UserRequestCompoundV2> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <UserRequestCompoundV2>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UserRequestCompoundV2.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UserRequestCompoundV2> mapFromJson(dynamic json) {
    final map = <String, UserRequestCompoundV2>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UserRequestCompoundV2.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of UserRequestCompoundV2-objects as value to a dart map
  static Map<String, List<UserRequestCompoundV2>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UserRequestCompoundV2>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UserRequestCompoundV2.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
