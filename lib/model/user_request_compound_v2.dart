    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UserRequestCompoundV2[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UserRequestCompoundV2[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return UserRequestCompoundV2(
        ...
        objPhoneHome: PhoneRequestV2.fromJson(json[r'objPhoneHome']),
        objPhoneSMS: PhoneRequestV2.fromJson(json[r'objPhoneSMS']),
