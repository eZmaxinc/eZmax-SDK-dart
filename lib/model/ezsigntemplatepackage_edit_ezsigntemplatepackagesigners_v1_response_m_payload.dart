...
class EzsigntemplatepackageEditEzsigntemplatepackagesignersV1ResponseMPayload {
  ...
  static EzsigntemplatepackageEditEzsigntemplatepackagesignersV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'a_pkiEzsigntemplatepackagesignerID'), 'Required key "EzsigntemplatepackageEditEzsigntemplatepackagesignersV1ResponseMPayload[a_pkiEzsigntemplatepackagesignerID]" is missing from JSON.');
        assert(json[r'a_pkiEzsigntemplatepackagesignerID'] != null, 'Required key "EzsigntemplatepackageEditEzsigntemplatepackagesignersV1ResponseMPayload[a_pkiEzsigntemplatepackagesignerID]" has a null value in JSON.');
        return true;
      }());
