...
class DomainGetListV1ResponseMPayload {
  ...
  static DomainGetListV1ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'iRowReturned'), 'Required key "DomainGetListV1ResponseMPayload[iRowReturned]" is missing from JSON.');
        assert(json[r'iRowReturned'] != null, 'Required key "DomainGetListV1ResponseMPayload[iRowReturned]" has a null value in JSON.');
        assert(json.containsKey(r'iRowFiltered'), 'Required key "DomainGetListV1ResponseMPayload[iRowFiltered]" is missing from JSON.');
        assert(json[r'iRowFiltered'] != null, 'Required key "DomainGetListV1ResponseMPayload[iRowFiltered]" has a null value in JSON.');
        assert(json.containsKey(r'a_objDomain'), 'Required key "DomainGetListV1ResponseMPayload[a_objDomain]" is missing from JSON.');
        assert(json[r'a_objDomain'] != null, 'Required key "DomainGetListV1ResponseMPayload[a_objDomain]" has a null value in JSON.');
        return true;
      }());
