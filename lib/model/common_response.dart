...
class CommonResponse {
  ...
  static CommonResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "CommonResponse[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "CommonResponse[objDebugPayload]" has a null value in JSON.');
        return true;
      }());
