...
class EzsigntemplatepublicGetObjectV2ResponseMPayload {
  ...
  static EzsigntemplatepublicGetObjectV2ResponseMPayload? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objEzsigntemplatepublic'), 'Required key "EzsigntemplatepublicGetObjectV2ResponseMPayload[objEzsigntemplatepublic]" is missing from JSON.');
        assert(json[r'objEzsigntemplatepublic'] != null, 'Required key "EzsigntemplatepublicGetObjectV2ResponseMPayload[objEzsigntemplatepublic]" has a null value in JSON.');
        return true;
      }());
