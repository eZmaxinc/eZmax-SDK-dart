...
class CorsEditObjectV1Request {
  ...
  static CorsEditObjectV1Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objCors'), 'Required key "CorsEditObjectV1Request[objCors]" is missing from JSON.');
        assert(json[r'objCors'] != null, 'Required key "CorsEditObjectV1Request[objCors]" has a null value in JSON.');
        return true;
      }());
