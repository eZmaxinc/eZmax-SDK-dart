...
class EzsignfoldertypeGetObjectV4Response {
  ...
  static EzsignfoldertypeGetObjectV4Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'objDebugPayload'), 'Required key "EzsignfoldertypeGetObjectV4Response[objDebugPayload]" is missing from JSON.');
        assert(json[r'objDebugPayload'] != null, 'Required key "EzsignfoldertypeGetObjectV4Response[objDebugPayload]" has a null value in JSON.');
        assert(json.containsKey(r'mPayload'), 'Required key "EzsignfoldertypeGetObjectV4Response[mPayload]" is missing from JSON.');
        assert(json[r'mPayload'] != null, 'Required key "EzsignfoldertypeGetObjectV4Response[mPayload]" has a null value in JSON.');
        return true;
      }());
