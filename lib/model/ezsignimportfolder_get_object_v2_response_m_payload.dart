    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EzsignimportfolderGetObjectV2ResponseMPayload[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EzsignimportfolderGetObjectV2ResponseMPayload[$key]" has a null value in JSON.');
        });
        return true;
      }());
