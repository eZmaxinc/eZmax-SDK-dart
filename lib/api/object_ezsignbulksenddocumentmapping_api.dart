...
class ObjectEzsignbulksenddocumentmappingApi {
  ...
  ///
  /// * [int] pkiEzsignbulksenddocumentmappingID (required):
  Future<Response> ezsignbulksenddocumentmappingGetObjectV3WithHttpInfo(int pkiEzsignbulksenddocumentmappingID, { Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
    final path = r'/3/object/ezsignbulksenddocumentmapping/{pkiEzsignbulksenddocumentmappingID}'
      .replaceAll('{pkiEzsignbulksenddocumentmappingID}', pkiEzsignbulksenddocumentmappingID.toString());
  ...
  ///
  /// * [int] pkiEzsignbulksenddocumentmappingID (required):
  Future<EzsignbulksenddocumentmappingGetObjectV3Response?> ezsignbulksenddocumentmappingGetObjectV3(int pkiEzsignbulksenddocumentmappingID, { Future<void>? abortTrigger, }) async {
    final response = await ezsignbulksenddocumentmappingGetObjectV3WithHttpInfo(pkiEzsignbulksenddocumentmappingID, abortTrigger: abortTrigger,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'EzsignbulksenddocumentmappingGetObjectV3Response',) as EzsignbulksenddocumentmappingGetObjectV3Response;
