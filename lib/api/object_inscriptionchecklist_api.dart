...
class ObjectInscriptionchecklistApi {
  ...
  Future<Response> inscriptionchecklistGetAutocompleteV2WithHttpInfo(String sSelector, { String? fkiID, String? eType, String? eFilterActive, String? sQuery, HeaderAcceptLanguage? acceptLanguage, }) async {
    // ignore: prefer_const_declarations
    final path = r'/2/object/inscriptionchecklist/getAutocomplete/{sSelector}'
    ...
    if (fkiID != null) {
      queryParams.addAll(_queryParams('', 'fkiID', fkiID));
    }
    if (eType != null) {
  ...
  ///
  /// * [HeaderAcceptLanguage] acceptLanguage:
  Future<InscriptionchecklistGetAutocompleteV2Response?> inscriptionchecklistGetAutocompleteV2(String sSelector, { String? fkiID, String? eType, String? eFilterActive, String? sQuery, HeaderAcceptLanguage? acceptLanguage, }) async {
    final response = await inscriptionchecklistGetAutocompleteV2WithHttpInfo(sSelector,  fkiID: fkiID, eType: eType, eFilterActive: eFilterActive, sQuery: sQuery, acceptLanguage: acceptLanguage, );
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'InscriptionchecklistGetAutocompleteV2Response',) as InscriptionchecklistGetAutocompleteV2Response;
