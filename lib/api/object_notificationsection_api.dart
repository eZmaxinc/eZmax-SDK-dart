...
class ObjectNotificationsectionApi {
  ObjectNotificationsectionApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  /// Parameters:
  ///
  /// * [int] pkiNotificationsectionID (required):
  ///
  ...
  Future<Response> notificationsectionGetNotificationtestsV1WithHttpInfo(int pkiNotificationsectionID, bool bShowHidden,) async {
    ...
    final formParams = <String, String>{};
      ...
      queryParams.addAll(_queryParams('', 'bShowHidden', bShowHidden));
  ...
  Future<NotificationsectionGetNotificationtestsV1Response?> notificationsectionGetNotificationtestsV1(int pkiNotificationsectionID, bool bShowHidden,) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'NotificationsectionGetNotificationtestsV1Response',) as NotificationsectionGetNotificationtestsV1Response;
