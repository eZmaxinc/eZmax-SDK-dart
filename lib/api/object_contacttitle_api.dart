...
class ObjectContacttitleApi {
  ObjectContacttitleApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  ///   The type of Contacttitles to return
  ///
  /// * [String] sQuery:
  ...
  Future<ContacttitleGetAutocompleteV2Response?> contacttitleGetAutocompleteV2(String sSelector, { String? sQuery, HeaderAcceptLanguage? acceptLanguage, }) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'ContacttitleGetAutocompleteV2Response',) as ContacttitleGetAutocompleteV2Response;
