...
class ObjectBankaccountApi {
  ...
  Future<Response> bankaccountGetAutocompleteV2WithHttpInfo(String sSelector, { String? eFilterActive, String? sQuery, HeaderAcceptLanguage? acceptLanguage, }) async {
  ...
  ///
  /// * [HeaderAcceptLanguage] acceptLanguage:
  Future<BankaccountGetAutocompleteV2Response?> bankaccountGetAutocompleteV2(String sSelector, { String? eFilterActive, String? sQuery, HeaderAcceptLanguage? acceptLanguage, }) async {
    final response = await bankaccountGetAutocompleteV2WithHttpInfo(sSelector,  eFilterActive: eFilterActive, sQuery: sQuery, acceptLanguage: acceptLanguage, );
