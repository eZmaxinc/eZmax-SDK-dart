...
class ObjectEzsignbulksendsignermappingApi {
  ...
  ///
  /// * [int] pkiEzsignbulksendsignermappingID (required):
  Future<Response> ezsignbulksendsignermappingGetObjectV1WithHttpInfo(int pkiEzsignbulksendsignermappingID,) async {
    // ignore: prefer_const_declarations
    final path = r'/1/object/ezsignbulksendsignermapping/{pkiEzsignbulksendsignermappingID}'
      .replaceAll('{pkiEzsignbulksendsignermappingID}', pkiEzsignbulksendsignermappingID.toString());
  ...
  ///
  /// * [int] pkiEzsignbulksendsignermappingID (required):
  Future<EzsignbulksendsignermappingGetObjectV1Response?> ezsignbulksendsignermappingGetObjectV1(int pkiEzsignbulksendsignermappingID,) async {
    final response = await ezsignbulksendsignermappingGetObjectV1WithHttpInfo(pkiEzsignbulksendsignermappingID,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'EzsignbulksendsignermappingGetObjectV1Response',) as EzsignbulksendsignermappingGetObjectV1Response;
