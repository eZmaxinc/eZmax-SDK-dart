...
class ObjectEzsigntemplateglobalannotationApi {
  ObjectEzsigntemplateglobalannotationApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<EzsigntemplateglobalannotationGetObjectV2Response?> ezsigntemplateglobalannotationGetObjectV2(int pkiEzsigntemplateglobalannotationID, { Future<void>? abortTrigger, }) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'EzsigntemplateglobalannotationGetObjectV2Response',) as EzsigntemplateglobalannotationGetObjectV2Response;
