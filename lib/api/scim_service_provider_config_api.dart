...
class ScimServiceProviderConfigApi {
  ScimServiceProviderConfigApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<ScimServiceProviderConfig?> serviceProviderConfigGetObjectScimV2() async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'ScimServiceProviderConfig',) as ScimServiceProviderConfig;
