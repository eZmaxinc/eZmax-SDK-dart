...
class ObjectBillingentityinternalApi {
  ...
  Future<Response> billingentityinternalGetAutocompleteV1WithHttpInfo(String sSelector, { String? sQuery, HeaderAcceptLanguage? acceptLanguage, }) async {
  ...
  Future<CommonGetAutocompleteV1Response?> billingentityinternalGetAutocompleteV1(String sSelector, { String? sQuery, HeaderAcceptLanguage? acceptLanguage, }) async {
    final response = await billingentityinternalGetAutocompleteV1WithHttpInfo(sSelector,  sQuery: sQuery, acceptLanguage: acceptLanguage, );
