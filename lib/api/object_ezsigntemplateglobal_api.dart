...
class ObjectEzsigntemplateglobalApi {
  ObjectEzsigntemplateglobalApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<EzsigntemplateglobalGetAutocompleteV2Response?> ezsigntemplateglobalGetAutocompleteV2(String sSelector, { String? eFilterActive, String? sQuery, HeaderAcceptLanguage? acceptLanguage, }) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'EzsigntemplateglobalGetAutocompleteV2Response',) as EzsigntemplateglobalGetAutocompleteV2Response;
  ...
  Future<EzsigntemplateglobalGetObjectV2Response?> ezsigntemplateglobalGetObjectV2(int pkiEzsigntemplateglobalID,) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'EzsigntemplateglobalGetObjectV2Response',) as EzsigntemplateglobalGetObjectV2Response;
