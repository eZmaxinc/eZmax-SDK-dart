...
class ModuleListApi {
  ...
  Future<Response> listListpresentationV1WithHttpInfo(String sListName, ListSaveListpresentationV1Request listSaveListpresentationV1Request,) async {
  ...
  Future<ListSaveListpresentationV1Response> listListpresentationV1(String sListName, ListSaveListpresentationV1Request listSaveListpresentationV1Request,) async {
    final response = await listListpresentationV1WithHttpInfo(sListName, listSaveListpresentationV1Request,);
