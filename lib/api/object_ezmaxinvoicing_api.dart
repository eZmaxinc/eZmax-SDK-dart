...
class ObjectEzmaxinvoicingApi {
  ...
  Future<Response> ezmaxinvoicingGetAutocompleteV1WithHttpInfo(String sSelector, { String? eFilterActive, String? sQuery, HeaderAcceptLanguage? acceptLanguage, }) async {
    // ignore: prefer_const_declarations
    final path = r'/1/object/ezmaxinvoicing/getAutocomplete/{sSelector}'
  ...
  ///
  /// * [HeaderAcceptLanguage] acceptLanguage:
  Future<CommonGetAutocompleteV1Response?> ezmaxinvoicingGetAutocompleteV1(String sSelector, { String? eFilterActive, String? sQuery, HeaderAcceptLanguage? acceptLanguage, }) async {
    final response = await ezmaxinvoicingGetAutocompleteV1WithHttpInfo(sSelector,  eFilterActive: eFilterActive, sQuery: sQuery, acceptLanguage: acceptLanguage, );
  ...
  Future<Response> ezmaxinvoicingGetObjectV1WithHttpInfo(int pkiEzmaxinvoicingID,) async {
    // ignore: prefer_const_declarations
    final path = r'/1/object/ezmaxinvoicing/{pkiEzmaxinvoicingID}'
  ...
  Future<EzmaxinvoicingGetObjectV1Response?> ezmaxinvoicingGetObjectV1(int pkiEzmaxinvoicingID,) async {
    final response = await ezmaxinvoicingGetObjectV1WithHttpInfo(pkiEzmaxinvoicingID,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'EzmaxinvoicingGetObjectV1Response',) as EzmaxinvoicingGetObjectV1Response;
