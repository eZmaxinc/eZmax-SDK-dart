...
class ObjectEzmaxcustomerApi {
  ObjectEzmaxcustomerApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  /// Parameters:
  ///
  /// * [int] pkiEzmaxcustomerID (required):
  ...
  Future<EzmaxcustomerPatchObjectV1Response?> ezmaxcustomerPatchObjectV1(int pkiEzmaxcustomerID, EzmaxcustomerPatchObjectV1Request ezmaxcustomerPatchObjectV1Request,) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'EzmaxcustomerPatchObjectV1Response',) as EzmaxcustomerPatchObjectV1Response;
