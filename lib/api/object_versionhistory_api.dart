...
class ObjectVersionhistoryApi {
  ObjectVersionhistoryApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<VersionhistoryGetObjectV2Response?> versionhistoryGetObjectV2(int pkiVersionhistoryID,) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'VersionhistoryGetObjectV2Response',) as VersionhistoryGetObjectV2Response;
