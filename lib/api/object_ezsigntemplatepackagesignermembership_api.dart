...
class ObjectEzsigntemplatepackagesignermembershipApi {
  ...
  ///
  /// * [int] pkiEzsigntemplatepackagesignermembershipID (required):
  Future<Response> ezsigntemplatepackagesignermembershipGetObjectV1WithHttpInfo(int pkiEzsigntemplatepackagesignermembershipID,) async {
    // ignore: prefer_const_declarations
    final path = r'/1/object/ezsigntemplatepackagesignermembership/{pkiEzsigntemplatepackagesignermembershipID}'
      .replaceAll('{pkiEzsigntemplatepackagesignermembershipID}', pkiEzsigntemplatepackagesignermembershipID.toString());
  ...
  Future<EzsigntemplatepackagesignermembershipGetObjectV1Response?> ezsigntemplatepackagesignermembershipGetObjectV1(int pkiEzsigntemplatepackagesignermembershipID,) async {
    final response = await ezsigntemplatepackagesignermembershipGetObjectV1WithHttpInfo(pkiEzsigntemplatepackagesignermembershipID,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'EzsigntemplatepackagesignermembershipGetObjectV1Response',) as EzsigntemplatepackagesignermembershipGetObjectV1Response;
